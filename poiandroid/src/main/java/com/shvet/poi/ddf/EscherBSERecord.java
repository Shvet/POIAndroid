 ...
 * stores extra information about the blip. A blip record is actually stored
 * inside the BSE record even though the BSE record isn't actually a container
 * record.
 *
...
public final class EscherBSERecord extends EscherRecord {
    ...
    public int fillFields(byte[] data, int offset,
        ...
        if (bytesRemaining > 0) {
            ...
            field_12_blipRecord = (EscherBlipRecord) recordFactory
                    .createRecord(data, pos + 36);
        ...
        return bytesRemaining
                + 8
                + 36
                + (field_12_blipRecord == null ? 0 : field_12_blipRecord
                .getRecordSize());
    ...
    public int serialize(int offset, byte[] data,
        ...
        if (_remainingData == null)
            _remainingData = new byte[0];
        int blipSize = field_12_blipRecord == null ? 0 : field_12_blipRecord
                .getRecordSize();
    ...
    public int getRecordSize() {
        ...
        return 8 + 1 + 1 + 16 + 2 + 4 + 4 + 4 + 1 + 1 + 1 + 1 + field_12_size
                + remaining_size;
    }
    ...
    public String toString() {
        String extraData = _remainingData == null ? null : HexDump.toHex(
                _remainingData, 32);
        return getClass().getName() + ":" + '\n' + "  RecordId: 0x"
                ...
                + (field_3_uid == null ? "" : HexDump.toHex(field_3_uid))
                + '\n' + "  Tag: " + field_4_tag + '\n' + "  Size: "
                + field_5_size + '\n' + "  Ref: " + field_6_ref + '\n'
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("<BlipTypeWin32>").append(field_1_blipTypeWin32)
                .append("</BlipTypeWin32>\n").append(tab).append("\t")
                .append("<BlipTypeMacOS>").append(field_2_blipTypeMacOS)
                .append("</BlipTypeMacOS>\n").append(tab).append("\t")
                .append("<SUID>")
                .append(field_3_uid == null ? "" : HexDump.toHex(field_3_uid))
                .append("</SUID>\n").append(tab).append("\t").append("<Tag>")
                .append(field_4_tag).append("</Tag>\n").append(tab)
                .append("\t").append("<Size>").append(field_5_size)
                .append("</Size>\n").append(tab).append("\t").append("<Ref>")
                .append(field_6_ref).append("</Ref>\n").append(tab)
                .append("\t").append("<Offset>").append(field_7_offset)
                .append("</Offset>\n").append(tab).append("\t")
                .append("<Usage>").append(field_8_usage).append("</Usage>\n")
                .append(tab).append("\t").append("<Name>").append(field_9_name)
                .append("</Name>\n").append(tab).append("\t")
                .append("<Unused2>").append(field_10_unused2)
                .append("</Unused2>\n").append(tab).append("\t")
                .append("<Unused3>").append(field_11_unused3)
                .append("</Unused3>\n");
