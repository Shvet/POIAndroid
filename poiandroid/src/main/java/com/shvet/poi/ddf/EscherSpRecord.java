...
public class EscherSpRecord extends EscherRecord {
     ...
     *
     * @param offset   The offset into <code>data</code> to start writing the record
     *                 data to.
    ...
    public String toString() {
        ...
        return getClass().getName() + ":" + nl + "  RecordId: 0x"
                ...
                + HexDump.toHex(getVersion()) + nl + "  ShapeType: 0x"
                + HexDump.toHex(getShapeType()) + nl + "  ShapeId: "
                + field_1_shapeId + nl + "  Flags: "
                + decodeFlags(field_2_flags) + " (0x"
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("\t")
                .append("<ShapeType>0x")
                .append(HexDump.toHex(getShapeType()))
                .append("</ShapeType>\n")
                .append(tab)
                .append("\t")
                .append("<ShapeId>")
                ...
                .append("\t")
                .append("<Flags>")
                .append(decodeFlags(field_2_flags) + " (0x"
                        + HexDump.toHex(field_2_flags) + ")")
                .append("</Flags>\n");
