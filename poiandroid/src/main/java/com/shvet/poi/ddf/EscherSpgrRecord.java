...
/**
 * The spgr record defines information about a shape group. Groups in escher are
 * simply another form of shape that you can't physically see.
 *
...
public class EscherSpgrRecord extends EscherRecord {
    ...
    public int fillFields(byte[] data, int offset,
        ...
        if (bytesRemaining != 0)
            throw new RecordFormatException(
                    "Expected no remaining bytes but got " + bytesRemaining);
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("<RectX>").append(field_1_rectX1).append("</RectX>\n")
                .append(tab).append("\t").append("<RectY>")
                .append(field_2_rectY1).append("</RectY>\n").append(tab)
                .append("\t").append("<RectWidth>").append(field_3_rectX2)
                .append("</RectWidth>\n").append(tab).append("\t")
                .append("<RectHeight>").append(field_4_rectY2)
                .append("</RectHeight>\n");
