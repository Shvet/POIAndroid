...
public interface EscherSerializationListener {
     ...
     *
     * @param offset   The position in the data array at which the record will be
     *                 serialized.
     ...
     * @param recordId The id of the record about to be serialized
     * @param size     The number of bytes written for this record. If it is a
     *                 container record then this will include the size of any
     *                 included records.
     */
    void afterRecordSerialize(int offset, short recordId, int size,
                              EscherRecord record);
}
