...
/**
 * The escher child achor record is used to specify the position of a shape
 * under an existing group. The first level of shape records use a
 * EscherClientAnchor record instead.
 *
...
public class EscherChildAnchorRecord extends EscherRecord {
    ...
    public int fillFields(byte[] data, int offset,
        ...
        switch (bytesRemaining) {
            ...
            case 8: // SmallRectStruct
                field_1_dx1 = LittleEndian.getShort(data, pos + size);
                size += 2;
                field_2_dy1 = LittleEndian.getShort(data, pos + size);
                size += 2;
                field_3_dx2 = LittleEndian.getShort(data, pos + size);
                size += 2;
                field_4_dy2 = LittleEndian.getShort(data, pos + size);
                size += 2;
                break;
            default:
                throw new RuntimeException(
                        "Invalid EscherChildAnchorRecord - neither 8 nor 16 bytes.");
        }
    ...
    public String toString() {
        ...
        return getClass().getName() + ":" + nl + "  RecordId: 0x"
                ...
                + HexDump.toHex(getInstance()) + nl + "  X1: " + field_1_dx1
                + nl + "  Y1: " + field_2_dy1 + nl + "  X2: " + field_3_dx2
                + nl + "  Y2: " + field_4_dy2 + nl;
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("<X1>").append(field_1_dx1).append("</X1>\n")
                .append(tab).append("\t").append("<Y1>").append(field_2_dy1)
                .append("</Y1>\n").append(tab).append("\t").append("<X2>")
                .append(field_3_dx2).append("</X2>\n").append(tab).append("\t")
                .append("<Y2>").append(field_4_dy2).append("</Y2>\n");
    ...
    /**
     * Retrieves offset within the parent coordinate space for the bottom right
     * point.
     */
    public int getDx2() {
        return field_3_dx2;
    ...
    /**
     * Sets offset within the parent coordinate space for the bottom right
     * point.
     */
    ...
    /**
     * Gets the offset within the parent coordinate space for the bottom right
     * point.
     */
    public int getDy2() {
        return field_4_dy2;
    ...
    /**
     * Sets the offset within the parent coordinate space for the bottom right
     * point.
     */
