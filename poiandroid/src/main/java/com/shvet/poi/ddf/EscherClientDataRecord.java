...
/**
 * The EscherClientDataRecord is used to store client specific data about the
 * position of a shape within a container.
 *
...
public class EscherClientDataRecord extends EscherRecord {
    ...
    public int serialize(int offset, byte[] data,
        ...
        System.arraycopy(remainingData, 0, data, offset + 8,
    ...
    public String toString() {
        ...
        return getClass().getName() + ":" + nl + "  RecordId: 0x"
                ...
                + HexDump.toHex(getInstance()) + nl + "  Extra Data:" + nl
                + extraData;
