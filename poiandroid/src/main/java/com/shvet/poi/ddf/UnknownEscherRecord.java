...
/**
 * This record is used whenever a escher record is encountered that we do not
 * explicitly support.
 *
...
public final class UnknownEscherRecord extends EscherRecord {
    ...
    public int fillFields(byte[] data, int offset,
        ...
        /*
         * Modified by Zhang Zhang Have a check between avaliable bytes and
		 * bytesRemaining, take the avaliable length if the bytesRemaining out
		 * of range. July 09, 2010
		 */
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("<IsContainer>").append(isContainerRecord())
                .append("</IsContainer>\n").append(tab).append("\t")
                .append("<Numchildren>")
                .append(HexDump.toHex(_childRecords.size()))
                .append("</Numchildren>\n");
