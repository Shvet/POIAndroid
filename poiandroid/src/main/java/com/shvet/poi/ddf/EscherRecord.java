 ...
 * Subclasses will need to define methods for serialization/deserialization and
 * for determining the record size.
 *
...
public abstract class EscherRecord {
     ...
     */
    public abstract int fillFields(byte[] data, int offset,
                                   EscherRecordFactory recordFactory);

    /**
     * Reads the 8 byte header information and populates the
     * <code>options</code> and <code>recordId</code> records.
     *
     * @param data   the byte array to read from
     * @param offset the offset to start reading from
     * @return the number of bytes remaining in this record. This may include
     * the children if this is a container.
     */
    ...
    /**
     * <p
     * Note that <code>options</code> is an internal field. Use
     * {@link #setInstance(short)} ()} and {@link #setVersion(short)} ()} to set
     * the actual fields.
     * </p>
     *
    ...
    /**
     * Set the options this this record. Container records should have the last
     * nibble set to 0xF.
     * <p/>
     * <p
     * Note that <code>options</code> is an internal field. Use
     * {@link #getInstance()} and {@link #getVersion()} to access actual fields.
     * </p>
     */
    @Internal
    ...
    /**
     * Serializes to an existing byte array without serialization listener. This
     * is done by delegating to serialize(int, byte[],
     ...
     * @param data     the data array to serialize to
     * @param listener a listener for begin and end serialization events. This is
     *                 useful because the serialization is hierarchical/recursive and
     *                 sometimes you need to be able break into that.
     * @return the number of bytes written.
     */
    ...
    /**
     * @return Returns the children of this record. By default this will be an
     * empty list. EscherCotainerRecord is the only record that may
     * contain children.
    ...
    /**
     * Sets the child records for this record. By default this will throw an
     * exception as only EscherContainerRecords may have children.
     *
     ...
     */
    public Object clone() {
        throw new RuntimeException("The class " + getClass().getName()
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append("<").append(getClass().getSimpleName())
                .append(">\n").append(tab).append("\t").append("<RecordId>0x")
                .append(HexDump.toHex(_recordId)).append("</RecordId>\n")
                .append(tab).append("\t").append("<Options>").append(_options)
                .append("</Options>\n").append(tab).append("</")
    ...
    protected String formatXmlRecordHeader(String className, String recordId,
        ...
        StringBuilder builder = new StringBuilder();
        builder.append("<").append(className).append(" recordId=\"0x")
                .append(recordId).append("\" version=\"0x").append(version)
                .append("\" instance=\"0x").append(instance)
                .append("\" size=\"").append(getRecordSize()).append("\">\n");
        return builder.toString();
    }
