...
/**
 * A list of the most recently used colours for the drawings contained in this
 * document.
 *
...
public class EscherSplitMenuColorsRecord extends EscherRecord {
    ...
    public String toString() {
        return getClass().getName() + ":" + '\n' + "  RecordId: 0x"
                ...
                + HexDump.toHex(field_1_color1) + '\n' + "  Color2: 0x"
                + HexDump.toHex(field_2_color2) + '\n' + "  Color3: 0x"
                + HexDump.toHex(field_3_color3) + '\n' + "  Color4: 0x"
                + HexDump.toHex(field_4_color4) + '\n' + "";
    }
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("<Color1>0x").append(HexDump.toHex(field_1_color1))
                .append("</Color1>\n").append(tab).append("\t")
                .append("<Color2>0x").append(HexDump.toHex(field_2_color2))
                .append("</Color2>\n").append(tab).append("\t")
                .append("<Color3>0x").append(HexDump.toHex(field_3_color3))
                .append("</Color3>\n").append(tab).append("\t")
                .append("<Color4>0x").append(HexDump.toHex(field_4_color4))
                .append("</Color4>\n");
