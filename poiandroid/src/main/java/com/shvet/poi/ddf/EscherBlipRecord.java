 ...
 */
public class EscherBlipRecord extends EscherRecord { // TODO - instantiable
    // superclass
    ...
    public int serialize(int offset, byte[] data,
        ...
        System.arraycopy(field_pictureData, 0, data, offset + 4,
                field_pictureData.length);

        listener.afterRecordSerialize(offset + 4 + field_pictureData.length,
                getRecordId(), field_pictureData.length + 4, this);
