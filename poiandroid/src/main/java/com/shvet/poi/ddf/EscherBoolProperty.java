...
/**
 * Represents a boolean property. The actual utility of this property is in
 * doubt because many of the properties marked as boolean seem to actually
 * contain special values. In other words they're not true booleans.
 *
...
public class EscherBoolProperty extends EscherSimpleProperty {
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append("<").append(getClass().getSimpleName())
                ...
                .append("\" simpleValue=\"").append(getPropertyValue())
                .append("\" blipId=\"").append(isBlipId())
                .append("\" value=\"").append(isTrue()).append("\"")
                .append("/>\n");
