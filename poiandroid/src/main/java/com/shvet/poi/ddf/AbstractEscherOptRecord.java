...
public abstract class AbstractEscherOptRecord extends EscherRecord {
    ...
    /**
     * Set an escher property. If a property with given propId already exists it
     * is replaced.
     *
     * @param value the property to set.
     */
    public void setEscherProperty(EscherProperty value) {
        for (Iterator<EscherProperty> iterator = properties.iterator(); iterator
                .hasNext(); ) {
    ...
    public void removeEscherProperty(int num) {
        for (Iterator<EscherProperty> iterator = getEscherProperties()
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append(
                formatXmlRecordHeader(getClass().getSimpleName(),
