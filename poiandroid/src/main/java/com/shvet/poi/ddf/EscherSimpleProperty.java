...
/**
 * A simple property is of fixed length and as a property number in addition to
 * a 32-bit value. Properties that can't be stored in only 32-bits are stored as
 * EscherComplexProperty objects.
 *
...
public class EscherSimpleProperty extends EscherProperty {
     ...
     * property number the blip id flag and an indicator whether the property is
     * complex or not.
     */
    ...
    /**
     * Constructs a new escher property. The three parameters are combined to
     * form a property id.
     */
    public EscherSimpleProperty(short propertyNumber, boolean isComplex,
                                boolean isBlipId, int propertyValue) {
    ...
    /**
     * Escher properties consist of a simple fixed length part and a complex
     * variable length part. The fixed length part is serialized first.
     */
    ...
    public boolean equals(Object o) {
        ...
        if (propertyValue != escherSimpleProperty.propertyValue)
            return false;
        return getId() == escherSimpleProperty.getId();
    ...
    public String toString() {
        return "propNum: " + getPropertyNumber() + ", RAW: 0x"
                + HexDump.toHex(getId()) + ", propName: "
                + EscherProperties.getPropertyName(getPropertyNumber())
                + ", complex: " + isComplex() + ", blipId: " + isBlipId()
                + ", value: " + propertyValue + " (0x"
                + HexDump.toHex(propertyValue) + ")";
    }
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append("<").append(getClass().getSimpleName())
                ...
                .append(isBlipId()).append("\" complex=\"").append(isComplex())
                .append("\" value=\"").append("0x")
