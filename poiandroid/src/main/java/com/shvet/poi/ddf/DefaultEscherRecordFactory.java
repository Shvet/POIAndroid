...
public class DefaultEscherRecordFactory implements EscherRecordFactory {
    ...
    /**
     * Converts from a list of classes into a map that contains the record id as
     * the key and the Constructor in the value part of the map. It does this by
     * using reflection to look up the RECORD_ID field then using reflection
     * again to find a reference to the constructor.
     *
     * @param recClasses The records to convert
     * @return The map containing the id/constructor pairs.
     */
    protected static Map<Short, Constructor<? extends EscherRecord>> recordsToMap(
            Class<?>[] recClasses) {
    ...
    /**
     * Generates an escher record including the any children contained under
     * that record. An exception is thrown if the record could not be generated.
     *
    ...
    public EscherRecord createRecord(byte[] data, int offset) {
        ...
        Constructor<? extends EscherRecord> recordConstructor = recordsMap
