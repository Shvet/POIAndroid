...
/**
 * A complex property differs from a simple property in that the data can not
 * fit inside a 32 bit integer. See the specification for more detailed
 * information regarding exactly what is stored here.
 *
...
public class EscherComplexProperty extends EscherProperty {
     ...
     * containing the complex data value.
     *
     * @param id          The id consists of the property number, a flag indicating
     *                    whether this is a blip id and a flag indicating that this is a
     *                    complex property.
    ...
    /**
     * Create a complex property using the property number, a flag to indicate
     * whether this is a blip reference and the complex property data.
     *
    ...
    public String toString() {
        ...
        return "propNum: " + getPropertyNumber() + ", propName: "
