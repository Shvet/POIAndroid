...
public class EscherBitmapBlip extends EscherBlipRecord {
    ...
    public int fillFields(byte[] data, int offset,
        ...
        System.arraycopy(data, pos, field_pictureData, 0,
                field_pictureData.length);
    ...
    public int serialize(int offset, byte[] data,
        ...
        System.arraycopy(field_pictureData, 0, data, pos + 17,
                field_pictureData.length);
    ...
    public String toString() {
        ...
        return getClass().getName() + ":" + nl + "  RecordId: 0x"
                + HexDump.toHex(getRecordId()) + nl + "  Version: 0x"
                + HexDump.toHex(getVersion()) + nl + "  Instance: 0x"
                + HexDump.toHex(getInstance()) + nl + "  UID: 0x"
                + HexDump.toHex(field_1_UID) + nl + "  Marker: 0x"
                + HexDump.toHex(field_2_marker) + nl + "  Extra Data:" + nl
                + extraData;
    }
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab)
                ...
                .append("<UID>0x").append(HexDump.toHex(field_1_UID))
                .append("</UID>\n").append(tab).append("\t")
                .append("<Marker>0x").append(HexDump.toHex(field_2_marker))
                .append("</Marker>\n").append(tab).append("\t")
