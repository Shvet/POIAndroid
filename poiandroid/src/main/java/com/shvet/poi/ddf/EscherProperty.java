...
public abstract class EscherProperty {
     ...
     * form a property id.
     */
    public EscherProperty(short propertyNumber, boolean isComplex,
                          boolean isBlipId) {
        _id = (short) (propertyNumber + (isComplex ? 0x8000 : 0x0) + (isBlipId ? 0x4000
                : 0x0));
    }
    ...
    public String toXml(String tab) {
        ...
        builder.append(tab).append("<").append(getClass().getSimpleName())
                ...
                .append(getName()).append("\" blipId=\"").append(isBlipId())
                .append("\"/>\n");
