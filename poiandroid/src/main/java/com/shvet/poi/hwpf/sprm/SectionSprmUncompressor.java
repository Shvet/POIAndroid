...
public final class SectionSprmUncompressor extends SprmUncompressor {
    ...
    /**
     * Used in decompression of a sepx. This performs an operation defined by a
     * single sprm.
     *
     ...
     */
    static void unCompressSEPOperation(SectionProperties newSEP,
                                       SprmOperation sprm) {
        switch (sprm.getOperation()) {
            ...
            case 0x2a:
                break;
            case 0x2b:
                newSEP.setBrcTop(new BorderCode(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x2c:
                newSEP.setBrcLeft(new BorderCode(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x2d:
                newSEP.setBrcBottom(new BorderCode(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x2e:
                newSEP.setBrcRight(new BorderCode(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x2f:
