...
import com.shvet.poi.hwpf.sprm.TableSprmUncompressor;
    ...
    private void initCells() {
        ...
        for (int p = 0; p < numParagraphs(); p++) {
            ...
            if (((s.length() > 0 && s.charAt(s.length() - 1) == TABLE_CELL_MARK) || paragraph
                ...
                TableCell tableCell = new TableCell(getParagraph(lastCellStart)
                        .getStartOffset(), getParagraph(p).getEndOffset(),
