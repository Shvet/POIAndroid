 ...
 *
 * @author S. Ryan Ackley. Field descriptions are quoted from Microsoft Office
...
public abstract class TCAbstractType {
    ...
    public String toString() {
        ...
        builder.append("         .fFirstMerged             = ")
                .append(isFFirstMerged()).append('\n');
        builder.append("         .fMerged                  = ")
                .append(isFMerged()).append('\n');
        builder.append("         .fVertical                = ")
                .append(isFVertical()).append('\n');
        builder.append("         .fBackward                = ")
                .append(isFBackward()).append('\n');
        builder.append("         .fRotateFont              = ")
                .append(isFRotateFont()).append('\n');
        builder.append("         .fVertMerge               = ")
                .append(isFVertMerge()).append('\n');
        builder.append("         .fVertRestart             = ")
                .append(isFVertRestart()).append('\n');
        builder.append("         .vertAlign                = ")
                .append(getVertAlign()).append('\n');
        builder.append("         .ftsWidth                 = ")
                .append(getFtsWidth()).append('\n');
        builder.append("         .fFitText                 = ")
                .append(isFFitText()).append('\n');
        builder.append("         .fNoWrap                  = ")
                .append(isFNoWrap()).append('\n');
        builder.append("         .fUnused                  = ")
                .append(getFUnused()).append('\n');
     ...
     * When a cell is merged, the display areas of the merged cells are
     * consolidated and the text within the cells is interpreted as belonging to
     * one text stream for purposes of calculating line breaks.
     *
    ...
    /**
     * Sets the fFirstMerged field value. When 1, cell is first cell of a range
     * of cells that have been merged. When a cell is merged, the display areas
     * of the merged cells are consolidated and the text within the cells is
     * interpreted as belonging to one text stream for purposes of calculating
     * line breaks.
     */
    @Internal
    ...
    /**
     * Sets the fMerged field value. When 1, cell has been merged with preceding
     * cell
     */
    @Internal
    ...
    /**
     * Sets the fBackward field value. For a vertical table cell, text flow is
     * bottom to top when 1 and is bottom to top when 0
     */
    @Internal
    ...
    /**
     * Sets the fRotateFont field value. When 1, cell has rotated characters
     * (i.e. uses @font)
     */
    @Internal
     ...
     * When cells are vertically merged, the display area of the merged cells
     * are consolidated. The consolidated area is used to display the contents
     * of the first vertically merged cell (the cell with fVertRestart set to
     * 1), and all other vertically merged cells (those with fVertRestart set to
     * 0) must be empty. Cells can only be merged vertically if their left and
     * right boundaries are (nearly) identical (i.e. if corresponding entries in
     * rgdxaCenter of the table rows differ by at most 3).
     *
    ...
    /**
     * Sets the fVertMerge field value. When 1, cell is vertically merged with
     * the cell(s) above and/or below. When cells are vertically merged, the
     * display area of the merged cells are consolidated. The consolidated area
     * is used to display the contents of the first vertically merged cell (the
     * cell with fVertRestart set to 1), and all other vertically merged cells
     ...
     * identical (i.e. if corresponding entries in rgdxaCenter of the table rows
     * differ by at most 3).
     */
    @Internal
    ...
    /**
     * When 1, the cell is the first of a set of vertically merged cells. The
     * contents of a cell with fVertStart set to 1 are displayed in the
     * consolidated area belonging to the entire set of vertically merged cells.
     * Vertically merged cells with fVertRestart set to 0 must be empty.
     *
    ...
    /**
     * Sets the fVertRestart field value. When 1, the cell is the first of a set
     * of vertically merged cells. The contents of a cell with fVertStart set to
     * 1 are displayed in the consolidated area belonging to the entire set of
     * vertically merged cells. Vertically merged cells with fVertRestart set to
     * 0 must be empty.
     */
    @Internal
     ...
     * in a cell with bottom to top text flow and bottom vertical alignment, the
     * text is shifted horizontally to match the cell's right boundary)
     *
    ...
    /**
     * Sets the vertAlign field value. Specifies the alignment of the cell
     * contents relative to text flow (e.g. in a cell with bottom to top text
     * flow and bottom vertical alignment, the text is shifted horizontally to
     * match the cell's right boundary)
     */
    @Internal
    ...
    /**
     * Sets the fNoWrap field value. When 1, do not allow text to wrap in the
     * table cell
     */
    @Internal
