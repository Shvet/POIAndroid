...
/**
 * Section Properties. NOTE: This source is automatically generated please do
...
public abstract class SEPAbstractType {
    ...
    public String toString() {
        ...
        builder.append(" (").append(Arrays.toString(getRgdxaColumn()))
                .append(" )\n");
        ...
        builder.append(" (").append(Arrays.toString(getOlstAnm()))
                .append(" )\n");
     ...
     * Break code.
     *
     * @return One of <li>{@link #BKC_NO_BREAK} <li>{@link #BKC_NEW_COLUMN} <li>
     * {@link #BKC_NEW_PAGE} <li>{@link #BKC_EVEN_PAGE} <li>
     * {@link #BKC_ODD_PAGE}
     */
    public byte getBkc() {
        return field_1_bkc;
     ...
     * Break code.
     *
     * @param field_1_bkc One of <li>{@link #BKC_NO_BREAK} <li>{@link #BKC_NEW_COLUMN}
     *                    <li>{@link #BKC_NEW_PAGE} <li>{@link #BKC_EVEN_PAGE} <li>
     *                    {@link #BKC_ODD_PAGE}
     */
    ...
    /**
     * Only for Macintosh compatibility, used only during open, when 1,
     ...
     *
     * @return One of <li>{@link #NFCPGN_ARABIC} <li>
     * {@link #NFCPGN_ROMAN_UPPER_CASE} <li>
     * {@link #NFCPGN_ROMAN_LOWER_CASE} <li>
     * {@link #NFCPGN_LETTER_UPPER_CASE} <li>
     ...
     * Page number format code.
     *
     * @param field_4_nfcPgn One of <li>{@link #NFCPGN_ARABIC} <li>
     *                       {@link #NFCPGN_ROMAN_UPPER_CASE} <li>
     *                       {@link #NFCPGN_ROMAN_LOWER_CASE} <li>
     *                       {@link #NFCPGN_LETTER_UPPER_CASE} <li>
     *                       {@link #NFCPGN_LETTER_LOWER_CASE}
     ...
     *
     * @return One of <li>{@link #DMORIENTPAGE_LANDSCAPE} <li>
     ...
     *
     * @param field_31_dmOrientPage One of <li>{@link #DMORIENTPAGE_LANDSCAPE} <li>
     *                              {@link #DMORIENTPAGE_PORTRAIT}
     */
