...
/**
 * <p/>
 * The File Information Block (FIB). Holds pointers to various bits of the file,
 * and lots of flags which specify properties of the document.
 * <p/>
 * <ul>
 * <li>The {@link FibBase} class, holds the first 32 bytes.</li>
 * <li>The next part, the fibRgW / FibRgW97, is handled by the {@link FibRgW97}.
 * </li>
 * <li>The next part, the fibRgLw / FibRgLw97, is handled by the
 * {@link FibRgLw97}.</li>
 * <li>Finally, the rest of the fields are handled by the
 * {@link FIBFieldHandler}.</li>
 * </ul>
 */
@Internal
public final class FileInformationBlock implements Cloneable {
    ...
    public void setFcPlcfbteChpx(int fcPlcfBteChpx) {
        _fieldHandler
                .setFieldOffset(FIBFieldHandler.PLCFBTECHPX, fcPlcfBteChpx);
    }
    ...
    public void setFcPlcfbtePapx(int fcPlcfBtePapx) {
        _fieldHandler
                .setFieldOffset(FIBFieldHandler.PLCFBTEPAPX, fcPlcfBtePapx);
    }
    ...
    public void setFcSttbSavedBy(int fcSttbSavedBy) {
        _fieldHandler
                .setFieldOffset(FIBFieldHandler.STTBSAVEDBY, fcSttbSavedBy);
    }
    ...
    /**
     * Updates the count of the number of bytes in the main stream which contain
     * real data
     */
