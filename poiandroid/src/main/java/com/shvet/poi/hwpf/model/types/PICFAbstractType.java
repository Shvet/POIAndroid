...
public abstract class PICFAbstractType {
    ...
    public static int getSize() {
        return 0 + 4 + 2 + 2 + 2 + 2 + 2 + 4 + 4 + 2 + 4 + 2 + 2 + 2 + 2 + 2
                + 2 + 2 + 2 + 1 + 1 + 4 + 4 + 4 + 4 + 2 + 2 + 2;
    }
    ...
    protected void fillFields(byte[] data, int offset) {
        ...
        field_23_brcBottom80 = LittleEndian
                .getByteArray(data, 0x36 + offset, 4);
    ...
    public void serialize(byte[] data, int offset) {
        ...
        System.arraycopy(field_21_brcTop80, 0, data, 0x2e + offset,
                field_21_brcTop80.length);
        System.arraycopy(field_22_brcLeft80, 0, data, 0x32 + offset,
                field_22_brcLeft80.length);
        System.arraycopy(field_23_brcBottom80, 0, data, 0x36 + offset,
                field_23_brcBottom80.length);
        System.arraycopy(field_24_brcRight80, 0, data, 0x3a + offset,
                field_24_brcRight80.length);
    ...
    public String toString() {
        ...
        builder.append(" (").append(Arrays.toString(getBrcTop80()))
                .append(" )\n");
        builder.append("    .brcLeft80            = ");
        builder.append(" (").append(Arrays.toString(getBrcLeft80()))
                .append(" )\n");
        builder.append("    .brcBottom80          = ");
        builder.append(" (").append(Arrays.toString(getBrcBottom80()))
                .append(" )\n");
        builder.append("    .brcRight80           = ");
        builder.append(" (").append(Arrays.toString(getBrcRight80()))
                .append(" )\n");
    ...
    /**
     * A signed integer that specifies the size, in bytes, of this PICF
     * structure and the subsequent data.
     */
    @Internal
    public int getLcb() {
        return field_1_lcb;
