...
public class FieldsImpl implements Fields {
     ...
     * Harmony).
     */
    private static <T> int binarySearch(List<PlexOfField> list, int startIndex,
                                        int endIndex, int requiredStartOffset) {
