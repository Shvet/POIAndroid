...
package com.shvet.poi.hwpf;

import com.shvet.poi.hpsf.DocumentSummaryInformation;
import com.shvet.poi.hpsf.SummaryInformation;
import com.shvet.poi.hwpf.model.BookmarksTables;
import com.shvet.poi.hwpf.model.CHPBinTable;
import com.shvet.poi.hwpf.model.ComplexFileTable;
import com.shvet.poi.hwpf.model.DocumentProperties;
import com.shvet.poi.hwpf.model.EscherRecordHolder;
import com.shvet.poi.hwpf.model.FSPADocumentPart;
import com.shvet.poi.hwpf.model.FSPATable;
import com.shvet.poi.hwpf.model.FieldsTables;
import com.shvet.poi.hwpf.model.FontTable;
import com.shvet.poi.hwpf.model.ListTables;
import com.shvet.poi.hwpf.model.NoteType;
import com.shvet.poi.hwpf.model.NotesTables;
import com.shvet.poi.hwpf.model.PAPBinTable;
import com.shvet.poi.hwpf.model.PicturesTable;
import com.shvet.poi.hwpf.model.RevisionMarkAuthorTable;
import com.shvet.poi.hwpf.model.SavedByTable;
import com.shvet.poi.hwpf.model.SectionTable;
import com.shvet.poi.hwpf.model.ShapesTable;
import com.shvet.poi.hwpf.model.SinglentonTextPiece;
import com.shvet.poi.hwpf.model.StyleSheet;
import com.shvet.poi.hwpf.model.SubdocumentType;
import com.shvet.poi.hwpf.model.TextPiece;
import com.shvet.poi.hwpf.model.TextPieceTable;
import com.shvet.poi.hwpf.model.io.HWPFFileSystem;
import com.shvet.poi.hwpf.model.io.HWPFOutputStream;
import com.shvet.poi.hwpf.usermodel.Bookmarks;
import com.shvet.poi.hwpf.usermodel.BookmarksImpl;
import com.shvet.poi.hwpf.usermodel.Field;
import com.shvet.poi.hwpf.usermodel.Fields;
import com.shvet.poi.hwpf.usermodel.FieldsImpl;
import com.shvet.poi.hwpf.usermodel.HWPFList;
import com.shvet.poi.hwpf.usermodel.Notes;
import com.shvet.poi.hwpf.usermodel.NotesImpl;
import com.shvet.poi.hwpf.usermodel.OfficeDrawings;
import com.shvet.poi.hwpf.usermodel.OfficeDrawingsImpl;
import com.shvet.poi.hwpf.usermodel.Range;
import com.shvet.poi.poifs.common.POIFSConstants;
import com.shvet.poi.poifs.filesystem.DirectoryNode;
import com.shvet.poi.poifs.filesystem.DocumentEntry;
import com.shvet.poi.poifs.filesystem.Entry;
...
public final class HWPFDocument extends HWPFDocumentCore {
    static final String PROPERTY_PRESERVE_BIN_TABLES = "com.shvet.poi.hwpf.preserveBinTables";
    private static final String PROPERTY_PRESERVE_TEXT_TABLE = "com.shvet.poi.hwpf.preserveTextTable";
     ...
     * @throws IOException If there is an unexpected IOException from the passed in
     *                     InputStream.
     */
    ...
    /**
     * This constructor loads a Word document from a specific point in a
     * POIFSFileSystem, probably not the default. Used typically to open
     * embedded documents.
     *
     * @param pfilesystem The POIFSFileSystem that contains the Word document.
     * @throws IOException If there is an unexpected IOException from the passed in
    ...
    /**
     * This constructor loads a Word document from a specific point in a
     * POIFSFileSystem, probably not the default. Used typically to open embeded
     * documents.
     *
    ...
    public HWPFDocument(DirectoryNode directory) throws IOException {
        ...
        try {
            DocumentEntry dataProps = (DocumentEntry) directory
        ...
        _dop = new DocumentProperties(_tableStream, _fib.getFcDop(),
                _fib.getLcbDop());
        _cft = new ComplexFileTable(_mainStream, _tableStream, _fib.getFcClx(),
                fcMin);
        ...
        _cbt = new CHPBinTable(_mainStream, _tableStream,
                _fib.getFcPlcfbteChpx(), _fib.getLcbPlcfbteChpx(), _tpt);
        _pbt = new PAPBinTable(_mainStream, _tableStream, _dataStream,
                _fib.getFcPlcfbtePapx(), _fib.getLcbPlcfbtePapx(), _tpt);
        ...
        if (_fib.getFcDggInfo() != 0) {
            _escherRecordHolder = new EscherRecordHolder(_tableStream,
                    _fib.getFcDggInfo(), _fib.getLcbDggInfo());
        } else {
        ...
        _pictures = new PicturesTable(this, _dataStream, _mainStream,
                _fspaMain, _escherRecordHolder);
        // And the art shapes stream
        _officeArts = new ShapesTable(_tableStream, _fib);

        // And escher pictures
        _officeDrawingsHeaders = new OfficeDrawingsImpl(_fspaHeaders,
        ...
        if (rmarkOffset != 0 && rmarkLength != 0) {
            _rmat = new RevisionMarkAuthorTable(_tableStream, rmarkOffset,
                    rmarkLength);
        }
        ...
        _footnotesTables = new NotesTables(NoteType.FOOTNOTE, _tableStream,
                _fib);
    ...
    /**
     * Returns the range which covers all "Header Stories". A header story
     * contains a header, footer, end note separators and footnote separators.
     */
    ...
    /**
     * Gets a reference to the saved -by table, which holds the save history for
     * the document.
     *
    ...
    /**
     * Gets a reference to the revision mark author table, which holds the
     * revision mark authors for the document.
     *
     * @return the saved-by table.
     */
    @Internal
    ...
    /**
     * @return FieldsTables object, that is able to extract fields descriptors
     * from this document
     * @deprecated
     */
    @Deprecated
    ...
    public void write(OutputStream out) throws IOException {
        ...
        HWPFOutputStream wordDocumentStream = docSys
                .getStream(STREAM_WORD_DOCUMENT);
    ...
    public int registerList(HWPFList list) {
        ...
        return _lt
                .addList(list.getListData(), list.getLFO(), list.getLFOData());
    }
