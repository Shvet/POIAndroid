...
import com.shvet.poi.hwpf.usermodel.TableAutoformatLookSpecifier;
import com.shvet.poi.hwpf.usermodel.TableCellDescriptor;
...
/**
 * Table Properties. Properties descriptions quoted from official 97-2007 binary
...
public abstract class TAPAbstractType {
    ...
    /**/private static BitField widthAndFitsFlags_empty1 = new BitField(
            0x00070000);
    ...
    /**/private static BitField widthAndFitsFlags_empty2 = new BitField(
            0xff000000);
    ...
    public String toString() {
        ...
        builder.append("         .fFirstRow                = ")
                .append(isFFirstRow()).append('\n');
        builder.append("         .fLastRow                 = ")
        ...
        builder.append("         .fCellSpacing             = ")
                .append(isFCellSpacing()).append('\n');
        builder.append("         .grpfTap_unused           = ")
        ...
        builder.append("         .fWrapToWwd               = ")
                .append(isFWrapToWwd()).append('\n');
        builder.append("         .fNotPageView             = ")
                .append(isFNotPageView()).append('\n');
        builder.append("         .viewFlags_unused1        = ")
                .append(isViewFlags_unused1()).append('\n');
        builder.append("         .fWebView                 = ")
                .append(isFWebView()).append('\n');
        builder.append("         .fAdjusted                = ")
                .append(isFAdjusted()).append('\n');
        builder.append("         .viewFlags_unused2        = ")
                .append(getViewFlags_unused2()).append('\n');
        builder.append("    .rgdxaCenter          = ");
        builder.append(" (").append(Arrays.toString(getRgdxaCenter()))
                .append(" )\n");
        builder.append("    .rgdxaCenterPrint     = ");
        builder.append(" (").append(Arrays.toString(getRgdxaCenterPrint()))
                .append(" )\n");
        ...
        builder.append(" (").append(getWCellPaddingDefaultLeft())
                .append(" )\n");
        builder.append("    .wCellPaddingDefaultBottom = ");
        builder.append(" (").append(getWCellPaddingDefaultBottom())
                .append(" )\n");
        builder.append("    .wCellPaddingDefaultRight = ");
        builder.append(" (").append(getWCellPaddingDefaultRight())
                .append(" )\n");
        builder.append("    .ftsCellPaddingDefaultTop = ");
        builder.append(" (").append(getFtsCellPaddingDefaultTop())
                .append(" )\n");
        builder.append("    .ftsCellPaddingDefaultLeft = ");
        builder.append(" (").append(getFtsCellPaddingDefaultLeft())
                .append(" )\n");
        builder.append("    .ftsCellPaddingDefaultBottom = ");
        builder.append(" (").append(getFtsCellPaddingDefaultBottom())
                .append(" )\n");
        builder.append("    .ftsCellPaddingDefaultRight = ");
        builder.append(" (").append(getFtsCellPaddingDefaultRight())
                .append(" )\n");
        ...
        builder.append(" (").append(getWCellSpacingDefaultLeft())
                .append(" )\n");
        builder.append("    .wCellSpacingDefaultBottom = ");
        builder.append(" (").append(getWCellSpacingDefaultBottom())
                .append(" )\n");
        builder.append("    .wCellSpacingDefaultRight = ");
        builder.append(" (").append(getWCellSpacingDefaultRight())
                .append(" )\n");
        builder.append("    .ftsCellSpacingDefaultTop = ");
        builder.append(" (").append(getFtsCellSpacingDefaultTop())
                .append(" )\n");
        builder.append("    .ftsCellSpacingDefaultLeft = ");
        builder.append(" (").append(getFtsCellSpacingDefaultLeft())
                .append(" )\n");
        builder.append("    .ftsCellSpacingDefaultBottom = ");
        builder.append(" (").append(getFtsCellSpacingDefaultBottom())
                .append(" )\n");
        builder.append("    .ftsCellSpacingDefaultRight = ");
        builder.append(" (").append(getFtsCellSpacingDefaultRight())
                .append(" )\n");
        ...
        builder.append(" (").append(getWCellPaddingOuterBottom())
                .append(" )\n");
        ...
        builder.append(" (").append(getFtsCellPaddingOuterLeft())
                .append(" )\n");
        builder.append("    .ftsCellPaddingOuterBottom = ");
        builder.append(" (").append(getFtsCellPaddingOuterBottom())
                .append(" )\n");
        builder.append("    .ftsCellPaddingOuterRight = ");
        builder.append(" (").append(getFtsCellPaddingOuterRight())
                .append(" )\n");
        ...
        builder.append(" (").append(getWCellSpacingOuterBottom())
                .append(" )\n");
        ...
        builder.append(" (").append(getFtsCellSpacingOuterLeft())
                .append(" )\n");
        builder.append("    .ftsCellSpacingOuterBottom = ");
        builder.append(" (").append(getFtsCellSpacingOuterBottom())
                .append(" )\n");
        builder.append("    .ftsCellSpacingOuterRight = ");
        builder.append(" (").append(getFtsCellSpacingOuterRight())
                .append(" )\n");
        builder.append("    .rgtc                 = ");
     ...
     * its column. 0 -- left justify, 1 -- center, 2 -- right justify.
     */
    @Internal
    public short getJc() {
        return field_2_jc;
    ...
    /**
     * Measures half of the white space that will be maintained between text in
    ...
    /**
     * When greater than 0, guarantees that the height of the table will be at
     * least dyaRowHeight high. When less than 0, guarantees that the height of
     * the table will be exactly absolute value of dyaRowHeight high. When 0,
     * table will be given a height large enough to represent all of the text in
     * all of the cells of the table. Cells with vertical text flow make no
     * contribution to the computation of the height of rows with auto or at
     * least height. Neither do vertically merged cells, except in the last row
     * of the vertical merge. If an auto height row consists entirely of cells
     * which have vertical text direction or are vertically merged, and the row
     * does not contain the last cell in any vertical cell merge, then the row
     * is given height equal to that of the end of cell mark in the first cell..
     */
    @Internal
    ...
    /**
     * When 1, table row may not be split across page bounds. Used for Word 2000
     * and Word 97..
     */
    @Internal
    ...
    /**
     * Width of invisible cell (used for layout purposes) before the first
    ...
    /**
     * Width of invisible cell (used for layout purposes) after the last visible
     * cell in the row..
     */
    @Internal
    ...
    /**
     * When 1, table is right-to-left. Logical right-to-left table: The CP
     * stream of a right-to-left table is meant to be displayed from right to
     * left. So for example the first table cell is displayed on the right side
     * of the table instead of the left..
     */
    @Internal
    ...
    /**
     * Word 2000 style right-to-left table. Visual right-to-left table: The CP
     * stream of a right-to-left table is displayed from left to right just as
     * for a normal table. So, the text which is meant to be in the first
     * (rightmost) table cell must be placed in the last table cell in the CP
     * stream..
     */
    @Internal
    public byte getFRTL() {
    ...
    /**
     * When set to 1, do not allow absolutely positioned table to overlap with
     * other tables.
     */
    @Internal
    ...
    /**
     * Count of cells defined for this row. itcMac must be >= 0 and less than or
     * equal to 64..
     */
    @Internal
    ...
    /**
     * rgdxaCenter[0] is the left boundary of cell 0 measured relative to margin
     * rgdxaCenter[tap.itcMac - 1] is left boundary of last cell
     * rgdxaCenter[tap.itcMac] is right boundary of last cell..
     */
    @Internal
    ...
    /**
     * Default top cell margin/padding units. 0 -- null; 1-2 -- not relevant; 3
     * -- twips..
     */
    @Internal
    ...
    /**
     * Default left cell margin/padding units. 0 -- null; 1-2 -- not relevant; 3
     * -- twips..
     */
    @Internal
    ...
    /**
     * Default bottom cell margin/padding units. 0 -- null; 1-2 -- not relevant;
     * 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default right cell margin/padding units. 0 -- null; 1-2 -- not relevant;
     * 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default top cell spacings units. 0 -- null; 1-2 -- not relevant; 3 --
     * twips..
     */
    @Internal
    ...
    /**
     * Default left cell spacings units. 0 -- null; 1-2 -- not relevant; 3 --
     * twips..
     */
    @Internal
    ...
    /**
     * Default bottom cell spacings units. 0 -- null; 1-2 -- not relevant; 3 --
     * twips..
     */
    @Internal
    ...
    /**
     * Default right cell spacings units. 0 -- null; 1-2 -- not relevant; 3 --
     * twips..
     */
    @Internal
    ...
    /**
     * Default outer top cell margin/padding units. 0 -- null; 1-2 -- not
     * relevant; 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default outer left cell margin/padding units. 0 -- null; 1-2 -- not
     * relevant; 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default outer bottom cell margin/padding units. 0 -- null; 1-2 -- not
     * relevant; 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default outer right cell margin/padding units. 0 -- null; 1-2 -- not
     * relevant; 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default outer top cell spacings units. 0 -- null; 1-2 -- not relevant; 3
     * -- twips..
     */
    @Internal
    ...
    /**
     * Default outer left cell spacings units. 0 -- null; 1-2 -- not relevant; 3
     * -- twips..
     */
    @Internal
    ...
    /**
     * Default outer bottom cell spacings units. 0 -- null; 1-2 -- not relevant;
     * 3 -- twips..
     */
    @Internal
    ...
    /**
     * Default outer right cell spacings units. 0 -- null; 1-2 -- not relevant;
     * 3 -- twips..
     */
    @Internal
