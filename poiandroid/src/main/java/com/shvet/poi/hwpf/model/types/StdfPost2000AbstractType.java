...
public abstract class StdfPost2000AbstractType {
    ...
    public String toString() {
        ...
        builder.append("         .istdLink                 = ")
                .append(getIstdLink()).append('\n');
        builder.append("         .fHasOriginalStyle        = ")
                .append(isFHasOriginalStyle()).append('\n');
        builder.append("         .fSpare                   = ")
                .append(getFSpare()).append('\n');
        builder.append("    .rsid                 = ");
        builder.append(" (").append(getRsid()).append(" )\n");
        builder.append("    .info3                = ");
        builder.append(" (").append(getInfo3()).append(" )\n");
        builder.append("         .iftcHtml                 = ")
                .append(getIftcHtml()).append('\n');
        builder.append("         .unused                   = ")
                .append(isUnused()).append('\n');
        builder.append("         .iPriority                = ")
                .append(getIPriority()).append('\n');
    ...
    /**
     * An unsigned integer that specifies the revision save identifier of the
     * session when this style definition was last modified.
     */
    @Internal
    public long getRsid() {
        return field_2_rsid;
    ...
    /**
     * An unsigned integer that specifies the istd of the style that is linked
     * to this one, or 0x0000 if this style is not linked to any other style in
     * the document.
     *
    ...
    /**
     * Sets the istdLink field value. An unsigned integer that specifies the
     * istd of the style that is linked to this one, or 0x0000 if this style is
     * not linked to any other style in the document.
     */
    @Internal
    ...
    /**
     * Specifies whether the style is revision-marked. A revision-marked style
     * stores the pre-revision formatting in addition to the current formatting.
     * If this bit is set to 1, the cupx member of StdfBase MUST include the
    ...
    /**
     * Sets the fHasOriginalStyle field value. Specifies whether the style is
     * revision-marked. A revision-marked style stores the pre-revision
     * formatting in addition to the current formatting. If this bit is set to
     * 1, the cupx member of StdfBase MUST include the formatting sets that
     * specify that pre-revision formatting
     */
    @Internal
    public void setFHasOriginalStyle(boolean value) {
        field_1_info1 = (short) fHasOriginalStyle.setBoolean(field_1_info1,
                value);
    }
    ...
    /**
     * Sets the fSpare field value. Specifies whether the paragraph height
     * information in the fcPlcfPhe field of FibRgFcLcb97
     */
    @Internal
    ...
    /**
     * Sets the iftcHtml field value. This field is undefined and MUST be
     * ignored
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the priority value that is assigned to
     * this style and that is used when ordering the styles by priority in the
     * user interface
     *
    ...
    /**
     * Sets the iPriority field value. An unsigned integer that specifies the
     * priority value that is assigned to this style and that is used when
     * ordering the styles by priority in the user interface
     */
    @Internal
