...
public abstract class FFDataBaseAbstractType {
    ...
    public boolean equals(Object obj) {
        ...
        if (field_3_cch != other.field_3_cch)
            return false;
        return field_4_hps == other.field_4_hps;
    }
    ...
    public String toString() {
        ...
        builder.append("         .iType                    = ")
                .append(getIType()).append('\n');
        builder.append("         .iRes                     = ")
                .append(getIRes()).append('\n');
        builder.append("         .fOwnHelp                 = ")
                .append(isFOwnHelp()).append('\n');
        builder.append("         .fOwnStat                 = ")
                .append(isFOwnStat()).append('\n');
        builder.append("         .fProt                    = ")
                .append(isFProt()).append('\n');
        builder.append("         .iSize                    = ")
                .append(isISize()).append('\n');
        builder.append("         .iTypeTxt                 = ")
                .append(getITypeTxt()).append('\n');
        builder.append("         .fRecalc                  = ")
                .append(isFRecalc()).append('\n');
        builder.append("         .fHasListBox              = ")
                .append(isFHasListBox()).append('\n');
        builder.append("    .cch                  = ");
     ...
     * the value of the textbox. This value MUST NOT exceed 32767. A value of 0
     * means there is no maximum length of the value of the textbox. If
     * bits.iType is not iTypeText (0), this value MUST be 0..
     */
    @Internal
    public int getCch() {
        return field_3_cch;
    ...
    /**
     * An unsigned integer. If bits.iType is iTypeChck (1), hps specifies the
     * size, in half-points, of the checkbox and MUST be between 2 and 3168,
     * inclusive. If bits.iType is not iTypeChck (1), hps is undefined and MUST
     * be ignored..
     */
    @Internal
    public int getHps() {
    ...
    /**
     * Sets the iType field value. An unsigned integer that specifies the type
     * of the form field.
     */
    @Internal
    ...
    /**
     * An unsigned integer. If iType is iTypeText (0), then iRes MUST be 0. If
     * iType is iTypeChck (1), iRes specifies the state of the checkbox and MUST
     * be 0 (unchecked), 1 (checked), or 25 (undefined). Undefined checkboxes
     * are treated as unchecked. If iType is iTypeDrop (2), iRes specifies the
     * current selected list box item. A value of 25 specifies the selection is
     * undefined. Otherwise, iRes is a zero-based index into
     * FFData.hsttbDropList.
     *
    ...
    /**
     * Sets the iRes field value. An unsigned integer. If iType is iTypeText
     * (0), then iRes MUST be 0. If iType is iTypeChck (1), iRes specifies the
     * state of the checkbox and MUST be 0 (unchecked), 1 (checked), or 25
     * (undefined). Undefined checkboxes are treated as unchecked. If iType is
     * iTypeDrop (2), iRes specifies the current selected list box item. A value
     * of 25 specifies the selection is undefined. Otherwise, iRes is a
     * zero-based index into FFData.hsttbDropList.
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the form field has custom help text in
     * FFData.xstzHelpText. If fOwnHelp is 0, FFData.xstzHelpText contains an
     * empty or auto-generated string.
     *
    ...
    /**
     * Sets the fOwnHelp field value. A bit that specifies whether the form
     * field has custom help text in FFData.xstzHelpText. If fOwnHelp is 0,
     * FFData.xstzHelpText contains an empty or auto-generated string.
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the form field has custom status bar text in
     * FFData.xstzStatText. If fOwnStat is 0, FFData.xstzStatText contains an
     * empty or auto-generated string.
     *
    ...
    /**
     * Sets the fOwnStat field value. A bit that specifies whether the form
     * field has custom status bar text in FFData.xstzStatText. If fOwnStat is
     * 0, FFData.xstzStatText contains an empty or auto-generated string.
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the form field is protected and its value
     * cannot be changed.
     *
    ...
    /**
     * Sets the fProt field value. A bit that specifies whether the form field
     * is protected and its value cannot be changed.
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the size of a checkbox is automatically
     * determined by the text size where the checkbox is located. This value
    ...
    /**
     * Sets the iSize field value. A bit that specifies whether the size of a
     * checkbox is automatically determined by the text size where the checkbox
    ...
    /**
     * An unsigned integer that specifies the type of the textbox. If iType is
     * not iTypeText (0), iTypeTxt MUST be 0 and MUST be ignored.
     *
    ...
    /**
     * Sets the iTypeTxt field value. An unsigned integer that specifies the
     * type of the textbox. If iType is not iTypeText (0), iTypeTxt MUST be 0
     * and MUST be ignored.
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the value of the field is automatically
     * calculated after the field is modified.
     *
    ...
    /**
     * Sets the fRecalc field value. A bit that specifies whether the value of
     * the field is automatically calculated after the field is modified.
     */
    @Internal
    ...
    /**
     * A bit that specifies that the form field has a list box. This value MUST
    ...
    /**
     * Sets the fHasListBox field value. A bit that specifies that the form
     * field has a list box. This value MUST be 1 if iType is iTypeDrop (2).
