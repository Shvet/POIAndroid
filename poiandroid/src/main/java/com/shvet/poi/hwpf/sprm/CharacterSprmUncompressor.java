...
import com.shvet.poi.hwpf.usermodel.CharacterProperties;
import com.shvet.poi.hwpf.usermodel.DateAndTime;
import com.shvet.poi.hwpf.usermodel.ShadingDescriptor;
import com.shvet.poi.hwpf.usermodel.ShadingDescriptor80;
...
public final class CharacterSprmUncompressor extends SprmUncompressor {
    ...
    /**
     * Used in decompression of a chpx. This performs an operation defined by a
     * single sprm.
     *
     ...
     * @param varParam   The variable length parameter defined by the sprm. (See Word
     *                   file format spec)
    ...
    static void unCompressCHPOperation(CharacterProperties oldCHP,
                                       CharacterProperties newCHP, SprmOperation sprm) {
        ...
        switch (sprm.getOperation()) {
            ...
            case 0x4:
                ...
                break;
            case 0x5:
                newCHP.setDttmRMark(new DateAndTime(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x6:
            ...
            case 0x9:
                newCHP.setFSpec(true);
                newCHP.setFtcSym(LittleEndian.getShort(sprm.getGrpprl(),
                        sprm.getGrpprlOffset()));
                newCHP.setXchSym(LittleEndian.getShort(sprm.getGrpprl(),
            ...
            case 0x34:
                ...
                break;
            case 0x35:
                newCHP.setFBold(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFBold()));
                break;
            case 0x36:
                newCHP.setFItalic(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFItalic()));
                break;
            case 0x37:
                newCHP.setFStrike(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFStrike()));
                break;
            case 0x38:
                newCHP.setFOutline(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFOutline()));
                break;
            case 0x39:
                newCHP.setFShadow(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFShadow()));
                break;
            case 0x3a:
                newCHP.setFSmallCaps(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFSmallCaps()));
                break;
            case 0x3b:
                newCHP.setFCaps(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFCaps()));
                break;
            case 0x3c:
                newCHP.setFVanish(getCHPFlag((byte) sprm.getOperand(),
                        oldCHP.isFVanish()));
                break;
            case 0x3d:
            ...
            case 0x3f:
                ...
                if (fAdjust && hpsPos != 128 && hpsPos != 0
                        && oldCHP.getHpsPos() == 0) {
			 ...
			 * genCHP.setFtcAscii (4); genCHP = (CharacterProperties)
			 * unCompressProperty (varParam, genCHP, styleSheet);
			 * CharacterProperties styleCHP = styleSheet.getStyleDescription
			 * (oldCHP. getBaseIstd ()).getCHP (); if (genCHP.isFBold () ==
			 * newCHP.isFBold ()) { newCHP.setFBold (styleCHP.isFBold ()); } if
			 * (genCHP.isFItalic () == newCHP.isFItalic ()) { newCHP.setFItalic
			 * (styleCHP.isFItalic ()); } if (genCHP.isFSmallCaps () ==
			 * newCHP.isFSmallCaps ()) { newCHP.setFSmallCaps
			 * (styleCHP.isFSmallCaps ()); } if (genCHP.isFVanish () ==
			 * newCHP.isFVanish ()) { newCHP.setFVanish (styleCHP.isFVanish ());
			 * } if (genCHP.isFStrike () == newCHP.isFStrike ()) {
			 * newCHP.setFStrike (styleCHP.isFStrike ()); } if (genCHP.isFCaps
			 * () == newCHP.isFCaps ()) { newCHP.setFCaps (styleCHP.isFCaps ());
			 * } if (genCHP.getFtcAscii () == newCHP.getFtcAscii ()) {
			 * newCHP.setFtcAscii (styleCHP.getFtcAscii ()); } if
			 * (genCHP.getFtcFE () == newCHP.getFtcFE ()) { newCHP.setFtcFE
			 * (styleCHP.getFtcFE ()); } if (genCHP.getFtcOther () ==
			 * newCHP.getFtcOther ()) { newCHP.setFtcOther (styleCHP.getFtcOther
			 * ()); } if (genCHP.getHps () == newCHP.getHps ()) { newCHP.setHps
			 * (styleCHP.getHps ()); } if (genCHP.getHpsPos () ==
			 * newCHP.getHpsPos ()) { newCHP.setHpsPos (styleCHP.getHpsPos ());
			 * } if (genCHP.getKul () == newCHP.getKul ()) { newCHP.setKul
			 * (styleCHP.getKul ()); } if (genCHP.getDxaSpace () ==
			 * newCHP.getDxaSpace ()) { newCHP.setDxaSpace (styleCHP.getDxaSpace
			 * ()); } if (genCHP.getIco () == newCHP.getIco ()) { newCHP.setIco
			 * (styleCHP.getIco ()); } if (genCHP.getLidDefault () ==
			 * newCHP.getLidDefault ()) { newCHP.setLidDefault
			 * (styleCHP.getLidDefault ()); } if (genCHP.getLidFE () ==
			 * newCHP.getLidFE ()) { newCHP.setLidFE (styleCHP.getLidFE ()); }
			 */
                break;
            case 0x48:
                ...
                break;
            case 0x49:
                newCHP.setHps(LittleEndian.getShort(sprm.getGrpprl(),
                        sprm.getGrpprlOffset()));
                break;
            case 0x4a:
                int increment = LittleEndian.getShort(sprm.getGrpprl(),
                        sprm.getGrpprlOffset());
            ...
            case 0x63:
                ...
                break;
            case 0x64:
                newCHP.setDttmRMarkDel(new DateAndTime(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x65:
                newCHP.setBrc(new BorderCode(sprm.getGrpprl(), sprm
                        .getGrpprlOffset()));
                break;
            case 0x66:
                // sprmCShd80
    ...
    private static boolean getCHPFlag(byte x, boolean oldVal) {
		/*
		 * switch(x) { case 0: return false; case 1: return true; case
		 * (byte)0x80: return oldVal; case (byte)0x81: return !oldVal; default:
		 * return false; }
		 */
        if (x == 0) {
            return false;
