...
import com.shvet.poi.hwpf.usermodel.ObjectPoolImpl;
import com.shvet.poi.hwpf.usermodel.ObjectsPool;
...
/**
 * This class holds much of the core of a Word document, but without some of the
 * table structure information. You generally want to work with one of
...
public abstract class HWPFDocumentCore extends POIDocument {
    ...
    public HWPFDocumentCore(DirectoryNode directory) throws IOException {
        ...
        directory.createDocumentInputStream(STREAM_WORD_DOCUMENT).read(
                _mainStream);
