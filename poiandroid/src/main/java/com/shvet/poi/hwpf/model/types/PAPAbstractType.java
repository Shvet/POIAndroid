...
import com.shvet.poi.hwpf.model.TabDescriptor;
import com.shvet.poi.hwpf.usermodel.BorderCode;
import com.shvet.poi.hwpf.usermodel.DateAndTime;
import com.shvet.poi.hwpf.usermodel.DropCapSpecifier;
import com.shvet.poi.hwpf.usermodel.LineSpacingDescriptor;
...
public abstract class PAPAbstractType {
    ...
    public String toString() {
        ...
        builder.append(" (").append(Arrays.toString(getRgdxaTab()))
                .append(" )\n");
     ...
     * Border line style.
     *
     * @return One of <li>{@link #BRCL_SINGLE} <li>{@link #BRCL_THICK} <li>
     * {@link #BRCL_DOUBLE} <li>{@link #BRCL_SHADOW}
     */
    @Internal
    public byte getBrcl() {
        return field_6_brcl;
     ...
     * Border line style.
     *
     * @param field_6_brcl One of <li>{@link #BRCL_SINGLE} <li>{@link #BRCL_THICK} <li>
     *                     {@link #BRCL_DOUBLE} <li>{@link #BRCL_SHADOW}
     */
    @Internal
     ...
     *
     * @return One of <li>{@link #BRCP_NONE} <li>{@link #BRCP_BORDER_ABOVE} <li>
     * {@link #BRCP_BORDER_BELOW} <li>{@link #BRCP_BOX_AROUND} <li>
     ...
     * Rectangle border codes.
     *
     * @param field_7_brcp One of <li>{@link #BRCP_NONE} <li>{@link #BRCP_BORDER_ABOVE}
     *                     <li>{@link #BRCP_BORDER_BELOW} <li>{@link #BRCP_BOX_AROUND}
     ...
     *
     * @return One of <li>{@link #FMINHEIGHT_EXACT} <li>
     ...
     * Minimum height is exact or auto.
     *
     * @param field_27_fMinHeight One of <li>{@link #FMINHEIGHT_EXACT} <li>
     *                            {@link #FMINHEIGHT_AT_LEAST}
     */
    @Internal
    ...
    /**
     * 1, Word will prevent widowed lines in this paragraph from being placed at
     ...
     *
     * @return One of <li>{@link #WALIGNFONT_HANGING} <li>
     * {@link #WALIGNFONT_CENTERED} <li>{@link #WALIGNFONT_ROMAN} <li>
     * {@link #WALIGNFONT_VARIABLE} <li>{@link #WALIGNFONT_AUTO}
     */
    @Internal
     ...
     *
     * @param field_39_wAlignFont One of <li>{@link #WALIGNFONT_HANGING} <li>
     *                            {@link #WALIGNFONT_CENTERED} <li>{@link #WALIGNFONT_ROMAN} <li>
     *                            {@link #WALIGNFONT_VARIABLE} <li>{@link #WALIGNFONT_AUTO}
     */
    @Internal
    ...
    /**
     * When 1, the end of paragraph mark is really an end of cell mark for a
     * nested table cell.
     */
    @Internal
    ...
    /**
     * Word 97 compatibility indicates this end of paragraph mark is really an
     * end of row marker for a nested table.
     */
    @Internal
    ...
    /**
     * When 1, absolutely positioned paragraph cannot overlap with another
     * paragraph.
     */
    @Internal
    ...
    public void setFVertical(boolean value) {
        field_40_fontAlign = (short) fVertical.setBoolean(field_40_fontAlign,
                value);
    }
    ...
    public void setFBackward(boolean value) {
        field_40_fontAlign = (short) fBackward.setBoolean(field_40_fontAlign,
                value);
    }
    ...
    public void setFRotateFont(boolean value) {
        field_40_fontAlign = (short) fRotateFont.setBoolean(field_40_fontAlign,
                value);
    }
