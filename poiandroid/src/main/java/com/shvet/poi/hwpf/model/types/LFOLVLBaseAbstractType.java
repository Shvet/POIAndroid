...
public abstract class LFOLVLBaseAbstractType {
    ...
    public boolean equals(Object obj) {
        ...
        if (field_1_iStartAt != other.field_1_iStartAt)
            return false;
        return field_2_flags == other.field_2_flags;
    }
    ...
    public String toString() {
        ...
        builder.append("         .iLvl                     = ")
                .append(getILvl()).append('\n');
        builder.append("         .fStartAt                 = ")
                .append(isFStartAt()).append('\n');
        builder.append("         .fFormatting              = ")
                .append(isFFormatting()).append('\n');
        builder.append("         .grfhic                   = ")
                .append(getGrfhic()).append('\n');
        builder.append("         .unused1                  = ")
                .append(getUnused1()).append('\n');
        builder.append("         .unused2                  = ")
                .append(getUnused2()).append('\n');
    ...
    /**
     * If fStartAt is set to 0x1, this is a signed integer that specifies the
     * start-at value that overrides lvlf.iStartAt of the corresponding LVL.
     * This value MUST be less than or equal to 0x7FFF and MUST be greater than
     * or equal to zero. If both fStartAt and fFormatting are set to 0x1, or if
     * fStartAt is set to 0x0, this value is undefined and MUST be ignored.
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the zero-based level of the list that
     * this overrides. This LFOLVL overrides the LVL that specifies the level
     * formatting of this level of the LSTF that is specified by the lsid field
     * of the LFO to which this LFOLVL corresponds. This value MUST be less than
     * or equal to 0x08
     *
    ...
    /**
     * Sets the iLvl field value. An unsigned integer that specifies the
     * zero-based level of the list that this overrides. This LFOLVL overrides
     * the LVL that specifies the level formatting of this level of the LSTF
     * that is specified by the lsid field of the LFO to which this LFOLVL
     * corresponds. This value MUST be less than or equal to 0x08
     */
    @Internal
    ...
    /**
     * A bit that specifies whether this LFOLVL overrides the start-at value of
     * the level.
     *
    ...
    /**
     * Sets the fStartAt field value. A bit that specifies whether this LFOLVL
     * overrides the start-at value of the level.
     */
    @Internal
    ...
    /**
     * A bit that specifies whether lvl is an LVL that overrides the
     * corresponding LVL
     *
    ...
    /**
     * Sets the fFormatting field value. A bit that specifies whether lvl is an
     * LVL that overrides the corresponding LVL
     */
    @Internal
    ...
    /**
     * A grfhic that specifies the HTML incompatibilities of the overriding
     * level formatting
     *
    ...
    /**
     * Sets the grfhic field value. A grfhic that specifies the HTML
     * incompatibilities of the overriding level formatting
     */
    @Internal
