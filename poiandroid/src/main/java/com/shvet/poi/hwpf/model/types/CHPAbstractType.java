...
import com.shvet.poi.hwpf.model.Colorref;
import com.shvet.poi.hwpf.model.Hyphenation;
import com.shvet.poi.hwpf.usermodel.BorderCode;
import com.shvet.poi.hwpf.usermodel.DateAndTime;
import com.shvet.poi.hwpf.usermodel.ShadingDescriptor;
...
public abstract class CHPAbstractType {
    ...
    /**/private static final BitField fUsePgsuSettings = new BitField(
            0x00080000);
    /**/private static final BitField fBoldBi = new BitField(0x00100000);
    /**/private static final BitField fComplexScripts = new BitField(
            0x00100000);
    ...
    /**/private static final BitField fWarichuNoOpenBracket = new BitField(
            0x08);
    ...
    public boolean equals(Object obj) {
        ...
        if (field_61_dttmDispFldRMark == null) {
            if (other.field_61_dttmDispFldRMark != null)
                return false;
        } else if (!field_61_dttmDispFldRMark
                .equals(other.field_61_dttmDispFldRMark))
            return false;
        if (!Arrays.equals(field_62_xstDispFldRMark,
                other.field_62_xstDispFldRMark))
            return false;
        ...
        if (field_67_fSdtVanish != other.field_67_fSdtVanish)
            return false;
        return field_68_wCharScale == other.field_68_wCharScale;
    }
    ...
    public int hashCode() {
        ...
        result = prime
                * result
                + ((field_40_hresiOld == null) ? 0 : field_40_hresiOld
                .hashCode());
        result = prime * result + field_41_ibstRMarkDel;
        result = prime
                * result
                + ((field_42_dttmRMark == null) ? 0 : field_42_dttmRMark
                .hashCode());
        result = prime
                * result
                + ((field_43_dttmRMarkDel == null) ? 0 : field_43_dttmRMarkDel
                .hashCode());
        ...
        result = prime
                * result
                + ((field_53_dttmPropRMark == null) ? 0
                : field_53_dttmPropRMark.hashCode());
        ...
        result = prime
                * result
                + ((field_58_dttmConflict == null) ? 0 : field_58_dttmConflict
                .hashCode());
        result = prime * result + (field_59_fDispFldRMark ? 1231 : 1237);
        result = prime * result + field_60_ibstDispFldRMark;
        result = prime
                * result
                + ((field_61_dttmDispFldRMark == null) ? 0
                : field_61_dttmDispFldRMark.hashCode());
    ...
    public String toString() {
        ...
        builder.append("         .fBold                    = ")
                .append(isFBold()).append('\n');
        builder.append("         .fItalic                  = ")
                .append(isFItalic()).append('\n');
        builder.append("         .fRMarkDel                = ")
                .append(isFRMarkDel()).append('\n');
        builder.append("         .fOutline                 = ")
                .append(isFOutline()).append('\n');
        builder.append("         .fFldVanish               = ")
                .append(isFFldVanish()).append('\n');
        builder.append("         .fSmallCaps               = ")
                .append(isFSmallCaps()).append('\n');
        builder.append("         .fCaps                    = ")
                .append(isFCaps()).append('\n');
        builder.append("         .fVanish                  = ")
                .append(isFVanish()).append('\n');
        builder.append("         .fRMark                   = ")
                .append(isFRMark()).append('\n');
        builder.append("         .fSpec                    = ")
                .append(isFSpec()).append('\n');
        builder.append("         .fStrike                  = ")
                .append(isFStrike()).append('\n');
        builder.append("         .fObj                     = ")
                .append(isFObj()).append('\n');
        builder.append("         .fShadow                  = ")
                .append(isFShadow()).append('\n');
        builder.append("         .fLowerCase               = ")
                .append(isFLowerCase()).append('\n');
        builder.append("         .fData                    = ")
                .append(isFData()).append('\n');
        builder.append("         .fOle2                    = ")
                .append(isFOle2()).append('\n');
        builder.append("         .fEmboss                  = ")
                .append(isFEmboss()).append('\n');
        builder.append("         .fImprint                 = ")
                .append(isFImprint()).append('\n');
        builder.append("         .fDStrike                 = ")
                .append(isFDStrike()).append('\n');
        builder.append("         .fUsePgsuSettings         = ")
                .append(isFUsePgsuSettings()).append('\n');
        builder.append("         .fBoldBi                  = ")
                .append(isFBoldBi()).append('\n');
        builder.append("         .fComplexScripts          = ")
                .append(isFComplexScripts()).append('\n');
        builder.append("         .fItalicBi                = ")
                .append(isFItalicBi()).append('\n');
        builder.append("         .fBiDi                    = ")
                .append(isFBiDi()).append('\n');
        builder.append("         .fIcoBi                   = ")
                .append(isFIcoBi()).append('\n');
        builder.append("         .fNonGlyph                = ")
                .append(isFNonGlyph()).append('\n');
        builder.append("         .fBoldOther               = ")
                .append(isFBoldOther()).append('\n');
        builder.append("         .fItalicOther             = ")
                .append(isFItalicOther()).append('\n');
        builder.append("         .fNoProof                 = ")
                .append(isFNoProof()).append('\n');
        builder.append("         .fWebHidden               = ")
                .append(isFWebHidden()).append('\n');
        builder.append("         .fFitText                 = ")
                .append(isFFitText()).append('\n');
        builder.append("         .fCalc                    = ")
                .append(isFCalc()).append('\n');
        builder.append("         .fFmtLineProp             = ")
                .append(isFFmtLineProp()).append('\n');
        builder.append("    .hps                  = ");
        ...
        builder.append("         .itypFELayout             = ")
                .append(getItypFELayout()).append('\n');
        builder.append("         .fTNY                     = ")
                .append(isFTNY()).append('\n');
        builder.append("         .fWarichu                 = ")
                .append(isFWarichu()).append('\n');
        builder.append("         .fKumimoji                = ")
                .append(isFKumimoji()).append('\n');
        builder.append("         .fRuby                    = ")
                .append(isFRuby()).append('\n');
        builder.append("         .fLSFitText               = ")
                .append(isFLSFitText()).append('\n');
        builder.append("         .spare                    = ")
                .append(getSpare()).append('\n');
        builder.append("    .copt                 = ");
        builder.append(" (").append(getCopt()).append(" )\n");
        builder.append("         .iWarichuBracket          = ")
                .append(getIWarichuBracket()).append('\n');
        builder.append("         .fWarichuNoOpenBracket     = ")
                .append(isFWarichuNoOpenBracket()).append('\n');
        builder.append("         .fTNYCompress             = ")
                .append(isFTNYCompress()).append('\n');
        builder.append("         .fTNYFetchTxm             = ")
                .append(isFTNYFetchTxm()).append('\n');
        builder.append("         .fCellFitText             = ")
                .append(isFCellFitText()).append('\n');
        builder.append("         .unused                   = ")
                .append(isUnused()).append('\n');
        ...
        builder.append("         .icoHighlight             = ")
                .append(getIcoHighlight()).append('\n');
        builder.append("         .fHighlight               = ")
                .append(isFHighlight()).append('\n');
        builder.append("    .CharsetFlags         = ");
        builder.append(" (").append(getCharsetFlags()).append(" )\n");
        builder.append("         .fChsDiff                 = ")
                .append(isFChsDiff()).append('\n');
        builder.append("         .fMacChs                  = ")
                .append(isFMacChs()).append('\n');
        builder.append("    .chse                 = ");
        ...
        builder.append(" (").append(Arrays.toString(getXstDispFldRMark()))
                .append(" )\n");
     ...
     * Emphasis mark.
     *
     * @return One of <li>{@link #KCD_NON} <li>{@link #KCD_DOT} <li>
     * {@link #KCD_COMMA} <li>{@link #KCD_CIRCLE} <li>
     * {@link #KCD_UNDER_DOT}
     */
    @Internal
    public byte getKcd() {
     ...
     * Emphasis mark.
     *
     * @param field_13_kcd One of <li>{@link #KCD_NON} <li>{@link #KCD_DOT} <li>
     *                     {@link #KCD_COMMA} <li>{@link #KCD_CIRCLE} <li>
     *                     {@link #KCD_UNDER_DOT}
     */
    @Internal
     ...
     *
     * @return One of <li>{@link #ISS_NONE} <li>{@link #ISS_SUPERSCRIPTED} <li>
     * {@link #ISS_SUBSCRIPTED}
     */
    @Internal
    public byte getIss() {
        return field_15_iss;
     ...
     * Superscript/subscript indices.
     *
     * @param field_15_iss One of <li>{@link #ISS_NONE} <li>{@link #ISS_SUPERSCRIPTED}
     ...
     * Underline code.
     *
     * @return One of <li>{@link #KUL_NONE} <li>{@link #KUL_SINGLE} <li>
     * {@link #KUL_BY_WORD} <li>{@link #KUL_DOUBLE} <li>
     * {@link #KUL_DOTTED} <li>{@link #KUL_HIDDEN} <li>
     * {@link #KUL_THICK} <li>{@link #KUL_DASH} <li>{@link #KUL_DOT} <li>
     * {@link #KUL_DOT_DASH} <li>{@link #KUL_DOT_DOT_DASH} <li>
     * {@link #KUL_WAVE} <li>{@link #KUL_DOTTED_HEAVY} <li>
     * {@link #KUL_DASHED_HEAVY} <li>{@link #KUL_DOT_DASH_HEAVY} <li>
     * {@link #KUL_DOT_DOT_DASH_HEAVY} <li>{@link #KUL_WAVE_HEAVY} <li>
     * {@link #KUL_DASH_LONG} <li>{@link #KUL_WAVE_DOUBLE} <li>
     ...
     * Underline code.
     *
     * @param field_19_kul One of <li>{@link #KUL_NONE} <li>{@link #KUL_SINGLE} <li>
     *                     {@link #KUL_BY_WORD} <li>{@link #KUL_DOUBLE} <li>
     *                     {@link #KUL_DOTTED} <li>{@link #KUL_HIDDEN} <li>
     *                     {@link #KUL_THICK} <li>{@link #KUL_DASH} <li>{@link #KUL_DOT}
     *                     <li>{@link #KUL_DOT_DASH} <li>{@link #KUL_DOT_DOT_DASH} <li>
     *                     {@link #KUL_WAVE} <li>{@link #KUL_DOTTED_HEAVY} <li>
     *                     {@link #KUL_DASHED_HEAVY} <li>{@link #KUL_DOT_DASH_HEAVY} <li>
     *                     {@link #KUL_DOT_DOT_DASH_HEAVY} <li>{@link #KUL_WAVE_HEAVY}
     *                     <li>{@link #KUL_DASH_LONG} <li>{@link #KUL_WAVE_DOUBLE} <li>
     *                     {@link #KUL_DASH_LONG_HEAVY}
     */
    @Internal
     ...
     * Text animation.
     *
     * @return One of <li>{@link #SFXTTEXT_NO} <li>
     * {@link #SFXTTEXT_LAS_VEGAS_LIGHTS} <li>
     * {@link #SFXTTEXT_BACKGROUND_BLINK} <li>
     * {@link #SFXTTEXT_SPARKLE_TEXT} <li>
     * {@link #SFXTTEXT_MARCHING_ANTS} <li>
     * {@link #SFXTTEXT_MARCHING_RED_ANTS} <li>{@link #SFXTTEXT_SHIMMER}
     */
    @Internal
     ...
     * Text animation.
     *
     * @param field_26_sfxtText One of <li>{@link #SFXTTEXT_NO} <li>
     *                          {@link #SFXTTEXT_LAS_VEGAS_LIGHTS} <li>
     *                          {@link #SFXTTEXT_BACKGROUND_BLINK} <li>
     *                          {@link #SFXTTEXT_SPARKLE_TEXT} <li>
     *                          {@link #SFXTTEXT_MARCHING_ANTS} <li>
     *                          {@link #SFXTTEXT_MARCHING_RED_ANTS} <li>
    ...
    /**
     * Collection properties represented by itypFELayout and copt (East Asian
     * layout properties).
     */
    @Internal
    ...
    /**
     * an index into the rgffn structure. When chp.fSpec is 1 and the character
     * recorded for the run in the document stream is chSymbol (0x28),
     * chp.ftcSym identifies the font code of the symbol font that will be used
     * to display the symbol character recorded in chp.xchSym..
     */
    @Internal
    ...
    /**
     * When chp.fSpec==1 and the character recorded for the run in the document
     * stream is chSymbol (0x28), the character stored chp.xchSym will be
     * displayed using the font specified in chp.ftcSym..
     */
    @Internal
    ...
    /**
     * Offset in data stream pointing to beginning of a picture when character
    ...
    /**
     * Offset in data stream pointing to beginning of a picture when character
     * is an OLE1 object character (character is 0x20 and chp.fSpec is 1,
     * chp.fOle2 is 0)..
     */
    @Internal
    public int getFcObj() {
    ...
    /**
     * An object ID for an OLE object, only set if chp.fSpec and chp.fOle2 are
     ...
     * of text. When istd is istdNormalChar (10 decimal), characters in run are
     * not affected by a character style. If chp.istd contains any other value,
     * chpx of the specified character style are applied to CHP for this run
     * before any other exceptional properties are applied..
     */
    @Internal
    public int getIstd() {
    ...
    /**
     * Index to author IDs stored in hsttbfRMark. Used when properties have been
     * changed when revision marking was enabled..
     */
    @Internal
    ...
    /**
     * Date/time at which properties of this were changed for this run of text
     * by the author. (Only recorded when revision marking is on.).
     */
    @Internal
    ...
    /**
     * When chp.wConflict!=0, this is TRUE when text is part of the original
     * version of text. When FALSE, text is alternative introduced by
    ...
    /**
     * When fConflictOtherDel==fTrue, the other side of a reconciliation
     * conflict causes this text to be deleted.
     */
    @Internal
    ...
    /**
     * When != 0, index number that identifies all text participating in a
     * particular conflict incident.
     */
    @Internal
    ...
    /**
     * the number for a ListNum field is being tracked in xstDispFldRMark. If
     * that number is different from the current value, the number has changed.
     * Only valid for ListNum fields..
     */
    @Internal
     ...
     *
     * @return One of <li>{@link #LBRCRJ_NONE} <li>{@link #LBRCRJ_LEFT} <li>
     * {@link #LBRCRJ_RIGHT} <li>{@link #LBRCRJ_BOTH}
     */
    @Internal
     ...
     * Line BReak code for xchCRJ.
     *
     * @param field_64_lbrCRJ One of <li>{@link #LBRCRJ_NONE} <li>{@link #LBRCRJ_LEFT} <li>
     *                        {@link #LBRCRJ_RIGHT} <li>{@link #LBRCRJ_BOTH}
     */
    @Internal
    ...
    /**
     * Used for character property revision marking. The chp at the time
    ...
    /**
     * has been deleted and will be displayed with strikethrough when revision
    ...
    /**
     * Sets the fRMarkDel field value. has been deleted and will be displayed
     * with strikethrough when revision marked text is to be displayed
     */
    @Internal
    ...
    /**
     * text has hidden format, and is not displayed unless fPagHidden is set in
     * the DOP
     *
    ...
    /**
     * Sets the fVanish field value. text has hidden format, and is not
    ...
    /**
     * text is newly typed since the last time revision marks have been accepted
     * and will be displayed with an underline when revision marked text is to
     * be displayed
     *
    ...
    /**
     * Sets the fRMark field value. text is newly typed since the last time
     * revision marks have been accepted and will be displayed with an underline
    ...
    /**
     * Character is displayed in lower case. This field may be set to 1 only
    ...
    /**
     * Sets the fLowerCase field value. Character is displayed in lower case.
     * This field may be set to 1 only when chp.fSmallCaps is 1.
     */
    @Internal
    ...
    /**
     * chp.fcPic points to an FFDATA, the data structure binary data used by
     * Word to describe a form field. The bit chp.fData may only be 1 when
     * chp.fSpec is also 1 and the special character in the document stream that
     * has this property is a chPicture (0x01)
     *
    ...
    /**
     * Sets the fData field value. chp.fcPic points to an FFDATA, the data
     * structure binary data used by Word to describe a form field. The bit
     * chp.fData may only be 1 when chp.fSpec is also 1 and the special
    ...
    /**
     * chp.lTagObj specifies a particular object in the object stream that
     * specifies the particular OLE object in the stream that should be
     * displayed when the chPicture fSpec character that is tagged with the
     * fOle2 is encountered. The bit chp.fOle2 may only be 1 when chp.fSpec is
     * also 1 and the special character in the document stream that has this
    ...
    /**
     * Sets the fOle2 field value. chp.lTagObj specifies a particular object in
     * the object stream that specifies the particular OLE object in the stream
     * that should be displayed when the chPicture fSpec character that is
     * tagged with the fOle2 is encountered. The bit chp.fOle2 may only be 1
    ...
    /**
     * Complex Scripts text that requires special processing to display and
     * process
     *
    ...
    /**
     * Sets the fComplexScripts field value. Complex Scripts text that requires
     * special processing to display and process
     */
    @Internal
    ...
    /**
     * Complex Scripts right-to-left text that requires special processing to
     * display and process (character reordering; contextual shaping; display of
     * combining characters and diacritics; specialized justification rules;
     * cursor positioning)
     *
    ...
    /**
     * Sets the fBiDi field value. Complex Scripts right-to-left text that
     * requires special processing to display and process (character reordering;
     * contextual shaping; display of combining characters and diacritics;
     * specialized justification rules; cursor positioning)
     */
    @Internal
    ...
    /**
     * Sets the fBoldOther field value. Used internally by Word 97 and earlier
     * versions
     */
    @Internal
    ...
    /**
     * Sets the fItalicOther field value. Used internally by Word 97 and earlier
     * versions
     */
    @Internal
    ...
    /**
     * Sets the fNoProof field value. When set to 1, do not check spelling or
     * grammar
     */
    @Internal
    ...
    /**
     * Sets the fWebHidden field value. Text should be hidden in Web View when
     * set to 1
     */
    @Internal
    ...
    /**
     * Sets the fTNY field value. Tatenakayoko: Horizontal-in-vertical (range of
    ...
    /**
     * Two lines in one (text in the group is displayed as two half-height lines
     * within a line)
     *
    ...
    /**
     * Sets the fWarichu field value. Two lines in one (text in the group is
     * displayed as two half-height lines within a line)
     */
    @Internal
    ...
    /**
     * Sets the iWarichuBracket field value. Bracket character for
     * two-lines-in-one
     */
    @Internal
    ...
    public void setFWarichuNoOpenBracket(boolean value) {
        field_30_copt = (byte) fWarichuNoOpenBracket.setBoolean(field_30_copt,
                value);
    }
    ...
    public void setIcoHighlight(byte value) {
        field_48_Highlight = (short) icoHighlight.setValue(field_48_Highlight,
                value);
    }
    ...
    /**
     * Sets the fHighlight field value. When 1, characters are highlighted with
     * color specified by chp.icoHighlight
     */
    @Internal
    public void setFHighlight(boolean value) {
        field_48_Highlight = (short) fHighlight.setBoolean(field_48_Highlight,
                value);
    }
    ...
    /**
     * Sets the fChsDiff field value. Pre-Unicode files, char's char set
     * different from FIB char set
     */
    @Internal
    public void setFChsDiff(boolean value) {
        field_49_CharsetFlags = (short) fChsDiff.setBoolean(
                field_49_CharsetFlags, value);
    }
    ...
    public void setFMacChs(boolean value) {
        field_49_CharsetFlags = (short) fMacChs.setBoolean(
                field_49_CharsetFlags, value);
    }
