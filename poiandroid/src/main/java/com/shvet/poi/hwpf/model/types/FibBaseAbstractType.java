...
public abstract class FibBaseAbstractType {
    ...
    /**/private static final BitField fReadOnlyRecommended = new BitField(
            0x0400);
    ...
    public String toString() {
        ...
        builder.append("         .fDot                     = ")
                .append(isFDot()).append('\n');
        builder.append("         .fGlsy                    = ")
                .append(isFGlsy()).append('\n');
        builder.append("         .fComplex                 = ")
                .append(isFComplex()).append('\n');
        builder.append("         .fHasPic                  = ")
                .append(isFHasPic()).append('\n');
        builder.append("         .cQuickSaves              = ")
                .append(getCQuickSaves()).append('\n');
        builder.append("         .fEncrypted               = ")
                .append(isFEncrypted()).append('\n');
        builder.append("         .fWhichTblStm             = ")
                .append(isFWhichTblStm()).append('\n');
        builder.append("         .fReadOnlyRecommended     = ")
                .append(isFReadOnlyRecommended()).append('\n');
        builder.append("         .fWriteReservation        = ")
                .append(isFWriteReservation()).append('\n');
        builder.append("         .fExtChar                 = ")
                .append(isFExtChar()).append('\n');
        builder.append("         .fLoadOverride            = ")
                .append(isFLoadOverride()).append('\n');
        builder.append("         .fFarEast                 = ")
                .append(isFFarEast()).append('\n');
        builder.append("         .fObfuscated              = ")
                .append(isFObfuscated()).append('\n');
        ...
        builder.append("         .fMac                     = ")
                .append(isFMac()).append('\n');
        builder.append("         .fEmptySpecial            = ")
                .append(isFEmptySpecial()).append('\n');
        builder.append("         .fLoadOverridePage        = ")
                .append(isFLoadOverridePage()).append('\n');
        builder.append("         .reserved1                = ")
                .append(isReserved1()).append('\n');
        builder.append("         .reserved2                = ")
                .append(isReserved2()).append('\n');
        builder.append("         .fSpare0                  = ")
                .append(getFSpare0()).append('\n');
        builder.append("    .Chs                  = ");
    ...
    /**
     * An unsigned integer that specifies that this is a Word Binary File. This
     * value MUST be 0xA5EC.
     */
    @Internal
     ...
     * used. Superseded by FibRgCswNew.nFibNew if it is present. This value
     * SHOULD be 0x00C1.
     */
    @Internal
    public int getNFib() {
     ...
     * then any install lid with a base language of Vietnamese, Thai, or Hindi
     ...
     * of the FIB for the document which contains all the AutoText items.
     */
    @Internal
     ...
     * obfuscation password verifier. If fEncryption is 1 and fObfuscation is 0,
     * this value specifies the size of the EncryptionHeader that is stored at
     * the beginning of the Table stream as described in Encryption and
    ...
    /**
     * Sets the fGlsy field value. Specifies whether this is a document that
     * contains only AutoText items
     */
    @Internal
    ...
    /**
     * Sets the fComplex field value. Specifies that the last save operation
     * that was performed on this document was an incremental save operation
     */
    @Internal
    ...
    /**
     * Sets the fHasPic field value. When set to 0, there SHOULD be no pictures
     * in the document
     */
    @Internal
     ...
     * specifies the number of consecutive times this document was incrementally
     * saved. If nFib is 0x00D9 or greater, then cQuickSaves MUST be 0xF
     *
    ...
    /**
     * Sets the cQuickSaves field value. An unsigned integer. If nFib is less
     * than 0x00D9, then cQuickSaves specifies the number of consecutive times
     * this document was incrementally saved. If nFib is 0x00D9 or greater, then
     * cQuickSaves MUST be 0xF
     */
    @Internal
    ...
    /**
     * Specifies whether the document is encrypted or obfuscated as specified in
    ...
    /**
     * Sets the fEncrypted field value. Specifies whether the document is
     * encrypted or obfuscated as specified in Encryption and Obfuscation
     */
    @Internal
    ...
    /**
     * Sets the fWhichTblStm field value. Specifies the Table stream to which
     * the FIB refers. When this value is set to 1, use 1Table; when this value
    ...
    /**
     * Sets the fReadOnlyRecommended field value. Specifies whether the document
     * author recommended that the document be opened in read-only mode
     */
    @Internal
    public void setFReadOnlyRecommended(boolean value) {
        field_6_flags1 = (short) fReadOnlyRecommended.setBoolean(
                field_6_flags1, value);
    }
    ...
    /**
     * Sets the fWriteReservation field value. Specifies whether the document
     * has a write-reservation password
     */
    @Internal
    public void setFWriteReservation(boolean value) {
        field_6_flags1 = (short) fWriteReservation.setBoolean(field_6_flags1,
                value);
    }
    ...
    /**
     * Sets the fLoadOverride field value. Specifies whether to override the
     * language information and font that are specified in the paragraph style
     * at istd 0 (the normal style) with the defaults that are appropriate for
     * the installation language of the application
     */
    @Internal
    public void setFLoadOverride(boolean value) {
        field_6_flags1 = (short) fLoadOverride
                .setBoolean(field_6_flags1, value);
    }
    ...
    /**
     * Sets the fFarEast field value. Specifies whether the installation
     * language of the application that created the document was an East Asian
     * language
     */
    @Internal
    ...
    /**
     * If fEncrypted is 1, this bit specifies whether the document is obfuscated
     * by using XOR obfuscation; otherwise, this bit MUST be ignored
     *
    ...
    /**
     * Sets the fObfuscated field value. If fEncrypted is 1, this bit specifies
     * whether the document is obfuscated by using XOR obfuscation; otherwise,
    ...
    /**
     * Sets the fEmptySpecial field value. This value SHOULD be 0 and SHOULD be
     * ignored
     */
    @Internal
    public void setFEmptySpecial(boolean value) {
        field_10_flags2 = (byte) fEmptySpecial.setBoolean(field_10_flags2,
                value);
    }
    ...
    /**
     * Sets the fLoadOverridePage field value. Specifies whether to override the
    ...
    public void setFLoadOverridePage(boolean value) {
        field_10_flags2 = (byte) fLoadOverridePage.setBoolean(field_10_flags2,
                value);
    }
    ...
    /**
     * Sets the reserved1 field value. This value is undefined and MUST be
     * ignored
     */
    @Internal
    ...
    /**
     * Sets the reserved2 field value. This value is undefined and MUST be
     * ignored
     */
    @Internal
