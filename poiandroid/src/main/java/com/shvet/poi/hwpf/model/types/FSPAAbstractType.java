...
public abstract class FSPAAbstractType {
    ...
    public String toString() {
        ...
        builder.append("         .fHdr                     = ")
                .append(isFHdr()).append('\n');
        builder.append("         .bx                       = ").append(getBx())
                .append('\n');
        builder.append("         .by                       = ").append(getBy())
                .append('\n');
        builder.append("         .wr                       = ").append(getWr())
                .append('\n');
        builder.append("         .wrk                      = ")
                .append(getWrk()).append('\n');
        builder.append("         .fRcaSimple               = ")
                .append(isFRcaSimple()).append('\n');
        builder.append("         .fBelowText               = ")
                .append(isFBelowText()).append('\n');
        builder.append("         .fAnchorLock              = ")
                .append(isFAnchorLock()).append('\n');
    ...
    /**
     * Shape Identifier. Used in conjunction with the office art data (found via
     * fcDggInfo in the FIB) to find the actual data for this shape.
     */
    @Internal
    public int getSpid() {
        return field_1_spid;
    ...
    /**
     * Sets the fHdr field value. 1 in the undo doc when shape is from the
     * header doc, 0 otherwise (undefined when not in the undo doc)
     */
    @Internal
    ...
    /**
     * Sets the wrk field value. Text wrapping mode type (valid only for
     * wrapping modes 2 and 4
     */
    @Internal
    ...
    /**
     * Sets the fRcaSimple field value. When set, temporarily overrides bx, by,
     * forcing the xaLeft, xaRight, yaTop, and yaBottom fields to all be page
     * relative.
     */
    @Internal
