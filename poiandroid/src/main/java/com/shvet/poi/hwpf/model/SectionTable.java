...
public class SectionTable {
    ...
    public SectionTable(byte[] documentStream, byte[] tableStream, int offset,
                        int size, int fcMin, TextPieceTable tpt, int mainLength) {
    ...
    // goss version of CPtoFC - this takes into account non-contiguous
    // textpieces
    // that we have come across in real world documents. Tests against the
    // example
