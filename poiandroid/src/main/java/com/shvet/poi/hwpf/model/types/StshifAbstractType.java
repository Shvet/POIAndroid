...
public abstract class StshifAbstractType {
    ...
    protected void fillFields(byte[] data, int offset) {
        ...
        field_5_istdMaxFixedWhenSaved = LittleEndian.getShort(data,
                0x8 + offset);
        field_6_nVerBuiltInNamesWhenSaved = LittleEndian.getShort(data,
                0xa + offset);
    ...
    public void serialize(byte[] data, int offset) {
        ...
        LittleEndian.putUShort(data, 0x8 + offset,
                field_5_istdMaxFixedWhenSaved);
        LittleEndian.putUShort(data, 0xa + offset,
    ...
    public String toString() {
        ...
        builder.append(" (").append(getNVerBuiltInNamesWhenSaved())
                .append(" )\n");
     ...
     * This value MUST be equal to or greater than 0x000F, and MUST be less than
     * 0x0FFE.
     */
    @Internal
    public int getCstd() {
    ...
    /**
     * An unsigned integer that specifies the size, in bytes, of the Stdf
     * structure. The Stdf structure contains an StdfBase structure that is
     * followed by a StdfPost2000OrNone structure which contains an optional
     * StdfPost2000 structure. This value MUST be 0x000A when the Stdf structure
     * does not contain an StdfPost2000 structure and MUST be 0x0012 when the
    ...
    /**
     * An unsigned integer that specifies a value that is 1 larger than the
     * largest StdfBase.sti index of any application-defined style. This SHOULD
     * be equal to the largest sti index that is defined in the application,
     * incremented by 1.
     */
    @Internal
     ...
     * STSH.rglpstd that are reserved for fixed-index application-defined
     * styles. This value MUST be 0x000F.
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the version number of the style names
     * as defined by the application that writes the file.
     */
    @Internal
     ...
     */
    @Internal
    public void setNVerBuiltInNamesWhenSaved(
            int field_6_nVerBuiltInNamesWhenSaved) {
        this.field_6_nVerBuiltInNamesWhenSaved = field_6_nVerBuiltInNamesWhenSaved;
    }

    /**
     * A signed integer that specifies an operand value for the sprmCRgFtc0 for
    ...
    /**
     * A signed integer that specifies an operand value for the sprmCRgFtc1 for
     * default document formatting, as defined in the section Determining
    ...
    /**
     * A signed integer that specifies an operand value for the sprmCRgFtc2 for
     * default document formatting, as defined in the section Determining
     * Formatting Properties.
     */
    @Internal
    ...
    /**
     * Sets the fHasOriginalStyle field value. This value MUST be 1 and MUST be
     * ignored
     */
    @Internal
    ...
    /**
     * Sets the fReserved field value. This value MUST be zero and MUST be
     * ignored
     */
    @Internal
