...
public final class BorderCode implements Cloneable {
    ...
    private static final BitField _dptLineWidth = BitFieldFactory
            .getInstance(0x00ff);
    private static final BitField _brcType = BitFieldFactory
            .getInstance(0xff00);
    private static final BitField _ico = BitFieldFactory.getInstance(0x00ff);
    private static final BitField _dptSpace = BitFieldFactory
            .getInstance(0x1f00);
    private static final BitField _fShadow = BitFieldFactory
            .getInstance(0x2000);
    ...
    /**
     * Border type code: <li>0 none <li>1 single <li>2 thick <li>3 double <li>5
     * hairline <li>6 dot <li>7 dash large gap <li>8 dot dash <li>9 dot dot dash
     * <li>10 triple <li>11 thin-thick small gap <li>12 thick-thin small gap <li>
     * 13 thin-thick-thin small gap <li>14 thin-thick medium gap <li>15
     * thick-thin medium gap <li>16 thin-thick-thin medium gap <li>17 thin-thick
     * large gap <li>18 thick-thin large gap <li>19 thin-thick-thin large gap
     * <li>20 wave <li>21 double wave <li>22 dash small gap <li>23 dash dot
     * stroked <li>24 emboss 3D <li>25 engrave 3D <li>codes 64 - 230 represent
     * border art types and are used only for page borders
     */
    ...
    /**
     * Color: <li>0 Auto <li>1 Black <li>2 Blue <li>3 Cyan <li>4 Green <li>5
     * Magenta <li>6 Red <li>7 Yellow <li>8 White <li>9 DkBlue <li>10 DkCyan <li>
     * 11 DkGreen <li>12 DkMagenta <li>13 DkRed <li>14 DkYellow <li>15 DkGray
     * <li>16 LtGray
     */
    ...
    /**
     * When true, border is drawn with shadow Must be false when BRC is a
