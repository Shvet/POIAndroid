...
public abstract class BKFAbstractType {
    ...
    public String toString() {
        ...
        builder.append("         .itcFirst                 = ")
                .append(getItcFirst()).append('\n');
        builder.append("         .fPub                     = ")
                .append(isFPub()).append('\n');
        builder.append("         .itcLim                   = ")
                .append(getItcLim()).append('\n');
        builder.append("         .fCol                     = ")
                .append(isFCol()).append('\n');
    ...
    /**
     * Index to BKL entry in plcfbkl that describes the ending position of this
    ...
    /**
     * When bkf.fCol==1, this is the index to the first column of a table column
     * bookmark
     *
    ...
    /**
     * Sets the itcFirst field value. When bkf.fCol==1, this is the index to the
     * first column of a table column bookmark
     */
    ...
    /**
     * Sets the fPub field value. When 1, this indicates that this bookmark is
     * marking the range of a Macintosh Publisher section
     */
    ...
    /**
     * When bkf.fCol==1, this is the index to limit column of a table column
     * bookmark
     *
    ...
    /**
     * Sets the itcLim field value. When bkf.fCol==1, this is the index to limit
     * column of a table column bookmark
     */
    ...
    /**
     * When 1, this bookmark marks a range of columns in a table specified by
     * (bkf.itcFirst, bkf.itcLim)
     *
    ...
    /**
     * Sets the fCol field value. When 1, this bookmark marks a range of columns
     * in a table specified by (bkf.itcFirst, bkf.itcLim)
     */
