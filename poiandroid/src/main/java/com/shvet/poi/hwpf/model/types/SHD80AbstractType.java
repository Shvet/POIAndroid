 ...
 * background shading. As an exception to the constraints that are specified by
 * Ico and Ipat, a Shd80 can be set to Shd80Nil and specifies that no shading is
 * applied.
 * <p/>
 * Class and fields descriptions are quoted from Word (.doc) Binary File Format
 ...
 *
 * @author Sergey Vladimirov; according to Word (.doc) Binary File Format by
...
public abstract class SHD80AbstractType {
    ...
    public boolean equals(Object obj) {
        ...
        return field_1_value == other.field_1_value;
    }
    ...
    public String toString() {
        ...
        builder.append("         .icoFore                  = ")
                .append(getIcoFore()).append('\n');
        builder.append("         .icoBack                  = ")
                .append(getIcoBack()).append('\n');
        builder.append("         .ipat                     = ")
                .append(getIpat()).append('\n');
