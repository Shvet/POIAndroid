...
public abstract class HRESIAbstractType {
     ...
     * Hyphenation rule.
     *
     * @return One of <li>{@link #HRES_NO} <li>{@link #HRES_NORMAL} <li>
     * {@link #HRES_ADD_LETTER_BEFORE} <li>
     * {@link #HRES_CHANGE_LETTER_BEFORE} <li>
     * {@link #HRES_DELETE_LETTER_BEFORE} <li>
     * {@link #HRES_CHANGE_LETTER_AFTER} <li>
     ...
     * Hyphenation rule.
     *
     * @param field_1_hres One of <li>{@link #HRES_NO} <li>{@link #HRES_NORMAL} <li>
     *                     {@link #HRES_ADD_LETTER_BEFORE} <li>
     *                     {@link #HRES_CHANGE_LETTER_BEFORE} <li>
     *                     {@link #HRES_DELETE_LETTER_BEFORE} <li>
     *                     {@link #HRES_CHANGE_LETTER_AFTER} <li>
    ...
    /**
     * The character that will be used to add or change a letter when hres is 2,
     * 3, 5 or 6.
     */
