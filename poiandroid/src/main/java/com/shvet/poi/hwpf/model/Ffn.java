...
/**
 * FFN - Font Family Name. FFN is a data structure that stores the names of the
 * Main Font and that of Alternate font as an array of characters. It has also a
 * header that stores info about the whole structure and the fonts
 *
 * @author Praveen Mathew
 */
@Internal
public final class Ffn {
    private static BitField _prq = BitFieldFactory.getInstance(0x0003);// pitch
    // request
    private static BitField _fTrueType = BitFieldFactory.getInstance(0x0004);// when
    // 1,
    // font
    // is
    // a
    ...
    public boolean equals(Object other) {
        ...
        return (o._cbFfnM1 == this._cbFfnM1 && o._info == this._info
                && o._wWeight == _wWeight && o._chs == _chs
                && o._ixchSzAlt == _ixchSzAlt
                && Arrays.equals(o._panose, _panose)
                && Arrays.equals(o._fontSig, _fontSig) && Arrays.equals(
                o._xszFfn, _xszFfn));
    }
