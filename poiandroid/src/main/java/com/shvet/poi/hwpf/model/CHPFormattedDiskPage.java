 ...
 * fkps consists of an array of 4 byte int offsets that represent a Paragraph's
 * or Character run's text offset in the main stream. The ending offset is the
 * next value in the array. For example, if an fkp has X number of Paragraph's
