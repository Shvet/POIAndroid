...
public abstract class StdfBaseAbstractType {
    ...
    public String toString() {
        ...
        builder.append("         .sti                      = ")
                .append(getSti()).append('\n');
        builder.append("         .fScratch                 = ")
                .append(isFScratch()).append('\n');
        builder.append("         .fInvalHeight             = ")
                .append(isFInvalHeight()).append('\n');
        builder.append("         .fHasUpe                  = ")
                .append(isFHasUpe()).append('\n');
        builder.append("         .fMassCopy                = ")
                .append(isFMassCopy()).append('\n');
        builder.append("    .info2                = ");
        builder.append(" (").append(getInfo2()).append(" )\n");
        builder.append("         .stk                      = ")
                .append(getStk()).append('\n');
        builder.append("         .istdBase                 = ")
                .append(getIstdBase()).append('\n');
        builder.append("    .info3                = ");
        builder.append(" (").append(getInfo3()).append(" )\n");
        builder.append("         .cupx                     = ")
                .append(getCupx()).append('\n');
        builder.append("         .istdNext                 = ")
                .append(getIstdNext()).append('\n');
        builder.append("    .bchUpe               = ");
        builder.append(" (").append(getBchUpe()).append(" )\n");
        builder.append("    .grfstd               = ");
        builder.append(" (").append(getGrfstd()).append(" )\n");
        builder.append("         .fAutoRedef               = ")
                .append(isFAutoRedef()).append('\n');
        builder.append("         .fHidden                  = ")
                .append(isFHidden()).append('\n');
        builder.append("         .f97LidsSet               = ")
                .append(isF97LidsSet()).append('\n');
        builder.append("         .fCopyLang                = ")
                .append(isFCopyLang()).append('\n');
        builder.append("         .fPersonalCompose         = ")
                .append(isFPersonalCompose()).append('\n');
        builder.append("         .fPersonalReply           = ")
                .append(isFPersonalReply()).append('\n');
        builder.append("         .fPersonal                = ")
                .append(isFPersonal()).append('\n');
        builder.append("         .fNoHtmlExport            = ")
                .append(isFNoHtmlExport()).append('\n');
        builder.append("         .fSemiHidden              = ")
                .append(isFSemiHidden()).append('\n');
        builder.append("         .fLocked                  = ")
                .append(isFLocked()).append('\n');
        builder.append("         .fInternalUse             = ")
                .append(isFInternalUse()).append('\n');
        builder.append("         .fUnhideWhenUsed          = ")
                .append(isFUnhideWhenUsed()).append('\n');
        builder.append("         .fQFormat                 = ")
                .append(isFQFormat()).append('\n');
        builder.append("         .fReserved                = ")
                .append(getFReserved()).append('\n');
     ...
     * This value MUST be equal to cbStd in LPStd.
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the invariant style identifier for
     * application-defined styles, or 0x0FFE for user-defined styles
     *
    ...
    /**
     * Sets the sti field value. An unsigned integer that specifies the
     * invariant style identifier for application-defined styles, or 0x0FFE for
     * user-defined styles
     */
    @Internal
    ...
    /**
     * Sets the fScratch field value. spare field for any temporary use, always
     * reset back to zero!
     */
    @Internal
    ...
    /**
     * Specifies whether the paragraph height information in the fcPlcfPhe field
     * of FibRgFcLcb97, for any paragraphs having this paragraph style, MUST be
     * ignored. SHOULD be 0
     *
    ...
    /**
     * Sets the fInvalHeight field value. Specifies whether the paragraph height
     * information in the fcPlcfPhe field of FibRgFcLcb97, for any paragraphs
     * having this paragraph style, MUST be ignored. SHOULD be 0
     */
    @Internal
    ...
    /**
     * Sets the fHidden field value. Specifies whether this style is not shown
    ...
    /**
     * Specifies whether sprmCRgLid0_80 and sprmCRgLid1_80 were applied, as
     * appropriate, to this paragraph or character style for compatibility with
     * applications that do not support sprmCRgLid0, sprmCRgLid1, and
     * sprmCFNoProof
     *
    ...
    /**
     * Sets the f97LidsSet field value. Specifies whether sprmCRgLid0_80 and
     * sprmCRgLid1_80 were applied, as appropriate, to this paragraph or
     * character style for compatibility with applications that do not support
     * sprmCRgLid0, sprmCRgLid1, and sprmCFNoProof
     */
    @Internal
    ...
    /**
     * If f97LidsSet is 1, this value specifies whether the applied
     * compatibility sprmCRgLid0_80 or sprmCRgLid1_80 specified an actual
     * language or a special LID value (0x0400) signifying that no proofing is
     * needed for the text. This MUST be ignored if f97LidsSet is 0
     *
    ...
    /**
     * Sets the fCopyLang field value. If f97LidsSet is 1, this value specifies
     * whether the applied compatibility sprmCRgLid0_80 or sprmCRgLid1_80
     * specified an actual language or a special LID value (0x0400) signifying
     * that no proofing is needed for the text. This MUST be ignored if
     * f97LidsSet is 0
     */
    @Internal
    ...
    /**
     * Specifies whether this character style can be used to automatically
     * format the new message text in a new e-mail
     *
    ...
    /**
     * Sets the fPersonalCompose field value. Specifies whether this character
     * style can be used to automatically format the new message text in a new
     * e-mail
     */
    @Internal
    public void setFPersonalCompose(boolean value) {
        field_5_grfstd = (short) fPersonalCompose.setBoolean(field_5_grfstd,
                value);
    }

    /**
     * Specifies whether this character style can be used to automatically
     * format the new message text when replying to an e-mail
     *
    ...
    /**
     * Sets the fPersonalReply field value. Specifies whether this character
     * style can be used to automatically format the new message text when
     * replying to an e-mail
     */
    @Internal
    public void setFPersonalReply(boolean value) {
        field_5_grfstd = (short) fPersonalReply.setBoolean(field_5_grfstd,
                value);
    }

    /**
     * Specifies whether this character style was applied to format all message
     * text from one or more users in an e-mail
     *
    ...
    /**
     * Sets the fPersonal field value. Specifies whether this character style
     * was applied to format all message text from one or more users in an
     * e-mail
     */
    @Internal
    ...
    /**
     * Sets the fNoHtmlExport field value. This value MUST be 0 and MUST be
     * ignored
     */
    @Internal
    public void setFNoHtmlExport(boolean value) {
        field_5_grfstd = (short) fNoHtmlExport
                .setBoolean(field_5_grfstd, value);
    }

    /**
     * Specifies whether this style is not shown in the simplified main styles
    ...
    /**
     * Sets the fSemiHidden field value. Specifies whether this style is not
     * shown in the simplified main styles UI of the application
     */
    @Internal
    ...
    /**
     * Specifies whether this style is prevented from being applied by using the
     * application UI
     *
    ...
    /**
     * Sets the fLocked field value. Specifies whether this style is prevented
     * from being applied by using the application UI
     */
    @Internal
    ...
    /**
     * Sets the fInternalUse field value. This bit is undefined and MUST be
     * ignored
     */
    @Internal
    ...
    /**
     * Specifies whether the fSemiHidden property is to be set to 0 when this
     * style is used
     *
    ...
    /**
     * Sets the fUnhideWhenUsed field value. Specifies whether the fSemiHidden
     * property is to be set to 0 when this style is used
     */
    @Internal
    public void setFUnhideWhenUsed(boolean value) {
        field_5_grfstd = (short) fUnhideWhenUsed.setBoolean(field_5_grfstd,
                value);
    }
    ...
    /**
     * Sets the fQFormat field value. Specifies whether this style is shown in
