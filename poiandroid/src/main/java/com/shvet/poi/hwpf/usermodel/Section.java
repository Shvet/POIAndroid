...
import com.shvet.poi.hwpf.HWPFOldDocument;
...
public final class Section extends Range {
    ...
    public Section(SEPX sepx, Range parent) {
        super(Math.max(parent._start, sepx.getStart()), Math.min(parent._end,
                sepx.getEnd()), parent);
    ...
    /**
     * Set the height of the bottom margin in twips. In the AbstractWordUtils
     * class, a constant is defined that indicates how many twips there are per
     * inch and it can be used in setting the margins width a little like this;
     * <p/>
     * section.setMarginBottom( (int) 1.5 * AbstractWordUtils.TWIPS_PER_INCH );
     *
     * @param marginWidth A primitive int whose value will indciate how high the margin
     *                    should be - in twips.
     */
    ...
    /**
     * Set the width of the left hand margin in twips. In the AbstractWordUtils
     * class, a constant is defined that indicates how many twips there are per
     * inch and it can be used in setting the margins width a little like this;
     * <p/>
    ...
    /**
     * Set the width of the right hand margin in twips. In the AbstractWordUtils
     * class, a constant is defined that indicates how many twips there are per
     * inch and it can be used in setting the margins width a little like this;
     * <p/>
    ...
    /**
     * Set the height of the top margin in twips. In the AbstractWordUtils
     * class, a constant is defined that indicates how many twips there are per
     * inch and it can be used in setting the margins width a little like this;
     * <p/>
