...
import com.shvet.poi.hwpf.model.Grfhic;
...
public abstract class LVLFAbstractType {
    ...
    public void serialize(byte[] data, int offset) {
        ...
        System.arraycopy(field_4_rgbxchNums, 0, data, 0x6 + offset,
                field_4_rgbxchNums.length);
    ...
    public String toString() {
        ...
        builder.append("         .jc                       = ").append(getJc())
                .append('\n');
        builder.append("         .fLegal                   = ")
                .append(isFLegal()).append('\n');
        builder.append("         .fNoRestart               = ")
                .append(isFNoRestart()).append('\n');
        builder.append("         .fIndentSav               = ")
                .append(isFIndentSav()).append('\n');
        builder.append("         .fConverted               = ")
                .append(isFConverted()).append('\n');
        builder.append("         .unused1                  = ")
                .append(isUnused1()).append('\n');
        builder.append("         .fTentative               = ")
                .append(isFTentative()).append('\n');
        builder.append("    .rgbxchNums           = ");
        builder.append(" (").append(Arrays.toString(getRgbxchNums()))
                .append(" )\n");
    ...
    /**
     * A signed integer that specifies the beginning number for the number
     * sequence belonging to this level. This value MUST be less than or equal
     * to 0x7FFF and MUST be greater than or equal to zero. If this level does
     * not have a number sequence (see nfc), this MUST be ignored.
     */
    @Internal
    ...
    /**
     * An array of 8-bit integers. Each integer specifies a one-based character
     * offset to a level placeholder in the xst.rgtchar of the LVL that contains
     * this LVLF. This array is zero-terminated, unless it is full. The count of
     * elements in this array, before to the first terminating zero, MUST be
     * less than or equal to the one-based level of the list to which this LVL
     * corresponds. The integers in this array, before the first terminating
     * zero, MUST be in ascending order, and MUST be unique.
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the character that follows the number
     * text.
     */
    @Internal
    ...
    /**
     * If fIndentSav is nonzero, this is a signed integer that specifies the
     * size, in twips, of the indent that needs to be removed when the numbering
     * is removed. This MUST be less than or equal to 0x00007BC0 or greater than
     * or equal to 0xFFFF8440. If fIndentSav is zero, this MUST be ignored.
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the size, in bytes, of the grpprlChpx
     * in the LVL that contains this LVLF.
     */
    @Internal
    ...
    /**
     * An unsigned integer that specifies the size, in bytes, of the grpprlPapx
     * in the LVL that contains this LVLF.
     */
    @Internal
     ...
     * restart. The number sequence of this level does restart after any level
     * that is more significant than the specified level. This MUST be less than
     * or equal to the zero-based level of the list to which this LVLF
     * corresponds. If fNoRestart is zero, this MUST be ignored. If this level
    ...
    /**
     * Sets the jc field value. An unsigned integer that specifies the
     * justification of this level
     */
    @Internal
    ...
    /**
     * A bit that specifies whether this level overrides the nfc of all
     * inherited level numbers. If the original nfc of a level number is
     * msonfcArabicLZ, it is preserved. Otherwise, the nfc of the level number
     * is overridden by msonfcArabic.
     *
    ...
    /**
     * Sets the fLegal field value. A bit that specifies whether this level
     * overrides the nfc of all inherited level numbers. If the original nfc of
     * a level number is msonfcArabicLZ, it is preserved. Otherwise, the nfc of
    ...
    /**
     * A bit that specifies whether the number sequence of the level does not
     * restart after a level is encountered that is more significant than the
     * level to which this LVLF corresponds
     *
    ...
    /**
     * Sets the fNoRestart field value. A bit that specifies whether the number
     * sequence of the level does not restart after a level is encountered that
     * is more significant than the level to which this LVLF corresponds
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the level indented the text it was applied
     * to and that the indent needs to be removed when numbering is removed. The
     * indent to be removed is stored in dxaIndentSav
     *
    ...
    /**
     * Sets the fIndentSav field value. A bit that specifies whether the level
     * indented the text it was applied to and that the indent needs to be
     * removed when numbering is removed. The indent to be removed is stored in
     * dxaIndentSav
     */
    @Internal
    ...
    /**
     * A bit that specifies whether the nfc of this LVLF structure was
     * previously a temporary value used for bidirectional compatibility that
     * was converted into a standard MSONFC
     *
    ...
    /**
     * Sets the fConverted field value. A bit that specifies whether the nfc of
     * this LVLF structure was previously a temporary value used for
     * bidirectional compatibility that was converted into a standard MSONFC
     */
    @Internal
    ...
    /**
     * Sets the fTentative field value. A bit that specifies whether the format
     * of the level is tentative
     */
    @Internal
