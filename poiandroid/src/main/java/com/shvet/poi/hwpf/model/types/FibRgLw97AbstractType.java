...
public abstract class FibRgLw97AbstractType {
    ...
    public static int getSize() {
        return 0 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4
                + 4 + 4 + 4 + 4 + 4 + 4 + 4;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (field_21_reserved13 != other.field_21_reserved13)
            return false;
        return field_22_reserved14 == other.field_22_reserved14;
    }
    ...
    /**
     * Specifies the count of bytes of those written to the WordDocument stream
     * of the file that have any meaning. All bytes in the WordDocument stream
     * at offset cbMac and greater MUST be ignored..
     */
    @Internal
    public int getCbMac() {
    ...
    /**
     * A signed integer that specifies the count of CPs in the footnote
    ...
    /**
     * A signed integer that specifies the count of CPs in the header
     * subdocument. This value MUST be zero, 1, or greater.
     */
    @Internal
    ...
    /**
     * A signed integer that specifies the count of CPs in the comment
     * subdocument. This value MUST be zero, 1, or greater.
     */
    @Internal
    ...
    /**
     * A signed integer that specifies the count of CPs in the endnote
     * subdocument. This value MUST be zero, 1, or greater.
     */
    @Internal
    ...
    /**
     * A signed integer that specifies the count of CPs in the textbox
    ...
    /**
     * This value MUST be equal or less than the number of data elements in
    ...
    /**
     * This value MUST be less than or equal to the number of data elements in
