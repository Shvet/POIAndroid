...
public final class DateAndTime implements Cloneable {
    ...
    // BitFieldFactory.getInstance(0xe000);
    ...
    public Calendar getDate() {
        ...
        Calendar cal = LocaleUtil.getLocaleCalendar(
                _years.getValue(_info2) + 1900, _months.getValue(_info2) - 1,
                _dom.getValue(_info), _hours.getValue(_info),
                _minutes.getValue(_info), 0);
        return cal;
    }
