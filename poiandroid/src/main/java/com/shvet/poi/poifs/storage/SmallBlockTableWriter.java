...
import com.shvet.poi.poifs.filesystem.OPOIFSDocument;
...
/**
 * This class implements storage for writing the small blocks used by small
 * documents.
 *
...
public class SmallBlockTableWriter implements BlockWritable, BATManaged {
    ...
    public SmallBlockTableWriter(final POIFSBigBlockSize bigBlockSize,
                                 final List<OPOIFSDocument> documents, final RootProperty root) {
