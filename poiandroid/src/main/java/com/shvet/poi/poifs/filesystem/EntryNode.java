...
public abstract class EntryNode implements Entry {
    ...
    /**
     * create a DocumentNode. This method is not public by design; it is
     * intended strictly for the internal use of extending classes
     *
    ...
    /**
     * get this Entry's parent (the DocumentEntry that owns this Entry). All
     * Entry objects, except the root Entry, has a parent.
     *
    ...
    /**
     * Delete this Entry. This operation should succeed, but there are special
     * circumstances when it will not:
     * <p/>
     * If this Entry is the root of the Entry tree, it cannot be deleted, as
     * there is no way to create another one.
     * <p/>
     * If this Entry is a directory, it cannot be deleted unless it is empty.
     *
     ...
     * <p/>
     * There is a sibling Entry (i.e., an Entry whose parent is the same as this
     * Entry's parent) with the same name.
     * <p/>
     * This Entry is the root of the Entry tree. Its name is dictated by the
     * Filesystem and many not be changed.
     *
