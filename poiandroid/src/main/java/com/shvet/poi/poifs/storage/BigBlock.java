...
abstract class BigBlock implements BlockWritable {
    /**
     * Either 512 bytes ({@link POIFSConstants#SMALLER_BIG_BLOCK_SIZE}) or 4096
     * bytes ({@link POIFSConstants#LARGER_BIG_BLOCK_SIZE})
     */
    ...
    /**
     * Default implementation of write for extending classes that contain their
     * data in a simple array of bytes.
     *
    ...
    abstract void writeData(final OutputStream stream) throws IOException;
