 ...
 */
public class StandardEncryptionVerifier extends EncryptionVerifier implements
        EncryptionRecord {
    ...
    public void write(LittleEndianByteArrayOutputStream bos) {
        ...
        // EncryptedVerifierHash: An array of bytes that contains the encrypted
        // form of the hash of
        // the randomly generated Verifier value. The length of the array MUST
        // be the size of the
        // encryption block size multiplied by the number of blocks needed to
        // encrypt the hash of the
        // Verifier. If the encryption algorithm is RC4, the length MUST be 20
        // bytes. If the encryption
        // algorithm is AES, the length MUST be 32 bytes. After decrypting the
