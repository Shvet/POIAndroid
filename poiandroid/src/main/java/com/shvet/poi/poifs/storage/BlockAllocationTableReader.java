...
public final class BlockAllocationTableReader {
     ...
     * @throws IOException if, in trying to create the table, we
     ...
     * @throws IOException if there is a problem acquiring the blocks
     */
     ...
     * (duh))
     * @throws IOException if the current block is unused
     */
