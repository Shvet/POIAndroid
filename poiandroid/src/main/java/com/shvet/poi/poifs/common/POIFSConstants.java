...
package com.shvet.poi.poifs.common;
...
public interface POIFSConstants {
    ...
    POIFSBigBlockSize SMALLER_BIG_BLOCK_SIZE_DETAILS = new POIFSBigBlockSize(
            SMALLER_BIG_BLOCK_SIZE, (short) 9);
    /**
     * Some use 4096 bytes
     */
    int LARGER_BIG_BLOCK_SIZE = 0x1000;
    POIFSBigBlockSize LARGER_BIG_BLOCK_SIZE_DETAILS = new POIFSBigBlockSize(
            LARGER_BIG_BLOCK_SIZE, (short) 12);
    ...
    /**
     * The minimum size of a document before it's stored using Big Blocks
     * (normal streams). Smaller documents go in the Mini Stream (SBAT / Small
     * Blocks)
     */
     ...
     */
    byte[] OOXML_FILE_HEADER = new byte[]{0x50, 0x4b,
            0x03, 0x04};
