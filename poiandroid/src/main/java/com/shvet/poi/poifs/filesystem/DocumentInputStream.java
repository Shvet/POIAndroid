 ...
 * {@link POIFSFileSystem} or {@link NPOIFSFileSystem} instance. It creates the
 * appropriate one, and delegates, allowing us to work transparently with the
 * two.
 */
public class DocumentInputStream extends InputStream implements
        LittleEndianInput {
    /**
