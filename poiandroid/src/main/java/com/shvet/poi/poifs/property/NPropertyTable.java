...
import com.shvet.poi.poifs.filesystem.NPOIFSStream;
...
/**
 * This class embodies the Property Table for a {@link NPOIFSFileSystem}; this
...
public final class NPropertyTable extends PropertyTableBase {
    private static final POILogger _logger = POILogFactory
            .getLogger(NPropertyTable.class);
    ...
    public NPropertyTable(final HeaderBlock headerBlock,
                          final NPOIFSFileSystem filesystem) throws IOException {
        super(headerBlock, buildProperties((new NPOIFSStream(filesystem,
                        headerBlock.getPropertyStart())).iterator(),
    ...
    private static List<Property> buildProperties(
            final Iterator<ByteBuffer> dataSource,
        ...
        while (dataSource.hasNext()) {
            ...
            if (bb.hasArray() && bb.arrayOffset() == 0
                ...
                if (bb.remaining() < bigBlockSize.getBigBlockSize()) {
                    ...
                    _logger.log(POILogger.WARN, "Short Property Block, ",
                            bb.remaining(), " bytes instead of the expected "
