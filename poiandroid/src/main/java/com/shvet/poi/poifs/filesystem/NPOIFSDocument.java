...
/**
 * This class manages a document in the NIO POIFS filesystem. This is the
 * {@link NPOIFSFileSystem} version.
 */
public final class NPOIFSDocument implements POIFSViewable {
     ...
     */
    public NPOIFSDocument(String name, NPOIFSFileSystem filesystem,
    ...
    public NPOIFSDocument(String name, int size, NPOIFSFileSystem filesystem,
