...
public abstract class ChunkedCipherOutputStream extends FilterOutputStream {
    ...
    protected abstract Cipher initCipherForBlock(Cipher existing, int block,
                                                 boolean lastChunk) throws GeneralSecurityException;
    ...
    protected abstract void createEncryptionInfoEntry(DirectoryNode dir,
                                                      File tmpFile) throws IOException, GeneralSecurityException;
    ...
    public void close() throws IOException {
        try {
            ...
            dir.createDocument(Decryptor.DEFAULT_POIFS_ENTRY, oleStreamSize,
                    new EncryptedPackageWriter());
