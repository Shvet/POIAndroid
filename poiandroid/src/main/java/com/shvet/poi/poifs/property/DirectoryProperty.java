...
public class DirectoryProperty extends Property implements Parent,
        Iterable<Property> { // TODO - fix instantiable superclass
     ...
     * @throws IOException if we already have a child with the same name
     */
            ...
            if (result == 0) {
                ...
                if (name1.compareTo(VBA_PROJECT) == 0)
                    ...
                    if (name1.startsWith("__") && name2.startsWith("__")) {
                        ...
                        // If only name1 is __XXX then this will be placed after
                        // name2
                        result = 1;
                    } else if (name2.startsWith("__")) {
                        // If only name2 is __XXX then this will be placed after
                        // name1
                        result = -1;
                    } else
