...
public final class PropertyBlock extends BigBlock {
    ...
    private PropertyBlock(final POIFSBigBlockSize bigBlockSize,
                          final Property[] properties, final int offset) {
        super(bigBlockSize);
    ...
    /**
     * Create an array of PropertyBlocks from an array of Property instances,
     * creating empty Property instances to make up any shortfall
     *
     * @param properties the Property instances to be converted into PropertyBlocks, in
     *                   a java List
    ...
    public static BlockWritable[] createPropertyBlockArray(
        ...
        int block_count = (properties.size() + _properties_per_block - 1)
                / _properties_per_block;
        Property[] to_be_written = new Property[block_count
                * _properties_per_block];

        System.arraycopy(properties.toArray(new Property[0]), 0, to_be_written,
                0, properties.size());
        ...
        for (int j = 0; j < block_count; j++) {
            rvalue[j] = new PropertyBlock(bigBlockSize, to_be_written, j
                    * _properties_per_block);
        }
        return rvalue;
    }
