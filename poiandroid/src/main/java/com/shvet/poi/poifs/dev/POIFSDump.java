...
import com.shvet.poi.poifs.filesystem.DocumentNode;
...
public class POIFSDump {
    ...
    protected static HeaderBlock getHeaderBlock(NPOIFSFileSystem fs)
            throws Exception {
    ...
    protected static NPropertyTable getPropertyTable(NPOIFSFileSystem fs)
            throws Exception {
    ...
    public static void dump(DirectoryEntry root, File parent)
            throws IOException {
        for (Iterator<Entry> it = root.getEntries(); it.hasNext(); ) {
            ...
            if (entry instanceof DocumentNode) {
                ...
                OutputStream out = new FileOutputStream(new File(parent, node
                        .getName().trim()));
                try {
                    out.write(bytes);
                } finally {
                ...
                System.err
                        .println("Skipping unsupported POIFS entry: " + entry);
            }
        }
    }

    public static void dump(NPOIFSFileSystem fs, int startBlock, String name,
