...
public final class ZipHelper {
     ...
     *
     * @throws OpenXML4JException Throws if internal error occurs.
     */
    ...
    public static ZipEntry getContentTypeZipEntry(ZipPackage pkg) {
        Enumeration<? extends ZipEntry> entries = pkg.getZipArchive()
                .getEntries();
     ...
     *
     * @param zipItemName Zip item name to convert.
     ...
     *
     * @param opcItemName The OPC item name to convert.
