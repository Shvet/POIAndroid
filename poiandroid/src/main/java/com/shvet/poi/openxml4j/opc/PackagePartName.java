...
public final class PackagePartName implements Comparable<PackagePartName> {
     ...
     *
     * @param uri              The URI to validate and to transform into ValidPartName.
     * @param checkConformance Flag to specify if the contructor have to validate the OPC
     ...
     * @throws InvalidFormatException Throw if the specified part name is not conform to Open
     ...
     *
     * @param partName         Part name to valid and to create.
     * @param checkConformance Flag to specify if the contructor have to validate the OPC
     *                         conformance. Must be always <code>true</code> except for
     *                         special URI like '/' which is needed for internal use by
     *                         OpenXML4J but is not valid.
     ...
     *
     * @param partUri The part name to check.
     * @throws Exception Throws if the part name is invalid.
     */
     ...
     *
     * @param partURI Part URI to check.
     * @throws InvalidFormatException If the specified URI is empty.
     */
     ...
     *
     * @param partUri The part name to check.
     * @throws InvalidFormatException if the specified URI contain an empty segments or if one the
     ...
     *
     * @param partUri The part name to check.
     * @throws InvalidFormatException If the specified part name doesn't start with a forward slash
     *                                character '/'.
     */
     ...
     *
     * @param partUri The part name to check.
     * @throws InvalidFormatException If the specified part name ends with a forwar slash character
     *                                '/'.
     */
     ...
     *
     * @param partUri The URI to check.
     * @throws InvalidFormatException Throws if the specified URI is absolute.
     */
     ...
     * requirements of {@code java.util.Comparator}, but simply implemented as a
     * static method.
     * <p/>
    ...
    public static int compare(PackagePartName obj1, PackagePartName obj2) {
        ...
        return compare(obj1.getURI().toASCIIString().toLowerCase(Locale.ROOT),
                obj2.getURI().toASCIIString().toLowerCase(Locale.ROOT));
    }

    /**
     * A natural sort order for strings, consistent with the requirements of
     * {@code java.util.Comparator}, but simply implemented as a static method.
     * <p/>
     * For example, this sorts "file10.png" after "file2.png" (comparing the
     * numerical portion), but sorts "File10.png" before "file2.png"
     * (lexigraphical sort)
    ...
    public static int compare(String str1, String str2) {
        ...
        for (int idx1 = 0, idx2 = 0; idx1 < len1 && idx2 < len2; /* nil */) {
            ...
            if (Character.isDigit(c1) && Character.isDigit(c2)) {
                ...
                int cmp = new BigInteger(str1.substring(beg1, idx1))
                        .compareTo(new BigInteger(str2.substring(beg2, idx2)));
                if (cmp != 0)
                    return cmp;
            } else if (c1 != c2) {
                return (c1 - c2);
     ...
     *
     * @param partUri The URI to check.
     * @return <code>true</code> if this part name respect the relationship part
     * naming convention else <code>false</code>.
     */
    ...
    public boolean equals(Object other) {
        if (other instanceof PackagePartName) {
            ...
            return this.partNameURI
                    ...
                    .equals(((PackagePartName) other).partNameURI
                            .toASCIIString().toLowerCase(Locale.ROOT));
        } else {
            return false;
        }
    }
    ...
    @Override
    public int hashCode() {
        return this.partNameURI.toASCIIString().toLowerCase(Locale.ROOT)
                .hashCode();
    }
