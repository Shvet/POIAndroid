...
import com.shvet.poi.openxml4j.opc.ContentTypes;
...
public final class PackagePropertiesPart extends PackagePart implements
     ...
     * Constructor.
     *
     * @param pack     Container package.
     * @param partName Name of this part.
     * @throws InvalidFormatException Throws if the content is invalid.
     */
     ...
     *
     * @see org.apache.poi.openxml4j.opc.PackageProperties#setCreatedProperty(com.shvet.poi.openxml4j.util.Nullable)
     */
     ...
     *
     * @see org.apache.poi.openxml4j.opc.PackageProperties#setLastPrintedProperty(com.shvet.poi.openxml4j.util.Nullable)
     */
     ...
     *
     * @see org.apache.poi.openxml4j.opc.PackageProperties#setModifiedProperty(com.shvet.poi.openxml4j.util.Nullable)
     */
     ...
     *
     * @throws InvalidFormatException Throws if the date format isnot valid.
     */
