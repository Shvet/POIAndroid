...
package com.shvet.poi.openxml4j.opc.internal.marshallers;
...
import com.shvet.poi.openxml4j.opc.StreamHelper;
...
public final class ZipPartMarshaller implements PartMarshaller {
    private static POILogger logger = POILogFactory
            .getLogger(ZipPartMarshaller.class);
    ...
    public static boolean marshallRelationshipPart(
        ...
        Element root = xmlOutDoc.createElementNS(
                PackageNamespaces.RELATIONSHIPS,
                PackageRelationship.RELATIONSHIPS_TAG_NAME);
        ...
        for (PackageRelationship rel : rels) {
            ...
            Element relElem = xmlOutDoc.createElementNS(
                    PackageNamespaces.RELATIONSHIPS,
                    PackageRelationship.RELATIONSHIP_TAG_NAME);
            root.appendChild(relElem);

            // the relationship ID
            relElem.setAttribute(PackageRelationship.ID_ATTRIBUTE_NAME,
                    rel.getId());

            // the relationship Type
            relElem.setAttribute(PackageRelationship.TYPE_ATTRIBUTE_NAME,
            ...
            if (rel.getTargetMode() == TargetMode.EXTERNAL) {
                ...
                targetValue = PackagingURIHelper.relativizeURI(sourcePartURI,
                        targetURI, true).toString();
            }
     ...
     *
     * @throws OpenXML4JException Throws if an internal exception is thrown.
     */
    public boolean marshall(PackagePart part, OutputStream os)
        ...
        ZipEntry partEntry = new ZipEntry(
                ZipHelper.getZipItemNameFromOPCName(part.getPartName().getURI()
                        .getPath()));
        try {
            ...
            logger.log(POILogger.ERROR, "Cannot write: " + part.getPartName()
                    + ": in ZIP", ioe);
            return false;
        }
