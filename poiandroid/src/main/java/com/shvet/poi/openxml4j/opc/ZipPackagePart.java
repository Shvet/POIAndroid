...
public class ZipPackagePart extends PackagePart {
     ...
     * Constructor.
     *
     * @param container   The container package.
     * @param partName    Part name.
     * @param contentType Content type.
     * @throws InvalidFormatException Throws if the content of this part invalid.
     */
     ...
     *
     * @param container   The container package.
     * @param zipEntry    The zip entry corresponding to this part.
     * @param partName    The part name.
     * @param contentType Content type.
     * @throws InvalidFormatException Throws if the content of this part is invalid.
     */
