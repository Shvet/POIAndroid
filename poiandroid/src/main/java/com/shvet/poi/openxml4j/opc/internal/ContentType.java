...
public final class ContentType {
    ...
    /**
     * Pattern to match on just the parameters part, to work around the Java
     * Regexp group capture behaviour
     */
     ...
     * @throws InvalidFormatException If the specified content type is not valid with RFC 2616.
     */
    public ContentType(String contentType) throws InvalidFormatException {
        ...
        if (mMediaType.groupCount() >= 2) {
            ...
            if (mMediaType.groupCount() >= 5) {
                Matcher mParams = patternParams.matcher(contentType
                        .substring(mMediaType.end(2)));
                while (mParams.find()) {
