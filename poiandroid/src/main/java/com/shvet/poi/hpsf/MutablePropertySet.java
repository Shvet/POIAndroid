...
public class MutablePropertySet extends PropertySet {
     ...
     * </p>
     */
    private final int OFFSET_HEADER = BYTE_ORDER_ASSERTION.length + /*
                                                                     * Byte
																	 * order
																	 */
    ...
    /**
     * <p>
     * Constructs a <code>MutablePropertySet</code> instance. Its primary task
     * is to initialize the immutable field with their proper values. It also
     * sets fields that might change to reasonable defaults.
     * </p>
     */
    public MutablePropertySet() {
		...
		/*
		 * Initialize "osVersion" field as if the property has been created on a
		 * Win32 platform, whether this is the case or not.
		 */
		...
		/*
		 * Initialize the sections. Since property set must have at least one
		 * section it is added right here.
		 */
    ...
    /**
     * <p>
     * Constructs a <code>MutablePropertySet</code> by doing a deep copy of an
     * existing <code>PropertySet</code>. All nested elements, i.e.
     * <code>Section</code>s and <code>Property</code> instances, will be their
     * mutable counterparts in the new <code>MutablePropertySet</code>.
     * </p>
     *
     ...
     * </p>
     *
     * @param section The {@link Section} to add. It will be appended after any
     *                sections that are already present in the property set and thus
     *                become the last section.
     */
     ...
     * @throws IOException                  if an error when writing to the output stream occurs
    ...
    /**
     * <p>
     * Returns the contents of this property set stream as an input stream. The
     * latter can be used for example to write the property set into a POIFS
     * document. The input stream represents a snapshot of the property set. If
     * the latter is modified while the input stream is still being read, the
     * modifications will not be reflected in the input stream but in the
     * {@link MutablePropertySet} only.
     * </p>
     *
     * @return the contents of this property set stream
     * @throws WritingNotSupportedException if HPSF does not yet support writing of a property's variant
     *                                      type.
