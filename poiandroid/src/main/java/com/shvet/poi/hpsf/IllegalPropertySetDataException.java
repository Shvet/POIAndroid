 ...
 * {@link PropertySet}. For example, a {@link Variant#VT_BOOL} must have a value
 * of <code>-1 (true)</code> or <code>0 (false)</code>. Any other value would
 * trigger this exception. It supports a nested "reason" throwable, i.e. an
 * exception that caused this one to be thrown.
 * </p>
 *
