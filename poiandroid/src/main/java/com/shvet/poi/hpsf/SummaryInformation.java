...
public final class SummaryInformation extends SpecialPropertySet {
     ...
     *           information stream.
     * @throws UnexpectedPropertySetTypeException if <var>ps</var> does not contain a summary information
     *                                            stream.
     */
    ...
    /**
     * <p>
     * Returns the title (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the subject (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the author (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the keywords (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the comments (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the template (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the last author (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the revision number (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the total time spent in editing the document (or <code>0</code>).
     * </p>
     *
     * @return The total time spent in editing the document or 0 if the
     * {@link SummaryInformation} does not contain this information.
     */
    ...
    /**
     * <p>
     * Returns the last printed time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the creation time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the last save time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the page count or 0 if the {@link SummaryInformation} does not
    ...
    /**
     * <p>
     * Returns the word count or 0 if the {@link SummaryInformation} does not
    ...
    /**
     * <p>
     * Returns the character count or 0 if the {@link SummaryInformation} does
     * not contain a char count.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the thumbnail (or <code>null</code>) <strong>when this method is
     * implemented. Please note that the return type is likely to
     * change!</strong>
     * </p>
     * <p/>
     * <p>
     * <strong>Hint to developers:</strong> Drew Varner &lt;Drew.Varner -at-
     ...
     * <li>
     * <p>
     * 0 if the {@link SummaryInformation} does not contain a security field or
     * if there is no security on the document. Use
     * {@link PropertySet#wasNull()} to distinguish between the two cases!
     * </p>
     * </li>
     * <p/>
     * <li>
