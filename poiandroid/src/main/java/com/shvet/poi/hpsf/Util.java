...
public class Util {
    ...
    public static void copy(final byte[] src, final int srcOffset,
                            final int length, final byte[] dst, final int dstOffset) {
     ...
     * @return A new byte array containing the concatenated byte arrays.
     */
    ...
    /**
     * <p>
     * Checks whether two collections are equal. Two collections C<sub>1</sub>
     * and C<sub>2</sub> are equal, if the following conditions are true:
     * </p>
     * <p/>
     * <ul>
     * <p/>
     * <li>
     * <p>
     * For each c<sub>1<em>i</em></sub> (element of C<sub>1</sub>) there is a
     * c<sub>2<em>j</em></sub> (element of C<sub>2</sub>), and c<sub>1<em>i</em>
     * </sub> equals c<sub>2<em>j</em></sub>.
     * </p>
     * </li>
     * <p/>
     * <li>
     * <p>
     * For each c<sub>2<em>i</em></sub> (element of C<sub>2</sub>) there is a
     * c<sub>1<em>j</em></sub> (element of C<sub>1</sub>) and c<sub>2<em>i</em>
     * </sub> equals c<sub>1<em>j</em></sub>.
     * </p>
     * </li>
     * <p/>
     * </ul>
    ...
    /**
     * <p>
     * Compares to object arrays with regarding the objects' order. For example,
     * [1, 2, 3] and [2, 1, 3] are equal.
     * </p>
     *
    ...
    /**
     * <p>
     * Pads a string with 0x0000 characters so that its length is a multiple of
     * 4.
     * </p>
     *
