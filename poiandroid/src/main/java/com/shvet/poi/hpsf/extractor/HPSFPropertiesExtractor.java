...
package com.shvet.poi.hpsf.extractor;

import com.shvet.poi.POIDocument;
import com.shvet.poi.POIOLE2TextExtractor;
import com.shvet.poi.POITextExtractor;
import com.shvet.poi.hpsf.CustomProperties;
import com.shvet.poi.hpsf.DocumentSummaryInformation;
import com.shvet.poi.hpsf.HPSFPropertiesOnlyDocument;
import com.shvet.poi.hpsf.Property;
import com.shvet.poi.hpsf.SpecialPropertySet;
...
/**
 * Extracts all of the HPSF properties, both build in and custom, returning them
 * in textual form.
 */
public class HPSFPropertiesExtractor extends POIOLE2TextExtractor {
    ...
    private static String getPropertiesText(SpecialPropertySet ps) {
        ...
        for (int i = 0; i < props.length; i++) {
            ...
            String val = HelperPropertySet.getPropertyValueText(props[i]
                    .getValue());
    ...
    public String getDocumentSummaryInformationText() {
        if (document == null) { // event based extractor does not have a
            // document
            return "";
        }

        DocumentSummaryInformation dsi = document
        ...
        if (cps != null) {
            ...
            while (keys.hasNext()) {
                ...
                String val = HelperPropertySet.getPropertyValueText(cps
                        .get(key));
                text.append(key + " = " + val + "\n");
            }
        }
    ...
    /**
     * @return the text of all the properties defined in the document.
     */
    public String getText() {
        return getSummaryInformationText()
    ...
    public POITextExtractor getMetadataTextExtractor() {
        throw new IllegalStateException(
                "You already have the Metadata Text Extractor, not recursing!");
    }
