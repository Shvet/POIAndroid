...
/**
 * A version of {@link POIDocument} which allows access to the HPSF Properties,
 * but no other document contents. Normally used when you want to read or alter
 * the Document Properties, without affecting the rest of the file
 */
