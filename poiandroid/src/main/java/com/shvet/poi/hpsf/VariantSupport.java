 ...
 * <p/>
 * <p>
 * <strong>FIXME (3):</strong> Reading and writing should be made more uniform
 * than it is now. The following items should be resolved:
 * <p/>
 * <ul>
 * <p/>
 * <li>
 * <p>
 * Reading requires a length parameter that is 4 byte greater than the actual
 * data, because the variant type field is included.
 * </p>
 * </li>
 * <p/>
 * <li>
 * <p>
 * Reading reads from a byte array while writing writes to an byte array output
 * stream.
 * </p>
 * </li>
 * <p/>
...
public class VariantSupport extends Variant {
    ...
    private static final POILogger logger = POILogFactory
            .getLogger(VariantSupport.class);
    /**
     * <p>
    ...
    /**
     * <p>
     * Checks whether logging of unsupported variant types warning is turned on
     * or off.
     * </p>
     *
     ...
     * written to <code>System.err</code> or not.
     * </p>
     *
     * @param logUnsupportedTypes If <code>true</code> warnings will be written, if
    ...
    /**
     * <p>
     * Writes a warning to <code>System.err</code> that a variant type is
     ...
     * {@link String}.
     * @throws ReadingNotSupportedException if a property is to be written who's variant type HPSF
     ...
     * the encoding name is "UTF-8". All other positive numbers are
     * mapped to "cp" followed by the number, e.g. if the codepage
     * number is 1252 the returned character encoding name will be
     * "cp1252".
     * @throws UnsupportedEncodingException if the specified codepage is less than zero.
     */
     ...
     * @throws WritingNotSupportedException if a property is to be written who's variant type HPSF
     *                                      does not yet support
     */
    public static int write(final OutputStream out, final long type,
                            final Object value, final int codepage) throws IOException,
        ...
        switch ((int) type) {
            ...
            default: {
			/*
			 * The variant type is not supported yet. However, if the value is a
			 * byte array we can write it nevertheless.
			 */
                if (value instanceof byte[]) {
                    final byte[] b = (byte[]) value;
                    out.write(b);
                    length = b.length;
                    writeUnsupportedTypeMessage(new WritingNotSupportedException(
                            type, value));
                } else
