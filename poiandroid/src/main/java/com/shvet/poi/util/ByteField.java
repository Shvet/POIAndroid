...
import com.shvet.poi.util.LittleEndian.BufferUnderrunException;
...
/**
 * representation of a byte (8-bit) field at a fixed location within a byte
 * array
 *
...
public class ByteField implements FixedField {
    ...
    /**
     * construct the ByteField with its offset into its containing byte array
    ...
    /**
     * Construct the ByteField with its offset into its containing byte array
     * and initialize its value from its byte array
     *
     * @param offset of the field within its byte array
     * @param data   the byte array to read the value from
     * @throws ArrayIndexOutOfBoundsException if the offset is not within the range of 0..(data.length -
     *                                        1)
     */
    ...
    /**
     * construct the ByteField with its offset into its containing byte array,
     * initialize its value, and write its value to its byte array
     *
     * @param offset of the field within its byte array
     * @param value  the initial value
     ...
     * @param value to be set
     * @param data  the byte array to write the value to
     * @throws ArrayIndexOutOfBoundsException if the offset is out of the byte array's range
     */
     ...
     * @throws ArrayIndexOutOfBoundsException if the offset is out of range of the bte array
     */
     ...
     *
     * @param stream the InputStream from which the value is to be read
     * @throws BufferUnderrunException if there is not enough data available from the InputStream
     * @throws IOException             if an IOException is thrown from reading the InputStream
     */
     ...
     *
     * @param data the array of bytes to which the value is to be written
     * @throws ArrayIndexOutOfBoundsException if the offset is out of the byte array's range
     */
