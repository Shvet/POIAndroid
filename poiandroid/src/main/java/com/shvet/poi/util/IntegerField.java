...
/**
 * representation of an integer (32-bit) field at a fixed location within a byte
 * array
 *
...
public class IntegerField implements FixedField {
     ...
     * @throws ArrayIndexOutOfBoundsException if the offset is negative
     */
     ...
     * @throws ArrayIndexOutOfBoundsException if the offset is negative or too large
     */
     ...
     * @param value to be set
     * @param data  the byte array to write the value to
     * @throws ArrayIndexOutOfBoundsException if the offset is too large
     */
