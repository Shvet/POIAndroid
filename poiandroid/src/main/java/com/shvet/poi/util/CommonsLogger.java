...
/**
 * A logger class that strives to make it as easy as possible for developers to
 * write log calls, while simultaneously making those calls as cheap as possible
 * by performing lazy evaluation of the log message.
 * <p/>
 *
