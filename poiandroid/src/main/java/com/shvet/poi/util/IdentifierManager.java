...
public class IdentifierManager {
    ...
    /**
     * @param lowerbound the lower limit of the id-range to manage. Must be greater
     *                   than or equal to {@link #MIN_ID}.
     * @param upperbound the upper limit of the id-range to manage. Must be less then
     *                   or equal {@link #MAX_ID}.
     */
    public IdentifierManager(long lowerbound, long upperbound) {
        if (lowerbound > upperbound) {
            ...
            String message = "lowerbound must be greater than or equal to "
                    + Long.toString(MIN_ID);
            throw new IllegalArgumentException(message);
			 ...
			 */
            String message = "upperbound must be less thean or equal "
                    + Long.toString(MAX_ID);
            throw new IllegalArgumentException(message);
        }
     ...
     * @throws IllegalStateException if no more identifiers are available, then an Exception is
     *                               raised.
     */
    ...
    /**
     * @param id the identifier to release. Must be greater than or equal to
     *           {@link #lowerbound} and must be less than or equal to
     *           {@link #upperbound}
