...
public class LittleEndian implements LittleEndianConsts {
     ...
     * @param offset Where to start copying from.
     * @param size   Number of bytes to copy.
     * @throws IndexOutOfBoundsException - if read would cause access of data outside array bounds.
     */
     ...
     * @param data   the byte array
     * @param offset a starting offset into the byte array
     * @param value  the float (32-bit) value
     */
     ...
     *
     * @param data        the byte array
     * @param startOffset a starting offset into the byte array
     * @param value       the short (16-bit) values
     */
     ...
     * @param offset a starting offset into the byte array
     * @param value  the short (16-bit) value
     * @throws ArrayIndexOutOfBoundsException may be thrown
     */
     ...
     *
     * @param value        the unsigned short (16-bit) value
     * @param outputStream output stream
     * @throws IOException if an I/O error occurs
     */
