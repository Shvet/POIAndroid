...
public class XWPFPictureData extends POIXMLDocumentPart {
     ...
     * @param rel  the package relationship holding this drawing, the
     ...
     * copied into a temporary byte array. You can grab the picture data
     * directly from the underlying package part as follows: <br/>
     * <code>
     ...
     * without keeping a copy like all others therefore we need to handle them
     * differently.
     */
    @Override
