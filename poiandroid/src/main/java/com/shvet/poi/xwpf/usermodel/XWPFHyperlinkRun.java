...
/**
 * A run of text with a Hyperlink applied to it. Any given Hyperlink may be made
 * up of multiple of these.
 */
public class XWPFHyperlinkRun extends XWPFRun {
    ...
    /**
     * If this Hyperlink is an external reference hyperlink, return the object
     * for it.
     */
