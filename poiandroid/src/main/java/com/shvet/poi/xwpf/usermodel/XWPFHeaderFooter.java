 ...
 */
public abstract class XWPFHeaderFooter extends POIXMLDocumentPart implements
        IBody {
    ...
    public XWPFHeaderFooter(POIXMLDocumentPart parent, PackagePart part,
                            PackageRelationship rel) throws IOException {
     ...
     * Normally there is only the one paragraph, but there could be more in
     * certain cases, or a table.
     */
    ...
    /**
     * Return the table(s) that holds the text of the header or footer, for
     * complex cases where a paragraph isn't used. Normally there's just one
     * paragraph, but some complex headers/footers have a table or two in
     * addition.
     */
    ...
    /**
     * Returns the textual content of the header/footer, by flattening out the
     * text of its paragraph(s)
     */
    ...
    /**
     * if there is a corresponding {@link XWPFTable} of the parameter ctTable in
     * the tableList of this header the method will return this table if there
     * is no corresponding {@link XWPFTable} the method will return null
     *
     * @param ctTable
     */
     ...
     * ctTable in the paragraphList of this header or footer the method will
     * return this paragraph if there is no corresponding {@link XWPFParagraph}
     * the method will return null
     *
     * @param p is instance of CTP and is searching for an XWPFParagraph
     * @return null if there is no XWPFParagraph with an corresponding
     * CTPparagraph in the paragraphList of this header or footer
     ...
     * @throws com.shvet.poi.openxml14j.exceptions.InvalidFormatException
     */
    public String addPictureData(byte[] pictureData, int format)
            throws InvalidFormatException {
        XWPFPictureData xwpfPicData = document.findPackagePictureData(
                pictureData, format);
