 ...
 * document. The break type determines the next location where text shall be
...
public enum BreakType {
     ...
     * the document when the document is displayed in page view. The determine
     * of the next line shall be done subject to the value of the clear
