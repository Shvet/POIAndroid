...
==================================================================== */
package com.shvet.poi.xwpf.extractor;

import com.shvet.poi.POIXMLDocument;
import com.shvet.poi.POIXMLTextExtractor;
import com.shvet.poi.openxml4j.exceptions.OpenXML4JException;
import com.shvet.poi.openxml4j.opc.OPCPackage;
import com.shvet.poi.xwpf.model.XWPFCommentsDecorator;
import com.shvet.poi.xwpf.model.XWPFHeaderFooterPolicy;
import com.shvet.poi.xwpf.usermodel.IBodyElement;
import com.shvet.poi.xwpf.usermodel.ICell;
import com.shvet.poi.xwpf.usermodel.IRunElement;
import com.shvet.poi.xwpf.usermodel.XWPFDocument;
import com.shvet.poi.xwpf.usermodel.XWPFHyperlink;
import com.shvet.poi.xwpf.usermodel.XWPFHyperlinkRun;
import com.shvet.poi.xwpf.usermodel.XWPFParagraph;
import com.shvet.poi.xwpf.usermodel.XWPFRelation;
import com.shvet.poi.xwpf.usermodel.XWPFSDT;
import com.shvet.poi.xwpf.usermodel.XWPFSDTCell;
import com.shvet.poi.xwpf.usermodel.XWPFTable;
import com.shvet.poi.xwpf.usermodel.XWPFTableCell;
import com.shvet.poi.xwpf.usermodel.XWPFTableRow;
...
public class XWPFWordExtractor extends POIXMLTextExtractor {
    public static final XWPFRelation[] SUPPORTED_TYPES = new XWPFRelation[]{
            ...
            XWPFRelation.MACRO_DOCUMENT, XWPFRelation.MACRO_TEMPLATE_DOCUMENT};
    ...
    public static void main(String[] args) throws Exception {
        ...
        POIXMLTextExtractor extractor = new XWPFWordExtractor(
                POIXMLDocument.openPackage(args[0]));
    ...
    public void appendParagraphText(StringBuffer text, XWPFParagraph paragraph) {
        ...
        // Add comments
        XWPFCommentsDecorator decorator = new XWPFCommentsDecorator(paragraph,
                null);
    ...
    private void extractHeaders(StringBuffer text,
                                XWPFHeaderFooterPolicy hfPolicy) {
        if (hfPolicy == null)
            return;
