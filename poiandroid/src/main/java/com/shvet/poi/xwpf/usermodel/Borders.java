 ...
 * <ul>
 * <li>Line borders: which specify a pattern to be used when drawing a line
 * around the specified object.</li>
 * <li>Art borders: which specify a repeated image to be used when drawing a
 * border around the specified object. Line borders may be specified on any
 * object which allows a border, however, art borders may only be used as a
 * border at the page level - the borders under the pgBorders element</li>
 * </ul>
 *
