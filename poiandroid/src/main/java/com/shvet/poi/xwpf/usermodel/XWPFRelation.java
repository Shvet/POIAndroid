...
public final class XWPFRelation extends POIXMLRelation {
    ...
    public static final XWPFRelation FOOTNOTE = new XWPFRelation(
            ...
            "/word/footnotes.xml", XWPFFootnotes.class);
