 ...
 * <p/>
 * <p/>
 * Chart related records don't seem to be covered in either the <A
 * HREF="http://sc.openoffice.org/excelfileformat.pdf">OOO</A> or the <A HREF=
 ...
 * >MS</A> documentation.
 * <p/>
 * The book "Microsoft Excel 97 Developer's Kit" ISBN: (1-57231-498-2) seems to
 * have an entire chapter (10) devoted to Chart records. One <A HREF=
 * "http://ooxmlisdefectivebydesign.blogspot.com/2008/03/bad-surprise-in-microsoft-office-binary.html"
 * >blog</A> suggests that some documentation for these records is available in
 * "MSDN Library, Feb 1998", but no later.
 *
