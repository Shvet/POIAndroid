 ...
 * <p/>
 * Description: flag denoting whether the user specified that gridlines are used
 * when printing.
 * <p/>
...
public final class GridsetRecord extends StandardRecord {
     ...
     *
     * @param gridset - <b>true</b> if no gridlines are print, <b>false</b> if
     *                gridlines are not print.
     */
