...
public class HSSFPatternFormatting implements
        com.shvet.poi.ss.usermodel.PatternFormatting {
    ...
    /**
     * @see com.shvet.poi.hssf.record.cf.PatternFormatting#getFillBackgroundColor()
     */
    ...
    /**
     * @param bg
     * @see com.shvet.poi.hssf.record.cf.PatternFormatting#setFillBackgroundColor(int)
     */
    ...
    /**
     * @see com.shvet.poi.hssf.record.cf.PatternFormatting#getFillForegroundColor()
     */
    ...
    /**
     * @param fg
     * @see com.shvet.poi.hssf.record.cf.PatternFormatting#setFillForegroundColor(int)
     */
    ...
    /**
     * @see com.shvet.poi.hssf.record.cf.PatternFormatting#getFillPattern()
     */
    ...
    /**
     * @param fp
     * @see com.shvet.poi.hssf.record.cf.PatternFormatting#setFillPattern(int)
     */
