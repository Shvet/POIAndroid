...
import com.shvet.poi.hssf.record.CFRule12Record;
import com.shvet.poi.hssf.record.CFRuleBase;
import com.shvet.poi.hssf.record.CFRuleRecord;
...
import com.shvet.poi.ss.usermodel.SheetConditionalFormatting;
...
public final class HSSFSheetConditionalFormatting implements
    ...
    /* package */HSSFSheetConditionalFormatting(HSSFSheet sheet) {
        _sheet = sheet;
        _conditionalFormattingTable = sheet.getSheet()
                .getConditionalFormattingTable();
    }

    /**
     * A factory method allowing to create a conditional formatting rule with a
     * cell comparison operator
     * <p/>
     * TODO - formulas containing cell references are currently not parsed
     * properly
     *
     * @param comparisonOperation - a constant value from <tt>
     *                            {@link com.shvet.poi.hssf.record.CFRuleBase.ComparisonOperator}
     *                            </tt>:
     *                            <p>
     *                            <ul>
     *                            <li>BETWEEN</li>
     ...
     *                            {@link com.shvet.poi.hssf.record.CFRuleBase.ComparisonOperator#BETWEEN}
     *                            ) and
     *                            {@link com.shvet.poi.hssf.record.CFRuleBase.ComparisonOperator#NOT_BETWEEN}
     *                            operations)
     */
    public HSSFConditionalFormattingRule createConditionalFormattingRule(
            byte comparisonOperation, String formula1, String formula2) {
        CFRuleRecord rr = CFRuleRecord.create(_sheet, comparisonOperation,
                formula1, formula2);
     ...
     * formula.<br>
     * <p/>
     * The formatting rules are applied by Excel when the value of the formula
     * not equal to 0.
     * <p/>
     * TODO - formulas containing cell references are currently not parsed
     * properly
    ...
    /**
     * A factory method allowing the creation of conditional formatting rules
     * using an Icon Set / Multi-State formatting. The thresholds for it will be
     * created, but will be empty and require configuring with
     * {@link HSSFConditionalFormattingRule#getMultiStateFormatting()} then
     ...
     * <p/>
     * The thresholds and colour for it will be created, but will be empty and
     * require configuring with
     * {@link HSSFConditionalFormattingRule#getDataBarFormatting()} then
     * {@link HSSFDataBarFormatting#getMinThreshold()} and
     * {@link HSSFDataBarFormatting#getMaxThreshold()}
     */
    public HSSFConditionalFormattingRule createConditionalFormattingRule(
            HSSFExtendedColor color) {
        CFRule12Record rr = CFRule12Record.create(_sheet,
     ...
     * <p/>
     * The thresholds and colours for it will be created, but will be empty and
     * require configuring with
     * {@link HSSFConditionalFormattingRule#getColorScaleFormatting()} then
     * {@link HSSFColorScaleFormatting#getThresholds()} and
     ...
     * <p/>
     * This method could be used to copy HSSFConditionalFormatting object from
     * one sheet to another. For example:
     * <p/>
     * <pre>
    ...
    public int addConditionalFormatting(HSSFConditionalFormatting cf) {
        CFRecordsAggregate cfraClone = cf.getCFRecordsAggregate()
                .cloneCFAggregate();
     ...
     */
    public int addConditionalFormatting(com.shvet.poi.ss.util.Region[] regions,
                                        HSSFConditionalFormattingRule[] cfRules) {
        return addConditionalFormatting(
                com.shvet.poi.ss.util.Region
                        .convertRegionsToCellRanges(regions),
                cfRules);
    }
     ...
     *
     * @param regions - list of rectangular regions to apply conditional formatting
     *                rules
    ...
    public int addConditionalFormatting(CellRangeAddress[] regions,
        ...
        return addConditionalFormatting(regions, rule1 == null ? null
                : new HSSFConditionalFormattingRule[]{rule1});
    }
