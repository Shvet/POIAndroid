...
/**
 * This structure appears as part of an Obj record that represents image display
 * properties.
 */
public final class FtPioGrbitSubRecord extends SubRecord {
    ...
    /**
     * A bit that specifies whether the picture's aspect ratio is preserved when
     * rendered in different views (Normal view, Page Break Preview view, Page
     * Layout view and printing).
     */
    public static final int AUTO_PICT_BIT = 1 << 0;

    /**
     * A bit that specifies whether the pictFmla field of the Obj record that
     * contains this FtPioGrbit specifies a DDE reference.
     */
    public static final int DDE_BIT = 1 << 1;

    /**
     * A bit that specifies whether this object is expected to be updated on
     * print to reflect the values in the cell associated with the object.
     */
    ...
    /**
     * A bit that specifies whether this object is an ActiveX control. It MUST
     * NOT be the case that both fCtl and fDde are equal to 1.
     */
    public static final int CTL_BIT = 1 << 4;

    /**
     * A bit that specifies whether the object data are stored in an embedding
     * storage (= 0) or in the controls stream (ctls) (= 1).
     */
    ...
    /**
     * A bit that specifies whether the OLE server for the object is called to
     * load the object's data automatically when the parent workbook is opened.
     */
    ...
    /**
     * Construct a new <code>FtPioGrbitSubRecord</code> and fill its data with
     * the default values
     */
    ...
    public String toString() {
        ...
        buffer.append("  flags    = ").append(HexDump.toHex(flags))
                .append("\n");
        buffer.append("[/FtPioGrbit ]\n");
