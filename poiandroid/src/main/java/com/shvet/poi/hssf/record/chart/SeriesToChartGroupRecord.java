...
/**
 * Indicates the chart-group index for a series. The order probably defines the
 * mapping. So the 0th record probably means the 0th series. The only field in
 * this of course defines which chart group the 0th series (for instance) would
 * map to. Confusing? Well thats because it is. (p 522 BCG)
 * <p/>
 *
...
public final class SeriesToChartGroupRecord extends StandardRecord {
    ...
    public String toString() {
        ...
        buffer.append("    .chartGroupIndex      = ").append("0x")
                .append(HexDump.toHex(getChartGroupIndex())).append(" (")
                .append(getChartGroupIndex()).append(" )");
