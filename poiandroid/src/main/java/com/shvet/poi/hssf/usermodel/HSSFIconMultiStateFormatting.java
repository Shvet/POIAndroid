...
import com.shvet.poi.ss.usermodel.ConditionalFormattingThreshold;

/**
 * High level representation for Icon / Multi-State Formatting component of
 * Conditional Formatting settings
 */
public final class HSSFIconMultiStateFormatting implements
        com.shvet.poi.ss.usermodel.IconMultiStateFormatting {
    ...
    public void setThresholds(ConditionalFormattingThreshold[] thresholds) {
        ...
        for (int i = 0; i < t.length; i++) {
            t[i] = ((HSSFConditionalFormattingThreshold) thresholds[i])
                    .getThreshold();
        }
    ...
    public HSSFConditionalFormattingThreshold createThreshold() {
        return new HSSFConditionalFormattingThreshold(
                new IconMultiStateThreshold(), sheet);
    }
}
