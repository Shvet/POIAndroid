 ...
 * <p/>
 * Description: used in data validation ; This record is the list header of all
 * data validation records (0x01BE) in the current sheet.
 *
...
public final class DVALRecord extends StandardRecord {
    ...
    /**
     * Object ID of the drop down arrow object for list boxes ; in our case this
     * will be always FFFF , until MSODrawingGroup and MSODrawing records are
     * implemented
     */
    ...
    public String toString() {
        ...
        buffer.append("    .horizPos     = ").append(getHorizontalPos())
                .append('\n');
        buffer.append("    .vertPos      = ").append(getVerticalPos())
                .append('\n');
