...
public final class DrawingSelectionRecord extends StandardRecord {
    ...
    // [MS-OGRAPH].pdf says that the data of this record is an OfficeArtFDGSL
    // structure
    ...
    protected int getDataSize() {
        return OfficeArtRecordHeader.ENCODED_SIZE + 12 // 3 int fields
                + _shapeIds.length * 4;
    }
    ...
    public String toString() {
        ...
        sb.append("    .rh       =(").append(_header.debugFormatAsString())
                .append(")\n");
        sb.append("    .cpsp     =").append(HexDump.intToHex(_cpsp))
                .append('\n');
        sb.append("    .dgslk    =").append(HexDump.intToHex(_dgslk))
                .append('\n');
        sb.append("    .spidFocus=").append(HexDump.intToHex(_spidFocus))
                .append('\n');
        sb.append("    .shapeIds =(");
        for (int i = 0; i < _shapeIds.length; i++) {
            if (i > 0) {
