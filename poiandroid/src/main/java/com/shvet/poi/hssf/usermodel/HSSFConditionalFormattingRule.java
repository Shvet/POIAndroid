...
import com.shvet.poi.hssf.record.CFRuleBase.ComparisonOperator;
...
import com.shvet.poi.ss.usermodel.ConditionType;
import com.shvet.poi.ss.usermodel.ConditionalFormattingRule;

/**
 * High level representation of Conditional Formatting Rule. It allows to
 * specify formula based conditions for the Conditional Formatting and the
 * formatting settings such as font, border and pattern.
 */
public final class HSSFConditionalFormattingRule implements
    ...
    protected static String toFormulaString(Ptg[] parsedExpression,
        ...
        if (cfRuleRecord instanceof CFRule12Record) {
            ...
            if (create)
                throw new IllegalArgumentException(
                        "Can't convert a CF into a CF12 record");
            return null;
        }
    ...
    /**
     * create a new font formatting structure if it does not exist, otherwise
     * just return existing object.
     *
    ...
    /**
     * create a new border formatting structure if it does not exist, otherwise
     * just return existing object.
     *
    ...
    private HSSFPatternFormatting getPatternFormatting(boolean create) {
        PatternFormatting patternFormatting = cfRuleRecord
    ...
    /**
     * create a new pattern formatting structure if it does not exist, otherwise
     * just return existing object.
     *
    ...
    private HSSFDataBarFormatting getDataBarFormatting(boolean create) {
        ...
        DataBarFormatting databarFormatting = cfRule12Record
    ...
    private HSSFIconMultiStateFormatting getMultiStateFormatting(boolean create) {
        ...
        IconMultiStateFormatting iconFormatting = cfRule12Record
    ...
    private HSSFColorScaleFormatting getColorScaleFormatting(boolean create) {
        ...
        ColorGradientFormatting colorFormatting = cfRule12Record
    ...
    /**
     * create a new color scale / gradient formatting object if it does not
     * exist, otherwise just return the existing object.
     */
