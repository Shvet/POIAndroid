 ...
 * <p/>
 * This record specifies common information for Shared Features, and specifies
 * the beginning of a collection of records to define them. The collection of
 * data (Globals Substream ABNF, macro sheet substream ABNF or worksheet
 * substream ABNF) specifies Shared Feature data.
 */
public final class FeatHdrRecord extends StandardRecord {
    /**
     * Specifies the enhanced protection type. Used to protect a shared workbook
     * by restricting access to some areas of it
     */
    ...
    /**
     * Specifies the smart tag type. Recognises certain types of entries (proper
     * names, dates/times etc) and flags them for action
     */
    ...
    /**
     * 0x00000000 = rgbHdrData not present 0xffffffff = rgbHdrData present
     */
