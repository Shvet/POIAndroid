...
import com.shvet.poi.hssf.record.FilePassRecord;
...
final class Biff8RC4 implements Biff8Cipher {
    ...
    private ByteBuffer _buffer = ByteBuffer.allocate(8).order(
    ...
    /**
     * TODO: Additionally, the lbPlyPos (position_of_BOF) field of the
     * BoundSheet8 record MUST NOT be encrypted.
     *
     * @return <code>true</code> if record type specified by <tt>sid</tt> is
     * never encrypted
     */
    private static boolean isNeverEncryptedRecord(int sid) {
        switch (sid) {
            ...
            case FilePassRecord.sid:
                // this only really counts when writing because FILEPASS is read
                // early
