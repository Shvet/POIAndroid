...
public final class ColumnInfoRecordsAggregate extends RecordAggregate {
     ...
     *
     * @param fromColumnIx group from this column (inclusive)
     * @param toColumnIx   group to this column (inclusive)
     * @param indent       if <code>true</code> the group will be indented by one
