...
import com.shvet.poi.ss.formula.constant.ConstantValueParser;
...
public final class ExternalNameRecord extends StandardRecord {
    ...
    public final static short sid = 0x0023; // as per BIFF8. (some old versions
    // used 0x223)

    private static final int OPT_BUILTIN_NAME = 0x0001;
    private static final int OPT_AUTOMATIC_LINK = 0x0002; // m$ doc calls this
    // fWantAdvise
    ...
    /**
     * 'rgoper' / 'Last received results of the DDE link' (seems to be only
     * applicable to DDE links)<br/>
     * Logically this is a 2-D array, which has been flattened into 1-D array
     * here.
     */
    ...
    /**
     * If this is a local name, then this is the (1 based) index of the name of
     * the Sheet this refers to, as defined in the preceeding
     * {@link SupBookRecord}. If it isn't a local name, then it must be zero.
     */
    public short getIx() {
    ...
    public String toString() {
        ...
        sb.append("    .options      = ").append(field_1_option_flag)
                .append("\n");
