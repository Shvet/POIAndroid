 ...
 * record breaks the SST table into a set of buckets. The offsets to these
 * buckets within the SST record are kept as well as the position relative to
 * the start of the SST record. REFERENCE: PG 313 Microsoft Excel 97 Developer's
...
public final class ExtSSTRecord extends ContinuableRecord {
    ...
    public ExtSSTRecord(RecordInputStream in) {
        ...
        while (in.available() > 0) {
            ...
            if (in.available() == 0 && in.hasNextRecord()
                    && in.getNextSid() == ContinueRecord.sid) {
                in.nextRecord();
            }
        }
    ...
    public String toString() {
        ...
        buffer.append("    .dsst           = ")
                .append(Integer.toHexString(_stringsPerBucket)).append("\n");
        ...
        for (int k = 0; k < _sstInfos.length; k++) {
            ...
            buffer.append("    .streampos      = ")
                    .append(Integer.toHexString(_sstInfos[k].getStreamPos()))
                    .append("\n");
            buffer.append("    .sstoffset      = ")
                    .append(Integer.toHexString(_sstInfos[k]
                            .getBucketSSTOffset())).append("\n");
        }
        buffer.append("[/EXTSST]\n");
    ...
    public static final class InfoSubRecord {
        ...
        private int field_2_bucket_sst_offset; // don't really understand this
        // yet.
        /**
