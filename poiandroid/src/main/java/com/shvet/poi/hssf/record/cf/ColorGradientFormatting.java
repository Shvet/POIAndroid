...
/**
 * Color Gradient / Color Scale Conditional Formatting Rule Record. (Called
 * Color Gradient in the file format docs, but more commonly Color Scale in the
 * UI)
 */
public final class ColorGradientFormatting implements Cloneable {
    private static POILogger log = POILogFactory
            .getLogger(ColorGradientFormatting.class);
    ...
    public ColorGradientFormatting(LittleEndianInput in) {
        ...
        if (numI != numG) {
            log.log(POILogger.WARN,
                    "Inconsistent Color Gradient defintion, found " + numI
                            + " vs " + numG + " entries");
        }
        options = in.readByte();
    ...
    public String toString() {
        ...
        buffer.append("          .clamp     = ").append(isClampToCurve())
                .append("\n");
        buffer.append("          .background= ")
                .append(isAppliesToBackground()).append("\n");
