...
/**
 * The FtCf structure specifies the clipboard format of the picture-type Obj
 * record containing this FtCf.
 */
public final class FtCfSubRecord extends SubRecord {
    ...
    /**
     * Specifies the picture is in an unspecified format that is neither and
     * enhanced metafile nor a bitmap.
     */
