...
public final class LinkedDataRecord extends StandardRecord {
    ...
    private static final BitField customNumberFormat = BitFieldFactory
            .getInstance(0x1);
    ...
    public String toString() {
        ...
        buffer.append("    .indexNumberFmtRecord = ")
                .append(HexDump.shortToHex(getIndexNumberFmtRecord()))
                .append('\n');
     ...
     *
     * @return One of LINK_TYPE_TITLE_OR_TEXT LINK_TYPE_VALUES
     ...
     *
     * @param field_1_linkType One of LINK_TYPE_TITLE_OR_TEXT LINK_TYPE_VALUES
     *                         LINK_TYPE_CATEGORIES
     */
     ...
     *
     * @return One of REFERENCE_TYPE_DEFAULT_CATEGORIES REFERENCE_TYPE_DIRECT
     * REFERENCE_TYPE_WORKSHEET REFERENCE_TYPE_NOT_USED
     ...
     *
     * @param field_2_referenceType One of REFERENCE_TYPE_DEFAULT_CATEGORIES REFERENCE_TYPE_DIRECT
     *                              REFERENCE_TYPE_WORKSHEET REFERENCE_TYPE_NOT_USED
     *                              REFERENCE_TYPE_ERROR_REPORTED
     */
    ...
    /**
     * Sets the custom number format field value. true if this object has a
     * custom number format
     */
    public void setCustomNumberFormat(boolean value) {
        field_3_options = customNumberFormat.setShortBoolean(field_3_options,
                value);
    }
}
