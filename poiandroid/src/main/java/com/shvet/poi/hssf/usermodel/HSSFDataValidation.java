...
import com.shvet.poi.hssf.usermodel.DVConstraint.FormulaPair;
...
public final class HSSFDataValidation implements DataValidation {
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#setEmptyCellAllowed(boolean)
     */
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#getSuppressDropDownArrow()
     */
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#setSuppressDropDownArrow
     * (boolean)
     */
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#setShowPromptBox(boolean)
     */
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#setShowErrorBox(boolean)
     */
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#createPromptBox(java.lang
     ...
     *
     * @see
     * org.apache.poi.hssf.usermodel.DataValidation#createErrorBox(java.lang
     * .String, java.lang.String)
     */
    ...
    public DVRecord createDVRecord(HSSFSheet sheet) {
        ...
        return new DVRecord(_constraint.getValidationType(),
                _constraint.getOperator(), _errorStyle, _emptyCellAllowed,
                getSuppressDropDownArrow(),
                _constraint.getValidationType() == ValidationType.LIST
                        && _constraint.getExplicitListValues() != null,
                _showPromptBox, _prompt_title, _prompt_text, _showErrorBox,
                _error_title, _error_text, fp.getFormula1(), fp.getFormula2(),
                _regions);
    }
}
