 ...
 */
public abstract class HeaderFooter implements
        com.shvet.poi.ss.usermodel.HeaderFooter {
     ...
     * @param style the fonts style, one of regular, italic, bold, italic bold or
     *              bold italic
     * @return The mark-up tag representing a new font size
     */
