...
/**
 * High level representation for DataBar / Data-Bar Formatting component of
 * Conditional Formatting settings
 */
public final class HSSFDataBarFormatting implements
        com.shvet.poi.ss.usermodel.DataBarFormatting {
    ...
    public HSSFConditionalFormattingThreshold getMinThreshold() {
        return new HSSFConditionalFormattingThreshold(
                databarFormatting.getThresholdMin(), sheet);
    }

    public HSSFConditionalFormattingThreshold getMaxThreshold() {
        return new HSSFConditionalFormattingThreshold(
                databarFormatting.getThresholdMax(), sheet);
    }
    ...
    public HSSFConditionalFormattingThreshold createThreshold() {
        return new HSSFConditionalFormattingThreshold(new DataBarThreshold(),
                sheet);
    }
}
