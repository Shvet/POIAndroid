 ...
 * OpenOffice.org's Excel Documentation: excelfileformat.pdf sec 2.5.14 - 'Cell
 * Range Address List'
 * <p/>
 ...
 * range address (called an ADDR structure) contains 4 16-bit-values. </p>
 *
 * @deprecated use {@link com.shvet.poi.ss.util.CellRangeAddressList}
 */
public class CellRangeAddressList extends
        com.shvet.poi.ss.util.CellRangeAddressList {
