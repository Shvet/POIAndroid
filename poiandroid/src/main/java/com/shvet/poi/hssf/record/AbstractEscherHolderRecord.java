...
import com.shvet.poi.ddf.NullEscherSerializationListener;
import com.shvet.poi.hssf.util.LazilyConcatenatedByteArray;
 ...
 * and must be subclassed for maximum benefit.
 *
...
public abstract class AbstractEscherHolderRecord extends Record {
    ...
    public int getRecordSize() {
        byte[] rawData = getRawData();
        if (escherRecords.size() == 0 && rawData != null) {
            // XXX: It should be possible to derive this without concatenating
            // the array, too.
    ...
    /**
     * Big drawing group records are split but it's easier to deal with them as
     * a whole group so we need to join them together.
     */
