...
public final class FilePassRecord extends StandardRecord {
    ...
    public FilePassRecord(RecordInputStream in) {
        ...
        switch (_encryptionType) {
            ...
            case ENCRYPTION_OTHER:
                ...
                break;
            default:
                throw new RecordFormatException("Unknown encryption type "
                        + _encryptionType);
        }
    ...
    public Rc4KeyData getRc4KeyData() {
        return (_keyData instanceof Rc4KeyData) ? (Rc4KeyData) _keyData : null;
    }

    public XorKeyData getXorKeyData() {
        return (_keyData instanceof XorKeyData) ? (XorKeyData) _keyData : null;
    }
    ...
    private Rc4KeyData checkRc4() {
        ...
        if (rc4 == null) {
            throw new RecordFormatException(
                    "file pass record doesn't contain a rc4 key.");
        }
        return rc4;
    }
    ...
    public String toString() {
        ...
        buffer.append("    .type = ")
                .append(HexDump.shortToHex(_encryptionType)).append("\n");
    ...
    public static class Rc4KeyData implements KeyData {
        ...
        public void read(RecordInputStream in) {
            ...
            if (_minorVersionNo != 1) {
                throw new RecordFormatException(
                        "Unexpected VersionInfo number for RC4Header "
                                + _minorVersionNo);
            }
        ...
        public void appendToString(StringBuffer buffer) {
            buffer.append("    .rc4.info = ")
                    .append(HexDump.shortToHex(_encryptionInfo)).append("\n");
            buffer.append("    .rc4.ver  = ")
                    .append(HexDump.shortToHex(_minorVersionNo)).append("\n");
            buffer.append("    .rc4.salt = ").append(HexDump.toHex(_salt))
                    .append("\n");
            buffer.append("    .rc4.verifier = ")
                    .append(HexDump.toHex(_encryptedVerifier)).append("\n");
            buffer.append("    .rc4.verifierHash = ")
                    .append(HexDump.toHex(_encryptedVerifierHash)).append("\n");
        }
    }

    public static class XorKeyData implements KeyData {
        /**
         * key (2 bytes): An unsigned integer that specifies the obfuscation
         * key. See [MS-OFFCRYPTO], 2.3.6.2 section, the first step of
         * initializing XOR array where it describes the generation of 16-bit
         * XorKey value.
         */
        private int _key;

        /**
         * verificationBytes (2 bytes): An unsigned integer that specifies the
         * password verification identifier.
         */
        ...
        public void appendToString(StringBuffer buffer) {
            buffer.append("    .xor.key = ").append(HexDump.intToHex(_key))
                    .append("\n");
            buffer.append("    .xor.verifier  = ")
                    .append(HexDump.intToHex(_verifier)).append("\n");
        }
    }
}
