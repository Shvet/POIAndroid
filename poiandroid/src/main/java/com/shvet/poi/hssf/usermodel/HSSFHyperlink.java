...
public class HSSFHyperlink implements Hyperlink {
     ...
     *
     * @param col the 0-based column of the first cell that contains the
     *            hyperlink
     */
     ...
     *
     * @param col the 0-based column of the last cell that contains the
     *            hyperlink
     */
     ...
     *
     * @param textMark the place in worksheet this hyperlink refers to, e.g. 'Target
     *                 Sheet'!A1'
     */
