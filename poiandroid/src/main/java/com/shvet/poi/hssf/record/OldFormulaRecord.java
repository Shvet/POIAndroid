...
import com.shvet.poi.hssf.record.FormulaRecord.SpecialCachedValue;
...
/**
 * Formula Record (0x0006 / 0x0206 / 0x0406) - holds a formula in encoded form,
 * along with the value if a number
 */
public final class OldFormulaRecord extends OldCellRecord {
    ...
    public OldFormulaRecord(RecordInputStream ris) {
        ...
        field_6_parsed_expr = Formula
                .read(expression_len, ris, nBytesAvailable);
    }
