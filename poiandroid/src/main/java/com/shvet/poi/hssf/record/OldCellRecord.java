 ...
 * {@link CellValueRecordInterface}). Subclasses are expected to manage the cell
...
public abstract class OldCellRecord {
    ...
    public final String toString() {
        ...
        sb.append("    .row    = ").append(HexDump.shortToHex(getRow()))
                .append("\n");
        sb.append("    .col    = ").append(HexDump.shortToHex(getColumn()))
                .append("\n");
        if (isBiff2()) {
            sb.append("    .cellattrs = ")
                    .append(HexDump.shortToHex(getCellAttrs())).append("\n");
        } else {
            sb.append("    .xfindex   = ")
