...
import com.shvet.poi.hssf.util.CellRangeAddress8Bit;
 ...
 * <p/>
 * <p/>
 * TableRecord - The record specifies a data table. This record is preceded by a
 * single Formula record that defines the first cell in the data table, which
 * should only contain a single Ptg, {@link TblPtg}.
 * <p/>
...
public final class TableRecord extends SharedValueRecordBase {
    ...
    private static final BitField alwaysCalc = BitFieldFactory
            .getInstance(0x0001);
    private static final BitField calcOnOpen = BitFieldFactory
            .getInstance(0x0002);
    private static final BitField rowOrColInpCell = BitFieldFactory
            .getInstance(0x0004);
    private static final BitField oneOrTwoVar = BitFieldFactory
            .getInstance(0x0008);
    private static final BitField rowDeleted = BitFieldFactory
            .getInstance(0x0010);
    private static final BitField colDeleted = BitFieldFactory
            .getInstance(0x0020);
    ...
    public String toString() {
        ...
        buffer.append("[TABLE]\n");
        buffer.append("    .range    = ").append(getRange().toString())
                .append("\n");
        buffer.append("    .flags    = ")
                .append(HexDump.byteToHex(field_5_flags)).append("\n");
        buffer.append("    .alwaysClc= ").append(isAlwaysCalc()).append("\n");
        buffer.append("    .reserved = ").append(HexDump.intToHex(field_6_res))
                .append("\n");
        ...
        buffer.append("    .rowInput = ").append(crRowInput.formatAsString())
                .append("\n");
        buffer.append("    .colInput = ").append(crColInput.formatAsString())
                .append("\n");
        buffer.append("[/TABLE]\n");
