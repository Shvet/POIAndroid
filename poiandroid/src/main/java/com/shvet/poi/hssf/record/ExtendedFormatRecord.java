...
import com.shvet.poi.util.BitFieldFactory;
import com.shvet.poi.util.LittleEndianOutput;

/**
 * Title: Extended Format Record Description: Probably one of the more complex
 * records. There are two breeds: Style and Cell.
 * <p/>
 * It should be noted that fields in the extended format record are somewhat
 * arbitrary. Almost all of the fields are bit-level, but we name them as best
 * as possible by functional group. In some places this is better than others.
 * <p/>
 * <p/>
...
public final class ExtendedFormatRecord extends StandardRecord {
    ...
    static final private BitField _xf_type = BitFieldFactory
            .getInstance(0x0004);
    static final private BitField _123_prefix = BitFieldFactory
            .getInstance(0x0008);
    static final private BitField _parent_index = BitFieldFactory
            .getInstance(0xFFF0);
    // field_4_alignment_options bit map
    static final private BitField _alignment = BitFieldFactory
            .getInstance(0x0007);
    static final private BitField _wrap_text = BitFieldFactory
            .getInstance(0x0008);
    static final private BitField _vertical_alignment = BitFieldFactory
            .getInstance(0x0070);
    static final private BitField _justify_last = BitFieldFactory
            .getInstance(0x0080);
    static final private BitField _rotation = BitFieldFactory
            .getInstance(0xFF00);
    // field_5_indention_options
    static final private BitField _indent = BitFieldFactory.getInstance(0x000F);
    static final private BitField _shrink_to_fit = BitFieldFactory
            .getInstance(0x0010);
    static final private BitField _merge_cells = BitFieldFactory
            .getInstance(0x0020);
    static final private BitField _reading_order = BitFieldFactory
            .getInstance(0x00C0);
    // apparently bits 8 and 9 are unused
    static final private BitField _indent_not_parent_format = BitFieldFactory
            .getInstance(0x0400);
    static final private BitField _indent_not_parent_font = BitFieldFactory
            .getInstance(0x0800);
    static final private BitField _indent_not_parent_alignment = BitFieldFactory
            .getInstance(0x1000);
    static final private BitField _indent_not_parent_border = BitFieldFactory
            .getInstance(0x2000);
    static final private BitField _indent_not_parent_pattern = BitFieldFactory
            .getInstance(0x4000);
    static final private BitField _indent_not_parent_cell_options = BitFieldFactory
            .getInstance(0x8000);
    // field_6_border_options bit map
    static final private BitField _border_left = BitFieldFactory
            .getInstance(0x000F);
    static final private BitField _border_right = BitFieldFactory
            .getInstance(0x00F0);
    static final private BitField _border_top = BitFieldFactory
            .getInstance(0x0F00);
    static final private BitField _border_bottom = BitFieldFactory
            .getInstance(0xF000);
    // all three of the following attributes are palette options
    // field_7_palette_options bit map
    static final private BitField _left_border_palette_idx = BitFieldFactory
            .getInstance(0x007F);
    static final private BitField _right_border_palette_idx = BitFieldFactory
            .getInstance(0x3F80);
    static final private BitField _diag = BitFieldFactory.getInstance(0xC000);
    // field_8_adtl_palette_options bit map
    static final private BitField _top_border_palette_idx = BitFieldFactory
            .getInstance(0x0000007F);
    static final private BitField _bottom_border_palette_idx = BitFieldFactory
            .getInstance(0x00003F80);
    static final private BitField _adtl_diag = BitFieldFactory
            .getInstance(0x001fc000);
    static final private BitField _adtl_diag_line_style = BitFieldFactory
            .getInstance(0x01e00000);
    // apparently bit 25 is unused
    static final private BitField _adtl_fill_pattern = BitFieldFactory
            .getInstance(0xfc000000);
    // field_9_fill_palette_options bit map
    static final private BitField _fill_foreground = BitFieldFactory
            .getInstance(0x007F);
    static final private BitField _fill_background = BitFieldFactory
            .getInstance(0x3f80);
    ...
    /**
     * gets the options bitmask - you can also use corresponding option bit
     * getters (see other methods that reference this one)
     *
    ...
    /**
     * sets the options bitmask - you can also use corresponding option bit
     * setters (see other methods that reference this one)
     *
    ...
    public void set123Prefix(boolean prefix) {
        field_3_cell_options = _123_prefix.setShortBoolean(
                field_3_cell_options, prefix);
    }

    /**
     * for cell XF types this is the parent style (usually 0/normal). For style
     * this should be NULL.
     *
    ...
    public void setParentIndex(short parent) {
        field_3_cell_options = _parent_index.setShortValue(
                field_3_cell_options, parent);
    }
    ...
    public void setAlignment(short align) {
        field_4_alignment_options = _alignment.setShortValue(
                field_4_alignment_options, align);
    }
    ...
    public void setWrapText(boolean wrapped) {
        field_4_alignment_options = _wrap_text.setShortBoolean(
                field_4_alignment_options, wrapped);
    }
    ...
    public void setVerticalAlignment(short align) {
        field_4_alignment_options = _vertical_alignment.setShortValue(
                field_4_alignment_options, align);
    }
    ...
    public short getJustifyLast() { // for far east languages supported only for
        // format always 0 for US
    ...
    public void setJustifyLast(short justify) { // for far east languages
        // supported only for format
        // always 0 for US
        field_4_alignment_options = _justify_last.setShortValue(
                field_4_alignment_options, justify);
    }
    ...
    public void setRotation(short rotation) {
        field_4_alignment_options = _rotation.setShortValue(
                field_4_alignment_options, rotation);
    }

    /**
     * get the indent options bitmask (see corresponding bit getters that
    ...
    /**
     * set the indent options bitmask (see corresponding bitmask setters that
     * reference this field)
     *
     * @param options bitmask to set.
     */
    ...
    public void setIndent(short indent) {
        field_5_indention_options = _indent.setShortValue(
                field_5_indention_options, indent);
    }
    ...
    // i've no idea.. possible values are 1 for down, 2 for up and 3 for
    // both...0 for none..
    ...
    public void setShrinkToFit(boolean shrink) {
        field_5_indention_options = _shrink_to_fit.setShortBoolean(
                field_5_indention_options, shrink);
    }
    ...
    public void setMergeCells(boolean merge) {
        field_5_indention_options = _merge_cells.setShortBoolean(
                field_5_indention_options, merge);
    }

    /**
     * get the reading order for far east versions (0 - Context, 1 - Left to
     * right, 2 - right to left) - We could use some help with support for the
     * far east.
     *
    ...
    public short getReadingOrder() { // only for far east always 0 in US
        return _reading_order.getShortValue(field_5_indention_options);
    }

    /**
     * set the reading order for far east versions (0 - Context, 1 - Left to
     * right, 2 - right to left) - We could use some help with support for the
     * far east.
     *
    ...
    public void setReadingOrder(short order) { // only for far east always 0 in
        // US
        field_5_indention_options = _reading_order.setShortValue(
                field_5_indention_options, order);
    }

    /**
     * get whether or not to use the format in this XF instead of the parent XF.
     *
     * @return parent - true if this XF has a different format value than its
     ...
     *
     * @param parent - true if this XF has a different format value than its
     *               parent, false otherwise.
     * @see #setIndentionOptions(short)
     */

    public void setIndentNotParentFormat(boolean parent) {
        field_5_indention_options = _indent_not_parent_format.setShortBoolean(
                field_5_indention_options, parent);
    }
     ...
     *
     * @return font - true if this XF has a different font value than its
     * parent, false otherwise.
     * @see #getIndentionOptions()
     */
    ...
    public void setIndentNotParentFont(boolean font) {
        field_5_indention_options = _indent_not_parent_font.setShortBoolean(
                field_5_indention_options, font);
    }

    /**
     * get whether or not to use the alignment in this XF instead of the parent
     * XF.
     *
     * @return alignment true if this XF has a different alignment value than
    ...
    /**
     * set whether or not to use the alignment in this XF instead of the parent
     * XF.
     *
     * @param alignment true if this XF has a different alignment value than its
     *                  parent, false otherwise.
     * @see #setIndentionOptions(short)
     */

    public void setIndentNotParentAlignment(boolean alignment) {
        field_5_indention_options = _indent_not_parent_alignment
     ...
     *
     * @return border - true if this XF has a different border value than its
     * parent, false otherwise.
     * @see #getIndentionOptions()
     */
     ...
     *
     * @param border - true if this XF has a different border value than its
     *               parent, false otherwise.
     * @see #setIndentionOptions(short)
     */

    public void setIndentNotParentBorder(boolean border) {
        field_5_indention_options = _indent_not_parent_border.setShortBoolean(
                field_5_indention_options, border);
    }

    // These are the bit fields in cell options

    /**
     * get whether or not to use the pattern in this XF instead of the parent
     * XF. (foregrount/background)
     *
     * @return pattern- true if this XF has a different pattern value than its
     * parent, false otherwise.
     * @see #getIndentionOptions()
     */
    ...
    /**
     * <p>
     * Sets whether or not to use the pattern in this XF instead of the parent
     * XF (foreground/background).
     * </p>
     *
     * @param pattern <code>true</code> if this XF has a different pattern value
     *                than its parent,</code> false</code> otherwise.
     * @see #setIndentionOptions(short)
     */

    public void setIndentNotParentPattern(boolean pattern) {
        field_5_indention_options = _indent_not_parent_pattern.setShortBoolean(
                field_5_indention_options, pattern);
    }

    /**
     * get whether or not to use the locking/hidden in this XF instead of the
     * parent XF.
     *
     * @return options- true if this XF has a different locking or hidden value
     * than its parent, false otherwise.
     * @see #getIndentionOptions()
     */
    ...
    public void setIndentNotParentCellOptions(boolean options) {
        field_5_indention_options = _indent_not_parent_cell_options
    ...
    public void setBorderLeft(short border) {
        field_6_border_options = _border_left.setShortValue(
                field_6_border_options, border);
    }
    ...
    public void setBorderRight(short border) {
        field_6_border_options = _border_right.setShortValue(
                field_6_border_options, border);
    }
    ...
    public void setBorderTop(short border) {
        field_6_border_options = _border_top.setShortValue(
                field_6_border_options, border);
    }
    ...
    public void setBorderBottom(short border) {
        field_6_border_options = _border_bottom.setShortValue(
                field_6_border_options, border);
    }

    /**
     * get the palette options bitmask (see the individual bit getter methods
     * that reference this one)
     *
     * @return options - the bitmask
     */
    ...
    /**
     * set the palette options bitmask (see the individual bitsetter methods
     * that reference this one)
     *
     * @param options - the bitmask to set
     */
    ...
    public void setLeftBorderPaletteIdx(short border) {
        field_7_palette_options = _left_border_palette_idx.setShortValue(
                field_7_palette_options, border);
    }
    ...
    public void setRightBorderPaletteIdx(short border) {
        field_7_palette_options = _right_border_palette_idx.setShortValue(
                field_7_palette_options, border);
    }

    /**
     * Not sure what this is for (maybe fill lines?) 1 = down, 2 = up, 3 = both,
     * 0 for none..
     *
    ...
    /**
     * get the additional palette options bitmask (see individual bit getter
     * methods that reference this method)
     *
    ...
    /**
     * set the additional palette options bitmask (see individual bitsetter
     * methods that reference this method)
     *
     * @param options - bitmask to set
     */
    ...
    public void setTopBorderPaletteIdx(short border) {
        field_8_adtl_palette_options = _top_border_palette_idx.setValue(
                field_8_adtl_palette_options, border);
    }
    ...
    public void setBottomBorderPaletteIdx(short border) {
        field_8_adtl_palette_options = _bottom_border_palette_idx.setValue(
                field_8_adtl_palette_options, border);
    }
    ...
    /**
     * get for diagonal borders? No idea (its a palette color for the other
     * function we didn't know what was?)
     *
    ...
    /**
     * set for diagonal borders? No idea (its a palette color for the other
     * function we didn't know what was?)
     *
    ...
    public void setAdtlDiag(short diag) {
        field_8_adtl_palette_options = _adtl_diag.setValue(
                field_8_adtl_palette_options, diag);
    }
    ...
    /**
     * get the diagonal border line style? Who the heck ever heard of a diagonal
     * border?
     *
    ...
    /**
     * set the diagonal border line style? Who the heck ever heard of a diagonal
     * border?
     *
    ...
    public void setAdtlDiagLineStyle(short diag) {
        field_8_adtl_palette_options = _adtl_diag_line_style.setValue(
                field_8_adtl_palette_options, diag);
    }
    ...
    public void setAdtlFillPattern(short fill) {
        field_8_adtl_palette_options = _adtl_fill_pattern.setValue(
                field_8_adtl_palette_options, fill);
    }
    ...
    public void setFillForeground(short color) {
        field_9_fill_palette_options = _fill_foreground.setShortValue(
                field_9_fill_palette_options, color);
    }
    ...
    public void setFillBackground(short color) {
        field_9_fill_palette_options = _fill_background.setShortValue(
                field_9_fill_palette_options, color);
    }
    ...
    public String toString() {
        ...
        buffer.append("    .alignmentoptions= ")
                .append(Integer.toHexString(getAlignmentOptions()))
                .append("\n");
        ...
        buffer.append("          .valignment= ")
                .append(Integer.toHexString(getVerticalAlignment()))
                .append("\n");
        ...
        buffer.append("    .indentionoptions= ")
                .append(Integer.toHexString(getIndentionOptions()))
                .append("\n");
        ...
        buffer.append("          .diaglnstyl= ")
                .append(Integer.toHexString(getAdtlDiagLineStyle()))
                .append("\n");
    ...
    /**
     * Clones all the style information from another ExtendedFormatRecord, onto
     * this one. This will then hold all the same style options.
     * <p/>
     * If The source ExtendedFormatRecord comes from a different Workbook, you
     * will need to sort out the font and format indicies yourself!
     */
    ...
    /**
     * Will consider two different records with the same contents as equals, as
     * the various indexes that matter are embedded in the records
     */
    ...
    public int[] stateSummary() {
        return new int[]{field_1_font_index, field_2_format_index,
                ...
                field_5_indention_options, field_6_border_options,
                field_7_palette_options, field_8_adtl_palette_options,
