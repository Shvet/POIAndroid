...
public final class ExtendedPivotTableViewFieldsRecord extends StandardRecord {
    ...
    /**
     * the value of the subname length when the {@link #_subtotalName} is not
     * present
     */
    ...
    public ExtendedPivotTableViewFieldsRecord(RecordInputStream in) {
        ...
        switch (in.remaining()) {
            ...
            case 10:
                ...
                break;
            default:
                throw new RecordFormatException("Unexpected remaining size ("
                        + in.remaining() + ")");
        }
    ...
    protected int getDataSize() {
        ...
        return 4 + 1 + 1 + 2 + 2 + 2 + 4 + 4
                + (_subtotalName == null ? 0 : (2 * _subtotalName.length())); // in
        // unicode
    }
