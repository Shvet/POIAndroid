...
/**
 * The common object data record is used to store all common preferences for an
 * excel object.
 * <p/>
 *
...
public final class CommonObjectDataSubRecord extends SubRecord {
    ...
    private static final BitField printable = BitFieldFactory
            .getInstance(0x0010);
    private static final BitField autofill = BitFieldFactory
            .getInstance(0x2000);
    private static final BitField autoline = BitFieldFactory
            .getInstance(0x4000);
    ...
    public String toString() {
        ...
        buffer.append("[ftCmo]\n");
        buffer.append("    .objectType           = ").append("0x")
                .append(HexDump.toHex(getObjectType())).append(" (")
                .append(getObjectType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .objectId             = ").append("0x")
                .append(HexDump.toHex(getObjectId())).append(" (")
                .append(getObjectId()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .option               = ").append("0x")
                .append(HexDump.toHex(getOption())).append(" (")
                .append(getOption()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        ...
        buffer.append("    .reserved1            = ").append("0x")
                .append(HexDump.toHex(getReserved1())).append(" (")
                .append(getReserved1()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .reserved2            = ").append("0x")
                .append(HexDump.toHex(getReserved2())).append(" (")
                .append(getReserved2()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .reserved3            = ").append("0x")
                .append(HexDump.toHex(getReserved3())).append(" (")
                .append(getReserved3()).append(" )");
        buffer.append(System.getProperty("line.separator"));
     ...
     *
     * @return One of OBJECT_TYPE_GROUP OBJECT_TYPE_LINE OBJECT_TYPE_RECTANGLE
     * OBJECT_TYPE_OVAL OBJECT_TYPE_ARC OBJECT_TYPE_CHART
     * OBJECT_TYPE_TEXT OBJECT_TYPE_BUTTON OBJECT_TYPE_PICTURE
     * OBJECT_TYPE_POLYGON OBJECT_TYPE_RESERVED1 OBJECT_TYPE_CHECKBOX
     * OBJECT_TYPE_OPTION_BUTTON OBJECT_TYPE_EDIT_BOX OBJECT_TYPE_LABEL
     * OBJECT_TYPE_DIALOG_BOX OBJECT_TYPE_SPINNER OBJECT_TYPE_SCROLL_BAR
     * OBJECT_TYPE_LIST_BOX OBJECT_TYPE_GROUP_BOX OBJECT_TYPE_COMBO_BOX
     * OBJECT_TYPE_RESERVED2 OBJECT_TYPE_RESERVED3 OBJECT_TYPE_RESERVED4
     * OBJECT_TYPE_RESERVED5 OBJECT_TYPE_COMMENT OBJECT_TYPE_RESERVED6
     * OBJECT_TYPE_RESERVED7 OBJECT_TYPE_RESERVED8 OBJECT_TYPE_RESERVED9
     ...
     *
     * @param field_1_objectType One of OBJECT_TYPE_GROUP OBJECT_TYPE_LINE
     *                           OBJECT_TYPE_RECTANGLE OBJECT_TYPE_OVAL OBJECT_TYPE_ARC
     *                           OBJECT_TYPE_CHART OBJECT_TYPE_TEXT OBJECT_TYPE_BUTTON
     *                           OBJECT_TYPE_PICTURE OBJECT_TYPE_POLYGON OBJECT_TYPE_RESERVED1
     *                           OBJECT_TYPE_CHECKBOX OBJECT_TYPE_OPTION_BUTTON
     *                           OBJECT_TYPE_EDIT_BOX OBJECT_TYPE_LABEL OBJECT_TYPE_DIALOG_BOX
     *                           OBJECT_TYPE_SPINNER OBJECT_TYPE_SCROLL_BAR
     *                           OBJECT_TYPE_LIST_BOX OBJECT_TYPE_GROUP_BOX
     *                           OBJECT_TYPE_COMBO_BOX OBJECT_TYPE_RESERVED2
     *                           OBJECT_TYPE_RESERVED3 OBJECT_TYPE_RESERVED4
     *                           OBJECT_TYPE_RESERVED5 OBJECT_TYPE_COMMENT
     *                           OBJECT_TYPE_RESERVED6 OBJECT_TYPE_RESERVED7
     *                           OBJECT_TYPE_RESERVED8 OBJECT_TYPE_RESERVED9
     *                           OBJECT_TYPE_MICROSOFT_OFFICE_DRAWING
     */
    ...
    /**
     * Sets the locked field value. true if object is locked when sheet has been
     * protected
     */
    ...
    /**
     * Sets the autofill field value. whether object uses an automatic fill
     * style
     */
    ...
    /**
     * Sets the autoline field value. whether object uses an automatic line
     * style
     */
