...
/**
 * High level representation for Icon / Multi-State / Databar / Colour Scale
 * change thresholds
 */
public final class HSSFConditionalFormattingThreshold implements
        com.shvet.poi.ss.usermodel.ConditionalFormattingThreshold {
    ...
    public String getFormula() {
        return HSSFConditionalFormattingRule.toFormulaString(
                threshold.getParsedExpression(), workbook);
    }
