...
/**
 * Title: Record Format Exception Description: Used by records to indicate
 * invalid format/data.
 * <p/>
 */

public class RecordFormatException extends
        com.shvet.poi.util.RecordFormatException {
