...
public final class GutsRecord extends StandardRecord {
    ...
    private short field_1_left_row_gutter; // size of the row gutter to the left
    // of the rows
    private short field_2_top_col_gutter; // size of the column gutter above the
    // columns
    private short field_3_row_level_max; // maximum outline level for row
    // gutters
    private short field_4_col_level_max; // maximum outline level for column
    // gutters
