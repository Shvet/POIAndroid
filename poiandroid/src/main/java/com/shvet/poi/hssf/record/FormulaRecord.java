...
import com.shvet.poi.hssf.usermodel.HSSFCell;
...
/**
 * Formula Record (0x0006). REFERENCE: PG 317/444 Microsoft Excel 97 Developer's
...
public final class FormulaRecord extends CellRecord {
    ...
    public static final short sid = 0x0006; // docs say 406...because of a bug
    private static final BitField alwaysCalc = BitFieldFactory
            .getInstance(0x0001);
    private static final BitField calcOnLoad = BitFieldFactory
            .getInstance(0x0002);
    private static final BitField sharedFormula = BitFieldFactory
            .getInstance(0x0008);
    ...
    /**
     * Unused field. As it turns out this field is often not zero.. According to
     * Microsoft Excel Developer's Kit Page 318: when writing the chn field
     * (offset 20), it's supposed to be 0 but ignored on read
     */
    ...
    public FormulaRecord(RecordInputStream ris) {
        ...
        int field_7_expression_len = in.readShort(); // this length does not
        // include any extra
        // array data
        int nBytesAvailable = in.available();
        field_8_parsed_expr = Formula.read(field_7_expression_len, in,
                nBytesAvailable);
    }
    ...
    public void setCachedResultErrorCode(int errorCode) {
        specialCachedValue = SpecialCachedValue
                .createCachedErrorCode(errorCode);
    }
     ...
     * {@link StringRecord} representing the cached text result of the
     * formula evaluation.
     */
    ...
    protected void serializeValue(LittleEndianOutput out) {
        ...
        out.writeInt(field_6_zero); // may as well write original data back so
        // as to minimise differences from original
    ...
    protected void appendValueText(StringBuilder sb) {
        ...
        sb.append("  .options   = ").append(HexDump.shortToHex(getOptions()))
                .append("\n");
     ...
     * Excel encodes the same 8 bytes that would be field_4_value with various
     * NaN values that are decoded/encoded by this class.
     */
    static final class SpecialCachedValue {
        ...
        /**
         * @return <code>null</code> if the double value encoded by
         * <tt>valueLongBits</tt> is a normal (non NaN) double value.
         */
        public static SpecialCachedValue create(long valueLongBits) {
            ...
            switch (result[0]) {
                ...
                case EMPTY:
                    break;
                default:
                    throw new RecordFormatException("Bad special value code ("
                            + result[0] + ")");
            }
        ...
        public boolean getBooleanValue() {
            if (getTypeCode() != BOOLEAN) {
                throw new IllegalStateException("Not a boolean cached value - "
                        + formatValue());
            }
        ...
        public int getErrorValue() {
            if (getTypeCode() != ERROR_CODE) {
                throw new IllegalStateException("Not an error cached value - "
                        + formatValue());
            }
            return getDataValue();
        }
