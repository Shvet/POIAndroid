...
import com.shvet.poi.hssf.record.cf.CellRangeUtil;
...
/**
 * Parent of Conditional Formatting Header records, {@link CFHeaderRecord} and
 * {@link CFHeader12Record}.
 */
public abstract class CFHeaderBase extends StandardRecord {
    ...
    protected CFHeaderBase(CellRangeAddress[] regions, int nRules) {
        ...
        CellRangeAddress[] mergeCellRanges = CellRangeUtil
                .mergeCellRanges(unmergedRanges);
    ...
    /**
     * Set cell ranges list to a single cell range and modify the enclosing cell
     * range accordingly.
     *
    ...
    public void setCellRanges(CellRangeAddress[] cellRanges) {
        ...
        for (int i = 0; i < cellRanges.length; i++) {
            ...
            enclosingRange = CellRangeUtil.createEnclosingCellRange(cr,
                    enclosingRange);
    ...
    public String toString() {
        ...
        buffer.append("\t.needRecalc        = ").append(getNeedRecalculation())
                .append("\n");
        ...
        for (int i = 0; i < field_4_cell_ranges.countRanges(); i++) {
            buffer.append(i == 0 ? "" : ",").append(
                    field_4_cell_ranges.getCellRangeAddress(i).toString());
        }
        buffer.append("]\n");
        buffer.append("[/").append(getRecordName()).append("]\n");
    ...
    protected int getDataSize() {
        return 4 // 2 short fields
                + CellRangeAddress.ENCODED_SIZE + field_4_cell_ranges.getSize();
    }
