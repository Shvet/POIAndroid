...
public final class BoolErrRecord extends CellRecord {
    ...
    public BoolErrRecord(RecordInputStream in) {
        ...
        switch (flag) {
            ...
            case 1:
                ...
                break;
            default:
                throw new RecordFormatException("Unexpected isError flag (" + flag
                        + ") for BOOLERR record.");
        }
    }
     ...
     *
     * @param value error representing the error value this value can only be
     *              0,7,15,23,29,36 or 42 see bugzilla bug 16560 for an
     *              explanation
     */
    ...
    protected void appendValueText(StringBuilder sb) {
        if (isBoolean()) {
            ...
            sb.append(" (").append(HexDump.byteToHex(getErrorValue()))
                    .append(")");
        }
    }
