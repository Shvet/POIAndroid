...
/**
 * Biff2 - Biff 4 Label Record (0x0004 / 0x0204) - read only support for strings
 * stored directly in the cell, from the older file formats that didn't use
 * {@link LabelSSTRecord}
 */
public final class OldLabelRecord extends OldCellRecord {
    ...
    private final static POILogger logger = POILogFactory
            .getLogger(OldLabelRecord.class);
