...
package com.shvet.poi.hssf.record.chart;

import com.shvet.poi.hssf.record.RecordInputStream;
import com.shvet.poi.hssf.record.StandardRecord;
...
public final class LegendRecord extends StandardRecord {
    ...
    private static final BitField autoPosition = BitFieldFactory
            .getInstance(0x01);
    private static final BitField autoSeries = BitFieldFactory
            .getInstance(0x02);
    private static final BitField autoXPositioning = BitFieldFactory
            .getInstance(0x04);
    private static final BitField autoYPositioning = BitFieldFactory
            .getInstance(0x08);
    ...
    public String toString() {
        ...
        buffer.append("    .xAxisUpperLeft       = ").append("0x")
                .append(HexDump.toHex(getXAxisUpperLeft())).append(" (")
                .append(getXAxisUpperLeft()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .yAxisUpperLeft       = ").append("0x")
                .append(HexDump.toHex(getYAxisUpperLeft())).append(" (")
                .append(getYAxisUpperLeft()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .xSize                = ").append("0x")
                .append(HexDump.toHex(getXSize())).append(" (")
                .append(getXSize()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .ySize                = ").append("0x")
                .append(HexDump.toHex(getYSize())).append(" (")
                .append(getYSize()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .type                 = ").append("0x")
                .append(HexDump.toHex(getType())).append(" (")
                .append(getType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .spacing              = ").append("0x")
                .append(HexDump.toHex(getSpacing())).append(" (")
                .append(getSpacing()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .options              = ").append("0x")
                .append(HexDump.toHex(getOptions())).append(" (")
     ...
     *
     * @return One of TYPE_BOTTOM TYPE_CORNER TYPE_TOP TYPE_RIGHT TYPE_LEFT
     * TYPE_UNDOCKED
     */
    public byte getType() {
        return field_5_type;
     ...
     *
     * @param field_5_type One of TYPE_BOTTOM TYPE_CORNER TYPE_TOP TYPE_RIGHT TYPE_LEFT
     *                     TYPE_UNDOCKED
     */
     ...
     *
     * @return One of SPACING_CLOSE SPACING_MEDIUM SPACING_OPEN
     */
     ...
     *
     * @param field_6_spacing One of SPACING_CLOSE SPACING_MEDIUM SPACING_OPEN
     */
    ...
    /**
     * Sets the auto x positioning field value. position of legend on the x axis
     * is automatic
     */
    public void setAutoXPositioning(boolean value) {
        field_7_options = autoXPositioning.setShortBoolean(field_7_options,
                value);
    }
    ...
    /**
     * Sets the auto y positioning field value. position of legend on the y axis
     * is automatic
     */
    public void setAutoYPositioning(boolean value) {
        field_7_options = autoYPositioning.setShortBoolean(field_7_options,
                value);
    }
    ...
    /**
     * Sets the vertical field value. vertical or horizontal legend (1 or 0
     * respectively). Always 0 if not automatic.
     */
