 ...
 * <p/>
 * Description: Tells whether to iterate over forumla calculations or not (if a
 * formula is dependant upon another formula's result) (odd feature for
 * something that can only have 32 elements in a formula!)
 * <p/>
...
public final class IterationRecord extends StandardRecord {
    ...
    private static final BitField iterationOn = BitFieldFactory
            .getInstance(0x0001);
