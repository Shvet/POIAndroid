...
/**
 * Label Record (0x0204) - read only support for strings stored directly in the
 * cell.. Don't use this (except to read), use LabelSST instead
 * <p/>
...
public final class LabelRecord extends Record implements
    ...
    /**
     * THROWS A RUNTIME EXCEPTION.. USE LABELSSTRecords. YOU HAVE NO REASON to
     * use LABELRecord!!
     */
    ...
    public String toString() {
        ...
        sb.append("[LABEL]\n");
        sb.append("    .row       = ").append(HexDump.shortToHex(getRow()))
                .append("\n");
        sb.append("    .column    = ").append(HexDump.shortToHex(getColumn()))
                .append("\n");
