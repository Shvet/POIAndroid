 ...
 * <p/>
 * Description: Occurs right after BOF, tells you where the DBCELL records are
 * for a sheet Important for locating cells
 * <p/>
 * NOT USED IN THIS RELEASE REFERENCE: PG 323 Microsoft Excel 97 Developer's Kit
 * (ISBN: 1-57231-498-2)
 * <p/>
 *
...
public class IndexRecord extends StandardRecord {
    ...
    public IndexRecord(RecordInputStream in) {
        ...
        if (field_1_zero != 0) {
            throw new RecordFormatException(
                    "Expected zero for field 1 but got " + field_1_zero);
        }
    ...
    /**
     * @return the size of an INdexRecord when it needs to index the specified
     * number of blocks
     */
