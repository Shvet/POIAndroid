...
public final class SeriesRecord extends StandardRecord {
    ...
    public String toString() {
        ...
        buffer.append("    .categoryDataType     = ").append("0x")
                .append(HexDump.toHex(getCategoryDataType())).append(" (")
                .append(getCategoryDataType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .valuesDataType       = ").append("0x")
                .append(HexDump.toHex(getValuesDataType())).append(" (")
                .append(getValuesDataType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .numCategories        = ").append("0x")
                .append(HexDump.toHex(getNumCategories())).append(" (")
                .append(getNumCategories()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .numValues            = ").append("0x")
                .append(HexDump.toHex(getNumValues())).append(" (")
                .append(getNumValues()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .bubbleSeriesType     = ").append("0x")
                .append(HexDump.toHex(getBubbleSeriesType())).append(" (")
                .append(getBubbleSeriesType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .numBubbleValues      = ").append("0x")
                .append(HexDump.toHex(getNumBubbleValues())).append(" (")
                .append(getNumBubbleValues()).append(" )");
        buffer.append(System.getProperty("line.separator"));
     ...
     *
     * @return One of CATEGORY_DATA_TYPE_DATES CATEGORY_DATA_TYPE_NUMERIC
     * CATEGORY_DATA_TYPE_SEQUENCE CATEGORY_DATA_TYPE_TEXT
     */
     ...
     *
     * @param field_1_categoryDataType One of CATEGORY_DATA_TYPE_DATES CATEGORY_DATA_TYPE_NUMERIC
     *                                 CATEGORY_DATA_TYPE_SEQUENCE CATEGORY_DATA_TYPE_TEXT
     */
     ...
     *
     * @return One of VALUES_DATA_TYPE_DATES VALUES_DATA_TYPE_NUMERIC
     * VALUES_DATA_TYPE_SEQUENCE VALUES_DATA_TYPE_TEXT
     */
     ...
     *
     * @param field_2_valuesDataType One of VALUES_DATA_TYPE_DATES VALUES_DATA_TYPE_NUMERIC
     *                               VALUES_DATA_TYPE_SEQUENCE VALUES_DATA_TYPE_TEXT
     */
     ...
     *
     * @return One of BUBBLE_SERIES_TYPE_DATES BUBBLE_SERIES_TYPE_NUMERIC
     * BUBBLE_SERIES_TYPE_SEQUENCE BUBBLE_SERIES_TYPE_TEXT
     */
     ...
     *
     * @param field_5_bubbleSeriesType One of BUBBLE_SERIES_TYPE_DATES BUBBLE_SERIES_TYPE_NUMERIC
     *                                 BUBBLE_SERIES_TYPE_SEQUENCE BUBBLE_SERIES_TYPE_TEXT
     */
