...
public final class DrawingGroupRecord extends AbstractEscherHolderRecord {
    ...
    public int serialize(int offset, byte[] data) {
        ...
        int pos = 0;
        for (Iterator<EscherRecord> iterator = getEscherRecords().iterator(); iterator
                .hasNext(); ) {
    ...
    /**
     * Process the bytes into escher records. (Not done by default in case we
     * break things, unless you set the "poi.deserialize.escher" system
     * property)
     */
    ...
    private void writeContinueHeader(byte[] data, int offset,
