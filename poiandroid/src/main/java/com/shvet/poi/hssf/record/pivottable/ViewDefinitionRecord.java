...
package com.shvet.poi.hssf.record.pivottable;
...
public final class ViewDefinitionRecord extends StandardRecord {
    ...
    protected int getDataSize() {
        return 40
                ...
                StringUtil.getEncodedSize(name)
                + StringUtil.getEncodedSize(dataField);
    }
    ...
    public String toString() {
        ...
        buffer.append("    .rwLast       =").append(HexDump.shortToHex(rwLast))
                .append('\n');
        ...
        buffer.append("    .iCache       =").append(HexDump.shortToHex(iCache))
                .append('\n');
        ...
        buffer.append("    .cDim         =").append(HexDump.shortToHex(cDim))
                .append('\n');
        buffer.append("    .cDimRw       =").append(HexDump.shortToHex(cDimRw))
                .append('\n');
        buffer.append("    .cDimCol      =")
                .append(HexDump.shortToHex(cDimCol)).append('\n');
        buffer.append("    .cDimPg       =").append(HexDump.shortToHex(cDimPg))
                .append('\n');
        buffer.append("    .cDimData     =")
                .append(HexDump.shortToHex(cDimData)).append('\n');
        buffer.append("    .cRw          =").append(HexDump.shortToHex(cRw))
                .append('\n');
        buffer.append("    .cCol         =").append(HexDump.shortToHex(cCol))
                .append('\n');
        buffer.append("    .grbit        =").append(HexDump.shortToHex(grbit))
                .append('\n');
