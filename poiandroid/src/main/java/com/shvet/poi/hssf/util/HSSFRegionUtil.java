...
import com.shvet.poi.ss.util.RegionUtil;
...
public final class HSSFRegionUtil {
     ...
     * {@link Region}
     */
    private static CellRangeAddress toCRA(com.shvet.poi.ss.util.Region region) {
        return com.shvet.poi.ss.util.Region.convertToCellRangeAddress(region);
    }
     ...
     * {@link Region}
     */
    public static void setBorderLeft(short border, Region region,
     ...
     * {@link Region}
     */
    public static void setBorderTop(short border, Region region,
                                    HSSFSheet sheet, HSSFWorkbook workbook) {
