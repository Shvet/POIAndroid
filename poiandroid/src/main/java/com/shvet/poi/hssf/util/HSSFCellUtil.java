...
import com.shvet.poi.hssf.usermodel.HSSFCellStyle;
import com.shvet.poi.hssf.usermodel.HSSFFont;
import com.shvet.poi.hssf.usermodel.HSSFRow;
import com.shvet.poi.hssf.usermodel.HSSFSheet;
import com.shvet.poi.hssf.usermodel.HSSFWorkbook;
import com.shvet.poi.ss.util.CellUtil;

/**
 * Various utility functions that make working with a cells and rows easier. The
 * various methods that deal with style's allow you to create your
 * HSSFCellStyles as you need them. When you apply a style change to a cell, the
...
public final class HSSFCellUtil {
     ...
     */
    public static void setAlignment(HSSFCell cell, HSSFWorkbook workbook,
                                    short align) {
     ...
     */
    public static void setFont(HSSFCell cell, HSSFWorkbook workbook,
                               HSSFFont font) {
        CellUtil.setFont(cell, workbook, font);
    }

    /**
     * This method attempt to find an already existing HSSFCellStyle that
     * matches what you want the style to be. If it does not find the style,
     * then it creates a new one. If it does create a new one, then it applies
     * the propertyName and propertyValue to the style. This is necessary
    ...
    public static void setCellStyleProperty(HSSFCell cell,
                                            HSSFWorkbook workbook, String propertyName, Object propertyValue) {
