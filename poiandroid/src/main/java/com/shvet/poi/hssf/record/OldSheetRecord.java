 ...
 * <p/>
 * Description: Defines a sheet within a workbook. Basically stores the sheet
 * name and tells where the Beginning of file record is within the HSSF file.
 */
public final class OldSheetRecord {
    ...
    /**
     * get the offset in bytes of the Beginning of File Marker within the HSSF
    ...
    /**
     * get the sheetname for this sheet. (this appears in the tabs at the
     * bottom)
     *
    ...
    public String toString() {
        ...
        buffer.append("    .visibility = ")
                .append(HexDump.shortToHex(field_2_visibility)).append("\n");
        buffer.append("    .type       = ")
                .append(HexDump.byteToHex(field_3_type)).append("\n");
