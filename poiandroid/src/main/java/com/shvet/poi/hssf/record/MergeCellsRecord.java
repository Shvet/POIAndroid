...
/**
 * Title: Merged Cells Record (0x00E5) <br/>
...
public final class MergeCellsRecord extends StandardRecord {
    ...
    public MergeCellsRecord(CellRangeAddress[] regions, int startIndex,
                            int numberOfRegions) {
        _regions = regions;
    ...
    /**
     * get the number of merged areas. If this drops down to 0 you should just
    ...
    /**
     * @return MergedRegion at the given index representing the area that is
     * Merged (r1,c1 - r2,c2)
     */
    ...
    public String toString() {
        ...
        for (int k = 0; k < _numberOfRegions; k++) {
            ...
            retval.append("     .rowfrom =").append(r.getFirstRow())
                    .append("\n");
            retval.append("     .rowto   =").append(r.getLastRow())
                    .append("\n");
            retval.append("     .colfrom =").append(r.getFirstColumn())
                    .append("\n");
            retval.append("     .colto   =").append(r.getLastColumn())
                    .append("\n");
        }
        retval.append("[MERGEDCELLS]").append("\n");
