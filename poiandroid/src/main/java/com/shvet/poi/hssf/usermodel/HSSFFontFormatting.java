...
/**
 * High level representation for Font Formatting component of Conditional
 * Formatting settings
 */
public final class HSSFFontFormatting implements
        com.shvet.poi.ss.usermodel.FontFormatting {
    /**
     * Underline type - None
     */
    ...
    /**
     * @param fci
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setFontColorIndex(short)
     */
    ...
    public HSSFColor getFontColor() {
        return workbook.getCustomPalette().getColor(getFontColorIndex());
    }
    ...
    /**
     * @param height
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setFontHeight(int)
     */
    ...
    /**
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#getRawRecord()
     */
    ...
    /**
     * @param modified
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setEscapementTypeModified(boolean)
     */
    ...
    /**
     * @param modified
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setFontCancellationModified(boolean)
     */
    ...
    /**
     * @param modified
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setFontOutlineModified(boolean)
     */
    ...
    /**
     * @param modified
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setFontShadowModified(boolean)
     */
    ...
    /**
     * @param modified
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setFontStyleModified(boolean)
     */
    ...
    /**
     * @param modified
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setUnderlineTypeModified(boolean)
     */
    ...
    /**
     * @param on
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setOutline(boolean)
     */
    ...
    /**
     * @param on
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setShadow(boolean)
     */
    ...
    /**
     * @param strike
     * @see com.shvet.poi.hssf.record.cf.FontFormatting#setStrikeout(boolean)
     */
