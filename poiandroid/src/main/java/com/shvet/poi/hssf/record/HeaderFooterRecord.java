...
public final class HeaderFooterRecord extends StandardRecord {
    ...
    /**
     * construct a HeaderFooterRecord record. No fields are interpreted and the
     * record will be serialized in its original form more or less
     *
    ...
    /**
     * If this header belongs to a specific sheet view , the sheet view?s GUID
     * will be saved here.
     * <p/>
     * If it is zero, it means the current sheet. Otherwise, this field MUST
     * match the guid field of the preceding {@link UserSViewBegin} record.
     *
