...
package com.shvet.poi.ss.formula.eval;
...
import com.shvet.poi.ss.formula.functions.Address;
import com.shvet.poi.ss.formula.functions.AggregateFunction;
import com.shvet.poi.ss.formula.functions.BooleanFunction;
import com.shvet.poi.ss.formula.functions.CalendarFieldFunction;
import com.shvet.poi.ss.formula.functions.Choose;
import com.shvet.poi.ss.formula.functions.Code;
import com.shvet.poi.ss.formula.functions.Column;
import com.shvet.poi.ss.formula.functions.Columns;
import com.shvet.poi.ss.formula.functions.Count;
import com.shvet.poi.ss.formula.functions.Counta;
import com.shvet.poi.ss.formula.functions.Countblank;
import com.shvet.poi.ss.formula.functions.Countif;
import com.shvet.poi.ss.formula.functions.DStarRunner;
import com.shvet.poi.ss.formula.functions.DateFunc;
import com.shvet.poi.ss.formula.functions.Days360;
import com.shvet.poi.ss.formula.functions.Errortype;
import com.shvet.poi.ss.formula.functions.Even;
import com.shvet.poi.ss.formula.functions.FinanceFunction;
import com.shvet.poi.ss.formula.functions.Fixed;
import com.shvet.poi.ss.formula.functions.Function;
import com.shvet.poi.ss.formula.functions.Hlookup;
import com.shvet.poi.ss.formula.functions.Hyperlink;
import com.shvet.poi.ss.formula.functions.IPMT;
import com.shvet.poi.ss.formula.functions.IfFunc;
import com.shvet.poi.ss.formula.functions.Index;
import com.shvet.poi.ss.formula.functions.Intercept;
import com.shvet.poi.ss.formula.functions.Irr;
import com.shvet.poi.ss.formula.functions.LogicalFunction;
import com.shvet.poi.ss.formula.functions.Lookup;
import com.shvet.poi.ss.formula.functions.Match;
import com.shvet.poi.ss.formula.functions.MinaMaxa;
import com.shvet.poi.ss.formula.functions.Mirr;
import com.shvet.poi.ss.formula.functions.Mode;
import com.shvet.poi.ss.formula.functions.Na;
import com.shvet.poi.ss.formula.functions.NotImplementedFunction;
import com.shvet.poi.ss.formula.functions.Now;
import com.shvet.poi.ss.formula.functions.Npv;
import com.shvet.poi.ss.formula.functions.NumericFunction;
import com.shvet.poi.ss.formula.functions.Odd;
import com.shvet.poi.ss.formula.functions.Offset;
import com.shvet.poi.ss.formula.functions.PPMT;
import com.shvet.poi.ss.formula.functions.Rank;
import com.shvet.poi.ss.formula.functions.Rate;
import com.shvet.poi.ss.formula.functions.Replace;
import com.shvet.poi.ss.formula.functions.Rept;
import com.shvet.poi.ss.formula.functions.Roman;
import com.shvet.poi.ss.formula.functions.RowFunc;
import com.shvet.poi.ss.formula.functions.Rows;
import com.shvet.poi.ss.formula.functions.Slope;
import com.shvet.poi.ss.formula.functions.Substitute;
import com.shvet.poi.ss.formula.functions.Subtotal;
import com.shvet.poi.ss.formula.functions.Sumif;
import com.shvet.poi.ss.formula.functions.Sumproduct;
import com.shvet.poi.ss.formula.functions.Sumx2my2;
import com.shvet.poi.ss.formula.functions.Sumx2py2;
import com.shvet.poi.ss.formula.functions.Sumxmy2;
import com.shvet.poi.ss.formula.functions.T;
import com.shvet.poi.ss.formula.functions.TextFunction;
import com.shvet.poi.ss.formula.functions.TimeFunc;
import com.shvet.poi.ss.formula.functions.Today;
import com.shvet.poi.ss.formula.functions.Value;
import com.shvet.poi.ss.formula.functions.Vlookup;
import com.shvet.poi.ss.formula.functions.WeekdayFunc;
...
/**
 * Mappings from the Excel functions to our evaluation implementations (where
 * avilable)
 */
public final class FunctionEval {
    ...
    private static Function[] produceFunctions() {
        ...
        retval[FunctionID.INDIRECT] = null; // Indirect.evaluate has different
        // signature
    ...
    /**
     * @return <code>null</code> if the specified functionIndex is for
     * INDIRECT() or any external (add-in) function.
     */
    ...
    public static void registerFunction(String name, Function func) {
        FunctionMetadata metaData = FunctionMetadataRegistry
                .getFunctionByName(name);
        if (metaData == null) {
            if (AnalysisToolPak.isATPFunction(name)) {
                throw new IllegalArgumentException(
                        name
                                + " is a function from the Excel Analysis Toolpack. "
