...
import com.shvet.poi.ss.formula.SheetRange;
import com.shvet.poi.ss.formula.ptg.AreaI;
...
public abstract class AreaEvalBase implements AreaEval {
    ...
    protected AreaEvalBase(SheetRange sheets, int firstRow, int firstColumn,
    ...
    protected AreaEvalBase(int firstRow, int firstColumn, int lastRow,
                           int lastColumn) {
    ...
    protected AreaEvalBase(AreaI ptg, SheetRange sheets) {
        this(sheets, ptg.getFirstRow(), ptg.getFirstColumn(), ptg.getLastRow(),
                ptg.getLastColumn());
    }
    ...
    public final boolean contains(int row, int col) {
        return _firstRow <= row && _lastRow >= row && _firstColumn <= col
                && _lastColumn >= col;
    }
    ...
    /**
     * @return whether cell at rowIndex and columnIndex is a subtotal. By
     * default return false which means 'don't care about subtotals'
     */
