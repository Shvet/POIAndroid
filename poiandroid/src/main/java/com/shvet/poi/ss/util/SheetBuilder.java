...
public class SheetBuilder {
     ...
     * cells.
     *
     * @return {@code true} if null objects should be treated as empty cells and
     ...
     *
     * @param shouldCreateEmptyCells {@code true} if null array elements should be treated as empty
     *                               cells
     * @return {@code this}
     */
    ...
    /**
     * Specifies name of the sheet to build. If not specified, default name
     * (provided by workbook) will be used instead.
     *
    ...
    /**
     * Builds sheet from parent workbook and 2D array with cell values. Creates
     * rows anyway (even if row contains only null cells), creates cells if
     * either corresponding array value is not null or createEmptyCells property
     * is true. The conversion is performed in the following way:
     * <p/>
     * <ul>
     ...
     * <li>String with leading '=' char become formulas (leading '=' will be
     * truncated).</li>
     ...
     */
    public Sheet build() {
        Sheet sheet = (sheetName == null) ? workbook.createSheet() : workbook
