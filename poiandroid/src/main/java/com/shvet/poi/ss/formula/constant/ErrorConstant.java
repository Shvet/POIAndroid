...
package com.shvet.poi.ss.formula.constant;
 ...
 * <p/>
 * <p/>
 * This class is a type-safe wrapper for a 16-bit int value performing a similar
 * job to <tt>ErrorEval</tt>.
 *
 * @author Josh Micich
 */
public class ErrorConstant {
    ...
    public static ErrorConstant valueOf(int errorCode) {
        ...
        logger.log(POILogger.WARN, "Warning - unexpected error code ("
                + errorCode + ")");
