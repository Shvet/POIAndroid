...
package com.shvet.poi.ss.usermodel.charts;

import com.shvet.poi.util.Beta;
...
public interface ManualLayout {
     ...
     *
     * @return the x location (left) of the chart element or 0.0 if not set.
     */
    double getX();

    /**
     * Specifies the x location (left) of the chart element as a fraction of the
     * width of the chart. If Left Mode is Factor, then the position is relative
     * to the default position for the chart element.
     */
    void setX(double x);
     ...
     *
     * @return the y location (top) of the chart element or 0.0 if not set.
     */
    double getY();

    /**
     * Specifies the y location (top) of the chart element as a fraction of the
     * height of the chart. If Top Mode is Factor, then the position is relative
     * to the default position for the chart element.
     */
    void setY(double y);
    ...
    /**
     * Specifies the width (if Width Mode is Factor) or right (if Width Mode is
     * Edge) of the chart element as a fraction of the width of the chart.
     *
    ...
    /**
     * Specifies the height (if Height Mode is Factor) or bottom (if Height Mode
     * is edge) of the chart element as a fraction of the height of the chart.
     *
