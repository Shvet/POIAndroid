 ...
 * binary exponents Does not handle negative numbers or zero
 * <p/>
 * The value of a {@link ExpandedDouble} is given by<br/>
 * <tt> a &times; 2<sup>b</sup></tt> <br/>
 * where:<br/>
 * <p/>
...
final class ExpandedDouble {
    private static final BigInteger BI_FRAC_MASK = BigInteger
            .valueOf(IEEEDouble.FRAC_MASK);
    private static final BigInteger BI_IMPLIED_FRAC_MSB = BigInteger
            .valueOf(IEEEDouble.FRAC_ASSUMED_HIGH_BIT);
    /**
    ...
    private static BigInteger getFrac(long rawBits) {
        return BigInteger.valueOf(rawBits).and(BI_FRAC_MASK)
                .or(BI_IMPLIED_FRAC_MSB).shiftLeft(11);
    }
    ...
    /**
     * Convert to an equivalent {@link NormalisedDecimal} representation having
     * 15 decimal digits of precision in the non-fractional bits of the
     * significand.
     */
    ...
    /**
     * @return the number of non-fractional bits after the MSB of the
     * significand
     */
