 ...
 * The HSSF equivalent using indexes is {@link Ref3DPtg}
 * </p>
 */
public final class Ref3DPxg extends RefPtgBase implements Pxg3D {
    ...
    public Ref3DPxg(int externalWorkbookNumber, SheetIdentifier sheetName,
                    String cellref) {
    ...
    public Ref3DPxg(int externalWorkbookNumber, SheetIdentifier sheetName,
        ...
        if (sheetName instanceof SheetRangeIdentifier) {
            this.lastSheetName = ((SheetRangeIdentifier) sheetName)
                    .getLastSheetIdentifier().getName();
        } else {
    ...
    public void write(LittleEndianOutput out) {
        throw new IllegalStateException(
                "XSSF-only Ptg, should not be serialised");
    }
}
