...
import com.shvet.poi.ss.formula.functions.Fixed2ArgFunction;
...
public abstract class TwoOperandNumericOperation extends Fixed2ArgFunction {
    ...
    protected final double singleOperandEvaluate(ValueEval arg, int srcCellRow,
    ...
    private static final class SubtractEvalClass extends
