...
package com.shvet.poi.ss.formula.ptg;
...
public abstract class AreaPtgBase extends OperandPtg implements AreaI {
    private final static BitField rowRelative = BitFieldFactory
            .getInstance(0x8000);
    private final static BitField colRelative = BitFieldFactory
            .getInstance(0x4000);
    private final static BitField columnMask = BitFieldFactory
            .getInstance(0x3FFF);
    /**
    ...
    protected AreaPtgBase(int firstRow, int lastRow, int firstColumn,
                          int lastColumn, boolean firstRowRelative, boolean lastRowRelative,
                          boolean firstColRelative, boolean lastColRelative) {
    ...
    /**
     * TODO - (May-2008) fix subclasses of AreaPtg 'AreaN~' which are used in
     * shared formulas. see similar comment in ReferencePtg
     */
    ...
    public final void setFirstRowRelative(boolean rel) {
        field_3_first_column = rowRelative
                .setBoolean(field_3_first_column, rel);
    }
    ...
    public final void setFirstColRelative(boolean rel) {
        field_3_first_column = colRelative
                .setBoolean(field_3_first_column, rel);
    }
    ...
    protected final String formatReferenceAsString() {
        CellReference topLeft = new CellReference(getFirstRow(),
                getFirstColumn(), !isFirstRowRelative(), !isFirstColRelative());
        CellReference botRight = new CellReference(getLastRow(),
                getLastColumn(), !isLastRowRelative(), !isLastColRelative());
