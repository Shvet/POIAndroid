 ...
 * value to behave like a hyperlink in the GUI. From an evaluation perspective
 * however, it is very simple.
 * <p/>
 * <p/>
 * <b>Syntax</b>:<br/>
 * <b>HYPERLINK</b>(<b>link_location</b>, friendly_name)
 * <p/>
 * <p/>
 * <b>link_location</b> The URL of the hyperlink <br/>
 * <b>friendly_name</b> (optional) the value to display
 * <p/>
 * <p/>
 * Returns last argument. Leaves type unchanged (does not convert to
 * {@link org.apache.poi.ss.formula.eval.StringEval}).
 *
