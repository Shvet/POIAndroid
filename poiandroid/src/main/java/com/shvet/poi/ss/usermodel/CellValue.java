...
/**
 * Mimics the 'data view' of a cell. This allows formula evaluator to return a
 * CellValue instead of precasting the value to String or Number or boolean
 * type.
 *
 * @author Amol S. Deshmukh &lt; amolweb at ya hoo dot com &gt;
 */
public final class CellValue {
    public static final CellValue TRUE = new CellValue(Cell.CELL_TYPE_BOOLEAN,
            0.0, true, null, 0);
    public static final CellValue FALSE = new CellValue(Cell.CELL_TYPE_BOOLEAN,
            0.0, false, null, 0);
