 ...
 * <p/>
 * <p/>
 * In the Microsoft documentation, this is also known as a Ref8U - see page 831
 * of version 1.0 of the documentation.
 * <p/>
...
public class CellRangeAddress extends CellRangeAddressBase {
    ...
    public CellRangeAddress(RecordInputStream in) {
        super(readUShortAndCheck(in), in.readUShort(), in.readUShort(), in
                .readUShort());
    }
    ...
    private static int readUShortAndCheck(RecordInputStream in) {
        if (in.remaining() < ENCODED_SIZE) {
            ...
            throw new RuntimeException(
                    "Ran out of data reading CellRangeAddress");
        }
    ...
    public CellRangeAddress copy() {
        return new CellRangeAddress(getFirstRow(), getLastRow(),
