 ...
 * worksheet, which is represented as a grid of cells. Worksheet cells can
...
public interface Sheet extends Iterable<Row> {
     ...
     * @return Row representing the rownumber or null if its not defined on the
     * sheet
     */
     ...
     * the default font is changed the column width can be streched
     * </p>
     *
     * @param columnIndex - the column to set (0-based)
    ...
    /**
     * Returns the CellStyle that applies to the given (0 based) column, or null
     * if no style has been set for that column
     */
    ...
    /**
     * Whether Excel will be asked to recalculate all formulas in this sheet
     ...
     * </p>
     * <p/>
     * To force recalcuation of formulas in the entire workbook use
     * {@link Workbook#setForceFormulaRecalculation(boolean)} instead.
     *
     ...
     * </p>
     *
     * @return <code>true</code> if row summaries appear below detail in the
     * outline
     */
     ...
     * </p>
     *
     * @param value <code>true</code> if row summaries appear below detail in the
     *              outline
     */
     ...
     * </p>
     *
     * @return <code>true</code> if col summaries appear right of the detail in
     * the outline
     */
     ...
     * </p>
     *
     * @param value <code>true</code> if col summaries appear right of the detail
     *              in the outline
     */
    void setRowSumsRight(boolean value);

    /**
     * Gets the flag indicating whether this sheet displays the lines between
     * rows and columns to make editing and reading easier.
     *
     * @return <code>true</code> if this sheet displays gridlines.
     * @see #isPrintGridlines() to check if printing of gridlines is turned on
     * or off
     */
     ...
     * between rows and columns to make editing and reading easier. To turn
     * printing of gridlines use {@link #setPrintGridlines(boolean)}
     *
     ...
     * @param toprow  the top row to show in desktop window pane
     * @param leftcol the left column to show in desktop window pane
     * @deprecated Use {@link #showInPane(int, int)} as there can be more than
     * 32767 rows.
     */
    @Deprecated
     ...
     */
    void createFreezePane(int colSplit, int rowSplit, int leftmostColumn,
                          int topRow);
     ...
     */
    void createSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn,
     ...
     *
     * @return all the horizontal page breaks, or null if there are no row page
     * breaks
     */
    int[] getRowBreaks();
     ...
     *
     * @return all the vertical page breaks, or null if there are no column page
     * breaks
     */
    int[] getColumnBreaks();
     ...
     * <p>
     * Note: multiple sheets can be selected, but only one sheet can be active
     * at one time.
     * </p>
     *
    ...
    /**
     * Remove a Array Formula from this sheet. All cells contained in the Array
     * Formula range are removed as well
     *
     ...
     * </pre>
     * <p/>
     * The parameter {@link CellRangeAddress} should specify a column part which
     * spans all columns, and a row part which specifies the contiguous range of
     * repeating rows, e.g.:
     * <p/>
     * <pre>
     ...
     * </pre>
     *
     * @param rowRangeRef a {@link CellRangeAddress} containing the repeating rows for
     *                    the Sheet, or null.
     */
     ...
     * rows, and a column part which specifies the contiguous range of repeating
     * columns.
     * <p/>
     ...
     * </pre>
     * <p/>
     * The parameter {@link CellRangeAddress} should specify a row part which
     * spans all rows, and a column part which specifies the contiguous range of
     * repeating columns, e.g.:
     * <p/>
     * <pre>
     ...
     * </pre>
     *
     * @param columnRangeRef a {@link CellRangeAddress} containing the repeating columns
     *                       for the Sheet, or null.
     */
