...
public interface DataValidation {
     ...
     *
     * @param allowed <code>true</code> if this object should treats empty as valid
     ...
     *
     * @return <code>true</code> if a list should display the values into a drop
     * down list , <code>false</code> otherwise .
     */
     ...
     *
     * @param suppress True if a list should display the values into a drop down list
    ...
    /**
     * @return <code>true</code> if an prompt box should be displayed ,
     ...
     *
     * @param show <code>true</code> if an prompt box should be displayed ,
     *             <code>false</code> otherwise
     */
    void setShowPromptBox(boolean show);

    /**
     * @return <code>true</code> if an error box should be displayed ,
     * <code>false</code> otherwise
     */
     ...
     *
     * @param show <code>true</code> if an error box should be displayed ,
     *             <code>false</code> otherwise
     */
