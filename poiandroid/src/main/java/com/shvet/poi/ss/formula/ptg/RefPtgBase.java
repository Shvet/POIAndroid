...
public abstract class RefPtgBase extends OperandPtg {
    ...
    private static final BitField rowRelative = BitFieldFactory
            .getInstance(0x8000);
    private static final BitField colRelative = BitFieldFactory
            .getInstance(0x4000);
    /**
     * YK: subclasses of RefPtgBase are used by the FormulaParser and
     * FormulaEvaluator accross HSSF and XSSF. The bit mask should accomodate
     * the maximum number of avaiable columns, i.e. 0x3FFF.
     *
