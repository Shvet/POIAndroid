...
public class Region implements Comparable<Region> {
    ...
    public Region(String ref) {
        CellReference cellReferenceFrom = new CellReference(ref.substring(0,
                ref.indexOf(":")));
        CellReference cellReferenceTo = new CellReference(ref.substring(ref
                .indexOf(":") + 1));
     ...
     * @return regions
     */
    public static Region[] convertCellRangesToRegions(
    ...
    private static Region convertToRegion(CellRangeAddress cr) {
        ...
        return new Region(cr.getFirstRow(), (short) cr.getFirstColumn(),
                cr.getLastRow(), (short) cr.getLastColumn());
    }
    ...
    public static CellRangeAddress convertToCellRangeAddress(Region r) {
        return new CellRangeAddress(r.getRowFrom(), r.getRowTo(),
    ...
    public boolean contains(int row, short col) {
        return (this._rowFrom <= row) && (this._rowTo >= row)
    ...
    public String getRegionRef() {
        ...
        String ref = cellRefFrom.formatAsString() + ":"
                + cellRefTo.formatAsString();
        return ref;
    }
}
