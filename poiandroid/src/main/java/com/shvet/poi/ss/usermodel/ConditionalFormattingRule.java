...
public interface ConditionalFormattingRule {
     ...
     */
    byte CONDITION_TYPE_CELL_VALUE_IS = ConditionType.CELL_VALUE_IS.id;
     ...
     */
    byte CONDITION_TYPE_FORMULA = ConditionType.FORMULA.id;
     ...
     * set to {@link #CONDITION_TYPE_CELL_VALUE_IS}
     * <p>
     ...
     * formatting rule.
     * <p>
     * If the condition type is {@link #CONDITION_TYPE_CELL_VALUE_IS}, this
     * field is the first operand of the comparison. If type is
     * {@link #CONDITION_TYPE_FORMULA}, this formula is used to determine if the
     * conditional formatting is applied.
     * </p>
     * <p>
     * If comparison type is {@link #CONDITION_TYPE_FORMULA} the formula MUST be
     * a Boolean function
     * </p>
     *
     ...
     * comparison type is {@link #CONDITION_TYPE_CELL_VALUE_IS} and operator is
     * either {@link ComparisonOperator#BETWEEN} or
     * {@link ComparisonOperator#NOT_BETWEEN}
     *
