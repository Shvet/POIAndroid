...
/**
 * The ConditionalFormatting class encapsulates all settings of Conditional
 * Formatting.
 * <p/>
 ...
 * <UL>
 * <LI>
 * to make a copy ConditionalFormatting settings.</LI>
 * <p/>
 * <p/>
 * For example:
 * <p/>
...
public interface ConditionalFormatting {
    ...
    /**
     * Replaces an existing Conditional Formatting rule at position idx. Excel
     * pre-2007 allows to create up to 3 Conditional Formatting rules, 2007 and
     * later allow unlimited numbers. This method can be useful to modify
     * existing Conditional Formatting rules.
     *
     * @param idx    position of the rule. Should be between 0 and 2 for Excel
    ...
    /**
     * Add a Conditional Formatting rule. Excel pre-2007 allows to create up to
