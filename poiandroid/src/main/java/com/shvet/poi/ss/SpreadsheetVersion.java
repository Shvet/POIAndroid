 ...
 * that are easily discernable to the user. It is not intended to deal with
 * low-level issues like file formats.
 */
public enum SpreadsheetVersion {
    ...
    SpreadsheetVersion(int maxRows, int maxColumns,
                       int maxFunctionArgs, int maxCondFormats, int maxCellStyles,
                       int maxText) {
        _maxRows = maxRows;
    ...
    /**
     * @return the last (maximum) valid row index, equals to
     * <code> getMaxRows() - 1 </code>
     */
    ...
    /**
     * @return the last (maximum) valid column index, equals to
     * <code> getMaxColumns() - 1 </code>
     */
